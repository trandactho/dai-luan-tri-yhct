...
Object.assign(window.database, {
  ...
  "dai_trang_thap_nhiet": {
    ...
    bt: "Thược dược thang",
    tpbt: ["Bạch thược", "Đương quy", "Hậu phác", "Binh lang", "Mộc hương", "Cam thảo", "Hoàng liên", "Hoàng cầm"]
  },
  "dai_trang_han_thap": {
    ...
    bt: "Bất hoán kim chính khí tán",
    tpbt: ["Hoắc hương", "Bạch truật", "Hậu phác", "Trần bì", "Phục linh", "Can khương"]
  },
  ...
  "tieu_truong_huyet_u": {
    ...
    tpbt: ["Đương quy", "Xuyên khung", "Xích thược", "Đào nhân", "Hồng hoa", "Quan quế"]
  },
  "bang_quang_thap_nhiet": {
    hc: "Bàng quang thấp nhiệt",
    phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Thấp nhiệt"],
  ...
  "ho_phong_han_thuong_phe": {
    ...
    tpbt: ["Ma hoàng", "Hạnh nhân", "Cát cánh", "Bạch tiền", "Bách bộ", "Trần bì", "Chích cam thảo"]
  },
  ...
  "tiet_ta_han_thap": {
    ...
    tpbt: ["Hoắc hương", "Tô diệp", "Bạch chỉ", "Bán hạ", "Hậu phác", "Trần bì", "Phục linh"]
  },
  "ty_hu_dam_thap_beo_phi": {
    ...
    tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Cam thảo", "Bán hạ", "Trần bì"]
  },
  "vi_nhiet_thua_can": {
  ...
  "xuat_tinh_som_tam_than_bat_giao": {
    ...
    tpbt: ["Hoàng liên", "Nhục quế", "Sinh địa", "Mạch môn", "Bách hợp"]
  },
  "kinh_nguyet_khong_deu_can_khi_uat": {
    ...
    tpbt: ["Sài hồ", "Bạch thược", "Chỉ xác", "Xuyên khung", "Đương quy", "Thục địa"]
  },
  "thong_kinh_han_thap": {
    ...
    tpbt: ["Đương quy", "Xuyên khung", "Bạch thược", "Ngô thù du", "Quế chi", "Hán diệp"]
  }, 
  "can_khi_thu_nghich": {
    ...
    bt: "Toàn phúc đại giá hoàn gia giảm",
    tpbt: ["Toàn phúc hoa", "Đại giả thạch", "Hương phụ", "Trần bì", "Bán hạ"]
  },
  "can_vi_bat_hoa_thuc_tich": {
    ...
    tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Sơn tra", "Thần khúc", "Lai phục tử"]
  },
  "can_than_am_hu": {
    hc: "Can Thận âm hư",
    phanloai: ["Tạng Can", "Nhiệt", "Hư", "Âm hư"],
    tc: ["Đau lưng mỏi gối chóng mặt tai ù", "M mắt khô nhìn mờ", "Triều nhiệt đạo hãn", "Mạch tế sác"],
    pdt: "Tư bổ can thận âm",
    bt: "Kỷ cúc địa hoàng hoàn hợp Nhất trí ẩm",
    tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Kỷ tử", "Cúc hoa"]
  },
  "can_ty_bat_hoa": {
    hc: "Can Tỳ bất hòa",
    phanloai: ["Tạng Can", "Bình", "Thực", "Khí trệ"],
    ...
    tpbt: ["Sài hồ", "Bạch thược", "Chỉ thực", "Cam thảo", "Bạch truật", "Phòng phong"]
  }, 
  "tam_khi_am_luong_hu": {
    ...
    tpbt: ["Nhân sâm", "Mạch môn", "Ngũ vị tử", "Đảng sâm", "Hoàng kỳ", "Cam thảo"]
  },
  "tam_mach_uat_tro": {
    hc: "Tâm mạch ứ trệ",
    phanloai: ["Tạng Tâm", "Bình", "Thực", "Huyết ứ"],
    ...
    bt: "Huyết phủ trục ứ thang hợp Hoắc hương chính khí",
    tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Đan sâm"]
  },
  "bat_cuong_bieu_han": {
    hc: "Biểu hàn chứng",
  ...
  "bat_cuong_bieu_nhiet": {
    ...
    bt: "Ngân kiều tán",
    tpbt: ["Kim ngân hoa", "Liên kiều", "Bạc hà", "Cát cánh", "Cúc hoa"]
  }, 
  "khi_hu_chung": {
    hc: "Khí hư chứng",
  ...
  "duong_minh_kinh_chung": {
    ...
    bt: "Bạch hổ thang",
    tpbt: ["Thạch cao", "Tri mẫu", "Ngạnh mễ", "Cam thảo"]
  }, 
  "ve_phan_chung": {
    hc: "Vệ phận chứng",
    ...
    bt: "Ngân kiều tán",
    tpbt: ["Kim ngân hoa", "Liên kiều", "Bạc hà", "Cát cánh", "Ngưu bàng tử"]
  },
  "thu_thai_am_phe_kinh": {
    ...
    tpbt: ["Khương hoạt", "Độc hoạt", "Quế chi", "Uy linh tiên", "Cam thảo"]
  }, 
  "am_kieu_mach_chung": {
    hc: "Âm kiều mạch bệnh chứng",
    phanloai: ["Khy kinh", "Lý", "Hư", "Âm kiều mạch"],
    ...
    tpbt: ["Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "Phục thần"]
  },
  "duong_kieu_mach_chung": {
    hc: "Dương kiều mạch bệnh chứng",
    phanloai: ["Khy kinh", "Lý", "Thực", "Dương kiều mạch"],
    ...
    tpbt: ["Tần giao", "Tang ký sinh", "Phòng phong", "Xích thược"]
  },
  "am_duy_mach_chung": {
    hc: "Âm duy mạch bệnh chứng",
    phanloai: ["Khy kinh", "Lý", "Hư", "Âm duy mạch"],
    ...
    tpbt: ["Đan sâm", "Đàn hương", "Cam thảo", "Tiểu mạch", "Đại táo"]
  },
  "duong_duy_mach_chung": {
    hc: "Dương duy mạch bệnh chứng",
    phanloai: ["Khy kinh", "Lý", "Thực", "Dương duy mạch"],
    ...
    tpbt: ["Sài hồ", "Hoàng cầm", "Quế chi", "Bạch thược", "Sinh khương"]
  },
  "can_khi_uat_ket": { hc: "Can khí uất kết", phanloai: ["Tạng Can", "Bình", "Thực", "Khí trệ"], tc: ["Ngực sườn đầy trướng", "Tinh thần u uất", "Hay thở dài", "Dễ cáu gắt", "Kinh nguyệt không đều", "Mạch huyền"], pdt: "Sơ can giải uất, lý khí chỉ thống", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Bạch thược", "Chỉ xác", "Xuyên khung", "Trần bì", "Chích cam thảo"]
  },
  "can_huyet_hu": { hc: "Can huyết hư", phanloai: ["Tạng Can", "Bình", "Hư", "Huyết hư"], tc: ["Sắc mặt úa vàng", "Chóng mặt hoa mắt", "Móng tay chân khô nhợt", "Kinh nguyệt ít sắc nhạt", "Mạch tế nhược"], pdt: "Bổ huyết dưỡng can", bt: "Tứ vật thang", tpbt: ["Thục địa", "Đương quy", "Bạch thược", "Xuyên khung"]
  },
  "can_hoa_thuong_viem": { hc: "Can hỏa thượng viêm", phanloai: ["Tạng Can", "Nhiệt", "Thực", "Can hỏa"], tc: ["Đau đầu chóng mặt", "Mắt đỏ tai ù", "Miệng đắng họng khô", "Hay giận dữ", "Tiểu đỏ đại tiện táo", "Mạch huyền sác"], pdt: "Thanh can tả hỏa", bt: "Long đởm tả can thang", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Trạch tả", "Đương quy", "Sinh địa", "Sài hồ"]
  },
  "can_am_hu": { hc: "Can âm hư", phanloai: ["Tạng Can", "Nhiệt", "Hư", "Âm hư"], tc: ["Chóng mặt hoa mắt", "Mắt khô nhìn mờ", "Má đỏ triều nhiệt", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư dưỡng can âm, minh mục", bt: "Kỷ cúc địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù nhục", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Kỷ tử", "Cúc hoa"]
  },
  "han_tre_can_mach": { hc: "Hàn trệ Can mạch", phanloai: ["Tạng Can", "Hàn", "Thực", "Hàn trệ"], tc: ["Đau quặn bụng dưới", "Đau lan xuống bộ phận sinh dục", "Gặp lạnh đau tăng ấm giảm", "Mạch huyền trầm khẩn"], pdt: "Ôn kinh tán hàn, noãn can chỉ thống", bt: "Noãn can tiễn", tpbt: ["Tiểu hồi hương", "Nhục quế", "Đương quy", "Câu kỷ tử", "Ô dược", "Trầm hương", "Phục linh"]
  },
  "can_hu_han": { hc: "Can hư hàn", phanloai: ["Tạng Can", "Hàn", "Hư", "Dương hư"], tc: ["Sợ lạnh tay chân lạnh", "Đau đỉnh đầu âm ỉ", "Sắc mặt xanh sạm", "Rêu lưỡi trắng nhuận", "Mạch trầm trì nhược"], pdt: "Ôn bổ can dương", bt: "Ngô thù du thang", tpbt: ["Ngô thù du", "Nhân sâm", "Sinh khương", "Đại táo"]
  },
  "can_duong_thuong_khang": { hc: "Can dương thượng kháng", phanloai: ["Tạng Can", "Nhiệt", "Hư thực thác tạp", "Can dương"], tc: ["Đau đầu chóng mặt dữ dội", "Mặt đỏ mắt đỏ", "Dễ cáu gắt tai ù như ve kêu", "Mất ngủ nhiều mộng", "Mạch huyền lực"], pdt: "Bình can tiềm dương, thanh nhiệt trấn kinh", bt: "Thiên ma câu đằng ẩm", tpbt: ["Thiên ma", "Câu đằng", "Thạch quyết minh", "Chi tử", "Hoàng cầm", "Ngưu tất", "Đỗ trọng"]
  },
  "can_phong_noi_dong": { hc: "Can phong nội động", phanloai: ["Tạng Can", "Nhiệt", "Hư thực", "Nội phong"], tc: ["Chân tay run rẩy co quắp", "Tê dại đầu ngón tay chân", "Chóng mặt hoa mắt", "Sắc mặt nhợt nhạt", "Mạch tế huyền"], pdt: "Dưỡng huyết nhuận can, trấn phong chỉ kinh", bt: "Chấn can tức phong thang", tpbt: ["Ngưu tất", "Đại giả thạch", "Long cốt", "Mẫu lệ", "Quy bản", "Bạch thược", "Huyền sâm"]
  },
  "can_lac_huyet_u": { hc: "Can lạc huyết ứ", phanloai: ["Tạng Can", "Bình", "Thực", "Huyết ứ"], tc: ["Sườn ngực đau nhói cố định", "Cự án", "Đau lan ra lưng", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, lý khí chỉ thống", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Sài hồ", "Xuyên khung"]
  },
  "thap_nhiet_uat_can": { hc: "Thấp nhiệt uất Can", phanloai: ["Tạng Can", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Sườn phải trướng đau", "Miệng đắng ăn kém", "Tiểu tiện đỏ sẻn", "Rêu lưỡi vàng nhớt", "Mạch huyền sác"], pdt: "Thanh nhiệt lợi thấp, sơ can", bt: "Long đởm tả can thang gia giảm", tpbt: ["Long đởm thảo", "Chi tử", "Hoàng cầm", "Sài hồ", "Xa tiền tử", "Trạch tả"]
  },
  "tam_khi_hu": { hc: "Tâm khí hư", phanloai: ["Tạng Tâm", "Bình", "Hư", "Khí hư"], tc: ["Hồi hộp trống ngực", "Thở ngắn mệt mỏi", "Vận động triệu chứng tăng", "Sắc mặt nhợt nhạt", "Mạch tế nhược"], pdt: "Ích khí bổ tâm", bt: "Bảo nguyên thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Phục linh", "Cam thảo", "Ngũ vị tử"]
  },
  "tam_duong_hu": { hc: "Tâm dương hư", phanloai: ["Tạng Tâm", "Hàn", "Hư", "Dương hư"], tc: ["Hồi hộp trống ngực", "Đau tức vùng ngực", "Sợ lạnh tay chân lạnh", "Lưỡi bệu nhợt rêu trắng", "Mạch trầm tế vi"], pdt: "Ôn bổ tâm dương, thông mạch", bt: "Quế chi cam thảo thang", tpbt: ["Quế chi", "Chích cam thảo", "Đảng sâm", "Phụ tử", "Hồng hoa"]
  },
  "tam_am_hu": { hc: "Tâm âm hư", phanloai: ["Tạng Tâm", "Nhiệt", "Hư", "Âm hư"], tc: ["Hồi hộp hay hoảng hốt", "Mất ngủ nhiều mộng", "Lòng bàn tay chân nóng đạo hãn", "Gò má đỏ miệng khô", "Mạch tế sác"], pdt: "Tư âm dưỡng tâm, an thần", bt: "Thiên vương bổ tâm đan", tpbt: ["Sinh địa", "Đảng sâm", "Đan sâm", "Bách hợp", "Toan táo nhân", "Viễn chí", "Phục linh"]
  },
  "tam_huyet_hu": { hc: "Tâm huyết hư", phanloai: ["Tạng Tâm", "Bình", "Hư", "Huyết hư"], tc: ["Hồi hộp chóng mặt", "Mất ngủ hay quên", "Sắc mặt nhợt nhạt môi nhạt", "Mạch tế nhược"], pdt: "Dưỡng huyết an thần", bt: "Tứ vật thang hợp A giao kê tử hoàng thang", tpbt: ["Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "A giao", "Hoàng liên", "Bạch phục thần"]
  },
  "tam_huyet_u_tre": { hc: "Tâm huyết ứ trệ", phanloai: ["Tạng Tâm", "Bình", "Thực", "Huyết ứ"], tc: ["Đau thắt ngực lan ra sau lưng hoặc vai trái", "Môi lưỡi tím tái hoặc điểm ứ huyết", "Mạch kết đại hoặc sáp"], pdt: "Hoạt huyết hóa ứ, thông mạch chỉ thống", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Sinh địa", "Đào nhân", "Hồng hoa", "Chỉ xác", "Xích thược", "Sài hồ", "Cát cánh"]
  },
  "tam_hoa_thuong_viem": { hc: "Tâm hỏa thượng viêm", phanloai: ["Tạng Tâm", "Nhiệt", "Thực", "Hỏa nhiệt"], tc: ["Loét miệng lưỡi đỏ đau", "Hồi hộp bứt rứt khó ngủ", "Mặt đỏ tiểu tiện đỏ rát", "Mạch sác lực"], pdt: "Thanh tâm tả hỏa", bt: "Đạo xích tán", tpbt: ["Sinh địa", "Mộc thông", "Cam thảo khiếu", "Trúc diệp"]
  },
  "tam_than_bat_giao": { hc: "Tâm thận bất giao", phanloai: ["Tạng Tâm", "Nhiệt", "Hư thực", "Tâm thận bất giao"], tc: ["Hồi hộp mất ngủ", "Tâm phiền bứt rứt", "Đầu choáng tai ù", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư âm giáng hỏa, giao hội tâm thận", bt: "Giao thái hoàn", tpbt: ["Hoàng liên", "Nhục quế"]
  },
  "tam_khi_huyet_luon_hu": { hc: "Tâm khí huyết lưỡng hư", phanloai: ["Tạng Tâm", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Hồi hộp trống ngực", "Hay quên chóng mặt", "Sắc mặt nhợt nhạt", "Mệt mỏi đoản khí", "Mạch tế nhược"], pdt: "Ích khí dưỡng huyết, an thần", bt: "Dưỡng tâm thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Đương quy", "Bạch thược", "Phục thần", "Toan táo nhân"]
  },
  "tam_duong_kiep_de": { hc: "Tâm dương kiệt thoát", phanloai: ["Tạng Tâm", "Hàn", "Hư", "Dương khí hư thoát"], tc: ["Hồi hộp dữ dội đột ngột", "Tay chân lạnh ngắt", "Mồ hôi vã như tắm", "Thần khí uể oải", "Mạch vi dục tuyệt"], pdt: "Hồi dương cứu nghịch, ích khí cố thoát", bt: "Sâm phụ thang", tpbt: ["Nhân sâm", "Hắc phụ tử"]
  },
  "tam_bao_huyet_nhiet": { hc: "Tâm bào hỏa nhiệt", phanloai: ["Tạng Tâm", "Nhiệt", "Thực", "Hỏa nhiệt"], tc: ["Hôn mê nói sảng", "Bứt rứt cuồng loạn", "Lưỡi đỏ thẫm", "Mạch sác hữu lực"], pdt: "Thanh tâm lương huyết, định kinh", bt: "An cung ngưu hoàng hoàn", tpbt: ["Ngưu hoàng", "Tê giác", "Uất kim", "Hoàng liên"]
  },
  "ty_khi_hu": { hc: "Tỳ khí hư", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Khí hư"], tc: ["Ăn kém đầy bụng sau ăn", "Mệt mỏi chân tay rã rời", "Sắc mặt vàng úa gầy sút", "Đại tiện lỏng loãng", "Mạch tế nhược"], pdt: "Kiện tỳ ích khí", bt: "Tứ quân tử thang", tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Cam thảo"]
  },
  "ty_duong_hu": { hc: "Tạng Tỳ dương hư", phanloai: ["Tạng Tỳ", "Hàn", "Hư", "Dương hư"], tc: ["Bụng lạnh đau thích chườm ấm", "Sợ lạnh tay chân lạnh", "Đại tiện lỏng loãng ăn sống đồ lạnh trướng bụng", "Lưỡi bệu nhợt", "Mạch trầm trì tế"], pdt: "Ôn trung kiện tỳ, tán hàn chỉ thống", bt: "Lý trung hoàn", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Cam thảo"]
  },
  "ty_khong_thong_nhiep_huyet": { hc: "Tỳ không thống huyết", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Huyết hư"], tc: ["Xuất huyết mạn tính rong kinh đại tiện ra máu", "Sắc mặt nhợt nhạt", "Mệt mỏi ăn kém", "Chất lưỡi nhợt", "Mạch tế nhược"], pdt: "Kiện tỳ ích khí, nhiếp huyết", bt: "Quy tỳ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Phục thần", "Đương quy", "Long nhãn", "Thán khương"]
  },
  "han_thap_khon_ty": { hc: "Hàn thấp khốn Tỳ", phanloai: ["Tạng Tỳ", "Hàn", "Thực", "Thấp trệ"], tc: ["Bụng trướng ăn kém buồn nôn", "Đầu nặng như đội khăn", "Người nặng nề chân tay mỏi", "Rêu lưỡi trắng nhớt", "Mạch nhu hoãn"], pdt: "Vận tỳ hóa thấp, ôn trung hóa trọc", bt: "Bất hoán kim chính khí tán", tpbt: ["Thương truật", "Hậu phác", "Trần bì", "Bán hạ", "Phục linh", "Sinh khương"]
  },
  "ty_vi_khi_hu": { hc: "Tỳ Vị khí hư", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Khí hư"], tc: ["Ăn kém đầy bụng", "Mệt mỏi chân tay rã rời", "Đại tiện lỏng loãng", "Chất lưỡi nhợt", "Mạch tế nhược"], pdt: "Ích khí kiện tỳ, hòa vị", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ", "Thăng ma", "Đương quy"]
  },
  "ty_am_hu": { hc: "Tỳ âm hư", phanloai: ["Tạng Tỳ", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khô khát không muốn uống nước", "Lòng bàn tay chân nóng", "Đại tiện táo hoặc khô", "Chất lưỡi đỏ khô", "Mạch tế sác"], pdt: "Tư dưỡng tỳ âm, sinh tân", bt: "Dưỡng vị thang gia giảm", tpbt: ["Sa sâm", "Mạch môn", "Đơn sâm", "Bạch thược", "Thạch hộc"]
  },
  "ty_khi_ha_ham": { hc: "Tỳ khí hạ hãm", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Khí hãm"], tc: ["Bụng dưới nặng tức", "Cảm giác sa giáng nội tạng", "Đại tiện mót rặn hoặc sa trực tràng", "Mệt mỏi đoản khí", "Mạch nhược"], pdt: "Bổ khí thăng dương", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ", "Thăng ma", "Đương quy"]
  },
  "thap_nhiet_khon_ty": { hc: "Thấp nhiệt khốn Tỳ", phanloai: ["Tạng Tỳ", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Bụng trướng buồn nôn", "Đại tiện nhầy dính hôi", "Nước tiểu vàng đỏ", "Rêu lưỡi vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt hóa thấp, vận tỳ", bt: "Nhân trần cao thang hợp Bình vị tán", tpbt: ["Nhân trần", "Chi tử", "Đại hoàng", "Thương truật", "Hậu phác", "Trần bì"]
  },
  "thuc_tich_ngu_tr_ty": { hc: "Thực tích trệ Tỳ", phanloai: ["Tạng Tỳ", "Bình", "Thực", "Thực tích"], tc: ["Bụng trướng đầy sau ăn", "Ợ hơi chua hôi", "Buồn nôn nôn mửa", "Rêu lưỡi dày nhớt", "Mạch hoạt"], pdt: "Tiêu thực hóa tích, kiện tỳ", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì", "Phục linh"]
  },
  "ty_vi_han_tre": { hc: "Tỳ Vị hàn trệ", phanloai: ["Tạng Tỳ", "Hàn", "Thực", "Hàn trệ"], tc: ["Bụng lạnh đau thích chườm ấm", "Nôn mửa nước trong", "Miệng không khát", "Rêu lưỡi trắng", "Mạch trầm trì"], pdt: "Ôn trung tán hàn, hành khí", bt: "Lương phụ hoàn", tpbt: ["Cao lương khương", "Hương phụ"]
  },
  "phe_khi_hu": { hc: "Phế khí hư", phanloai: ["Tạng Phế", "Bình", "Hư", "Khí hư"], tc: ["Ho khạc đờm loãng trong tiếng ho nhỏ", "Thở ngắn tiếng nói nhỏ", "Sợ gió dễ cảm mạo", "Sắc mặt trắng nhợt", "Mạch hư nhược"], pdt: "Bổ ích phế khí", bt: "Bổ phế thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Tang bạch bì", "Ngũ vị tử", "Thục địa"]
  },
  "phe_am_hu": { hc: "Phế âm hư", phanloai: ["Tạng Phế", "Nhiệt", "Hư", "Âm hư"], tc: ["Ho khan ít đờm ho lâu ngày", "Đờm dính máu hoặc khản tiếng", "Gò má đỏ chiều nhiệt đạo hãn", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư âm nhuận phế, chỉ khái", bt: "Bách hợp cố kim thang", tpbt: ["Bách hợp", "Sinh địa", "Thục địa", "Đương quy", "Bạch thược", "Bối mẫu", "Cát cánh", "Mạch môn"]
  },
  "phong_han_pham_phe": { hc: "Phong hàn phạm Phế", phanloai: ["Tạng Phế", "Hàn", "Thực", "Ngoại cảm"], tc: ["Ho ngứa cổ khạc đờm trắng loãng", "Sợ lạnh sốt không có mồ hôi", "Đau đầu ngạt mũi chảy mũi trong", "Rêu lưỡi trắng mỏng", "Mạch phù khẩn"], pdt: "Sơ phong tán hàn, tuyên phế chỉ khái", bt: "Tam ảo thang", tpbt: ["Ma hoàng", "Hạnh nhân", "Chích cam thảo", "Sinh khương"]
  },
  "phong_nhiet_pham_phe": { hc: "Phong nhiệt phạm Phế", phanloai: ["Tạng Phế", "Nhiệt", "Thực", "Ngoại cảm"], tc: ["Sốt sợ gió nhẹ đau đầu", "Ho khạc đờm vàng đặc", "Đau rát họng khát nước", "Rêu lưỡi vàng mỏng", "Mạch phù sác"], pdt: "Sơ phong thanh nhiệt, tuyên phế hóa đàm", bt: "Tang cúc ẩm", tpbt: ["Tang diệp", "Cúc hoa", "Hạnh nhân", "Cát cánh", "Liên kiều", "Bạc hà", "Cam thảo"]
  },
  "phe_khi_uat": { hc: "Phế khí uất trệ", phanloai: ["Tạng Phế", "Bình", "Thực", "Khí trệ"], tc: ["Ngực tức thở ngắn", "Ho hắng ít đờm", "Tinh thần u uất", "Mạch huyền"], pdt: "Tuyên phế lý khí", bt: "Tứ ma thang gia giảm", tpbt: ["Trần bì", "Hương phụ", "Ô dược", "Binh lang"]
  },
  "phong_thap_pham_phe": { hc: "Phong thấp phạm Phế", phanloai: ["Tạng Phế", "Bình", "Thực", "Phong thấp"], tc: ["Ho khạc đờm dính", "Đầu nặng như đội khăn", "Ngực tức nặng nề", "Rêu lưỡi trắng nhớt", "Mạch nhu"], pdt: "Khu phong hóa thấp, tuyên phế", bt: "Tam nhân thang gia giảm", tpbt: ["Hạnh nhân", "Ý dĩ", "Bạch đậu khấu", "Hậu phác", "Bán hạ"]
  },
  "tao_nhiet_thuong_phe": { hc: "Táo nhiệt thương Phế", phanloai: ["Tạng Phế", "Nhiệt", "Thực", "Táo nhiệt"], tc: ["Ho khan không đờm", "Họng khô đau rát", "Mũi khô môi táo", "Rêu lưỡi vàng khô", "Mạch sác"], pdt: "Thanh nhiệt nhuận táo, tuyên phế", bt: "Tang hạnh thang", tpbt: ["Tang diệp", "Hạnh nhân", "Bối mẫu", "Sa sâm", "Đạm trúc diệp", "Lô căn"]
  },
  "dam_tro_tr_phe": { hc: "Đàm trọc trở Phế", phanloai: ["Tạng Phế", "Hàn", "Thực", "Đàm trọc"], tc: ["Ho khạc đờm trắng loãng nhiều", "Ngực tức thở gấp", "Nằm ngửa không được", "Rêu lưỡi trắng nhớt", "Mạch huyền hoạt"], pdt: "Táo thấp hóa đàm, giáng nghịch bình suyễn", bt: "Nhị trần thang hợp Tam tử dưỡng thân thang", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Cam thảo", "Tô tử", "Lai phục tử", "Bạch giới tử"]
  },
  "phe_lac_huyet_u": { hc: "Phế lạc huyết ứ", phanloai: ["Tạng Phế", "Bình", "Thực", "Huyết ứ"], tc: ["Ngực đau nhói cố định", "Ho khạc đờm lẫn máu đen", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang gia giảm", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Cát cánh"]
  },
  "phe_nhiet_uat_ket": { hc: "Phế nhiệt uất kết", phanloai: ["Tạng Phế", "Nhiệt", "Thực", "Phế nhiệt"], tc: ["Sốt cao ho thấu", "Đờm vàng đặc tanh hôi", "Ngực tức đau", "Rêu lưỡi vàng", "Mạch hồng sác"], pdt: "Thanh phế hóa đàm, giải độc", bt: "Thanh kim hóa đàm thang", tpbt: ["Hoàng cầm", "Chi tử", "Tri mẫu", "Bối mẫu", "Qua lâu", "Tang bạch bì"]
  },
  "than_am_hu": { hc: "Thận âm hư", phanloai: ["Tạng Thận", "Nhiệt", "Hư", "Âm hư"], tc: ["Đau lưng mỏi gối ù tai chóng mặt", "Triều nhiệt đạo hãn lòng bàn tay chân nóng", "Di tinh rụng tóc răng lung lay", "Mạch tế sác"], pdt: "Tư bổ thận âm", bt: "Lục vị địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù nhục", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh"]
  },
  "than_duong_hu": { hc: "Thận dương hư", phanloai: ["Tạng Thận", "Hàn", "Hư", "Dương hư"], tc: ["Đau lưng mỏi gối sợ lạnh tay chân lạnh", "Tiểu tiện nhiều lần về đêm tiểu dầm", "Liệt dương di tinh xuất tinh sớm", "Lưỡi bệu nhợt", "Mạch trầm trì tế"], pdt: "Ôn bổ thận dương", bt: "Hữu quy hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Kỷ tử", "Đỗ trọng", "Lộc giác giao"]
  },
  "than_khi_bhat_co": { hc: "Thận khí bất cố", phanloai: ["Tạng Thận", "Bình", "Hư", "Khí hư"], tc: ["Tiểu tiện rỉ rả tiểu đêm nhiều lần", "Di tinh hoạt tinh đới hạ trắng loãng", "Thắt lưng mỏi yếu", "Mạch trầm tế nhược"], pdt: "Bổ thận cố sáp", bt: "Tang tiêu tiêu tán", tpbt: ["Tang tiêu tiêu", "Long cốt", "Quy bản", "Thạch xương bồ", "Viễn chí", "Phục thần"]
  },
  "than_nap_khi_vo": { hc: "Thận nạp khí hư", phanloai: ["Tạng Thận", "Bình", "Hư", "Khí hư"], tc: ["Ho hen lâu ngày thở gấp khi vận động", "Hơi thở ngắn tiếng nói nhỏ", "Thắt lưng mỏi tự ra mồ hôi", "Mạch trầm tế vô lực"], pdt: "Ôn thận nạp khí", bt: "Kim quỹ thận khí hoàn gia giảm", tpbt: ["Thục địa", "Sơn thù", "Đỗ trọng", "Phụ tử", "Nhục quế", "Hải mã", "Nhân sâm"]
  },
  "than_tinh_bat_tuc": { hc: "Thận tinh bất túc", phanloai: ["Tạng Thận", "Bình", "Hư", "Tinh hư"], tc: ["Đầu choáng tai ù", "Trí nhớ giảm sút", "Răng lung lay tóc rụng", "Chân tay mỏi yếu", "Mạch trầm tế"], pdt: "Bổ thận ích tinh, điền tủy", bt: "Hà xa đại tạo hoàn", tpbt: ["Hà xa", "Thục địa", "Quy bản", "Kỷ tử", "Đỗ trọng"]
  },
  "than_khi_hu": { hc: "Thận khí hư", phanloai: ["Tạng Thận", "Bình", "Hư", "Khí hư"], tc: ["Thắt lưng mỏi yếu", "Tiểu tiện nhiều lần", "Tiểu rỉ rả về đêm", "Chất lưỡi nhợt", "Mạch trầm tế"], pdt: "Bổ ích thận khí", bt: "Kim quỹ thận khí hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Nhục quế", "Phụ tử"]
  },
  "than_am_duong_luong_hu": { hc: "Thận âm dương lưỡng hư", phanloai: ["Tạng Thận", "Bình", "Hư", "Âm dương lưỡng hư"], tc: ["Đau lưng mỏi gối vừa sợ lạnh vừa sốt nóng về chiều", "Tai ù chóng mặt", "Tiểu đêm nhiều", "Mạch trầm tế sác"], pdt: "Âm dương song bổ", bt: "Nhị tiên thang hợp Lục vị địa hoàng hoàn", tpbt: ["Tiên mao", "Tiên linh tỳ", "Đương quy", "Ba kích thiên", "Thục địa", "Sơn thù", "Hoài sơn"]
  },
  "than_hu_thuy_lam": { hc: "Thận hư thủy lạm", phanloai: ["Tạng Thận", "Hàn", "Hư", "Thủy thũng"], tc: ["Phù toàn thân nhất là nửa người dưới", "Bụng trướng nước", "Sợ lạnh chân tay lạnh", "Mạch trầm trì"], pdt: "Ôn dương lợi thủy", bt: "Chân vũ thang", tpbt: ["Hắc phụ tử", "Bạch truật", "Phục linh", "Bạch thược", "Sinh khương"]
  },
  "than_lac_huyet_u": { hc: "Thận lạc huyết ứ", phanloai: ["Tạng Thận", "Bình", "Thực", "Huyết ứ"], tc: ["Thắt lưng đau nhói cố định", "Đau lan xuống mông chân", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Thân thống trục ứ thang", tpbt: ["Đương quy", "Xuyên khung", "Đào nhân", "Hồng hoa", "Ngưu tất", "Địa long"]
  },
  "than_hoa_vuong": { hc: "Thận hỏa vượng", phanloai: ["Tạng Thận", "Nhiệt", "Thực", "Thận hỏa"], tc: ["Dâm dục vọng động", "Di tinh xuất tinh sớm", "Tâm phiền bứt rứt", "Lưỡi đỏ rêu vàng", "Mạch huyền sác"], pdt: "Thanh tả thận hỏa", bt: "Tri bách địa hoàng hoàn gia giảm", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Tri mẫu", "Hoàng bá"]
  },
  "vi_khi_hu": { hc: "Vị khí hư", phanloai: ["Phủ Vị", "Bình", "Hư", "Khí hư"], tc: ["Thượng vị đau âm ỉ", "Thích xoa thích ấm", "Ăn kém đầy bụng sau ăn", "Mệt mỏi đoản khí", "Mạch hư nhược"], pdt: "Ích khí kiện vị", bt: "Bổ trung ích khí thang", tpbt: ["Đảng sâm", "Bạch truật", "Hoàng kỳ", "Trần bì", "Cam thảo", "Đương quy"]
  },
  "vi_am_hu": { hc: "Vị âm hư", phanloai: ["Phủ Vị", "Nhiệt", "Hư", "Âm hư"], tc: ["Thượng vị nóng rát", "Âm ỉ đau", "Miệng khô họng khát", "Thích uống nước mát", "Lưỡi đỏ ít rêu", "Mạch tế sác"], pdt: "Tư dưỡng vị âm, sinh tân", bt: "Ích vị thang", tpbt: ["Ngọc trúc", "Sinh địa", "Sa sâm", "Mạch môn"]
  },
  "vi_lac_huyet_u": { hc: "Vị lạc huyết ứ", phanloai: ["Phủ Vị", "Bình", "Thực", "Huyết ứ"], tc: ["Thượng vị đau nhói cố định", "Cự án", "Đau về đêm hoặc sau ăn", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, lý khí chỉ thống", bt: "Thất tiễu tán hợp Diên hồ sách tán", tpbt: ["Ngũ linh tử", "Bồ hoàng", "Diên hồ sách", "Đương quy", "Xích thược", "Xuyên khung"]
  },
  "vi_thuc_tru": { hc: "Vị thực trệ (Thực tích)", phanloai: ["Phủ Vị", "Bình", "Thực", "Trệ tích"], tc: ["Bụng trướng đau", "Cự án", "Ợ hơi chua", "Buồn nôn nôn ra thức ăn cũ", "Đại tiện thối khắm", "Mạch hoạt"], pdt: "Tiêu thực hóa tích, giáng nghịch", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Phục linh", "Bán hạ", "Trần bì", "Lai phục tử", "Liên kiều"]
  },
  "vi_han": { hc: "Vị hàn (Hàn tà phạm Vị)", phanloai: ["Phủ Vị", "Hàn", "Thực", "Ngoại cảm hàn"], tc: ["Thượng vị đột ngột đau quặn", "Gặp lạnh đau tăng", "Chườm ấm đỡ", "Miệng không khát", "Mạch trầm khẩn"], pdt: "Ôn vị tán hàn, hành khí", bt: "Lương phương ngô thù du thang", tpbt: ["Ngô thù du", "Can khương", "Sinh khương", "Đảng sâm"]
  },
  "vi_nhiet_uat": { hc: "Vị nhiệt uất kết", phanloai: ["Phủ Vị", "Nhiệt", "Thực", "Vị nhiệt"], tc: ["Thượng vị nóng rát đau", "Mau đói ăn nhiều", "Miệng hôi họng khát", "Rêu lưỡi vàng", "Mạch sác"], pdt: "Thanh vị tả hỏa", bt: "Thanh vị tán", tpbt: ["Hoàng liên", "Thăng ma", "Sinh địa", "Mẫu đơn bì", "Đại hoàng"]
  },
  "vi_khi_nghich": { hc: "Vị khí thượng nghịch", phanloai: ["Phủ Vị", "Bình", "Thực", "Khí nghịch"], tc: ["Nấc cụt liên tục", "Buồn nôn nôn mửa", "Thượng vị trướng tức", "Mạch huyền hoạt"], pdt: "Giáng nghịch chỉ ẩu", bt: "Quất bì trúc nhự thang", tpbt: ["Trần bì", "Trúc nhự", "Đảng sâm", "Cam thảo", "Sinh khương", "Đại táo"]
  },
  "vi_thong_can_vi_uat": { hc: "Can khí phạm Vị", phanloai: ["Phủ Vị", "Bình", "Thực", "Khí trệ"], tc: ["Thượng vị trướng đau lan sườn ngực", "Ợ hơi ợ chua", "Dễ cáu gắt", "Mạch huyền"], pdt: "Sơ can lý khí, hòa vị", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Xuyên khung", "Hương phụ", "Uất kim"]
  },
  "vi_phong_hof": { hc: "Vị hỏa thượng công", phanloai: ["Phủ Vị", "Nhiệt", "Thực", "Vị hỏa"], tc: ["Răng lợi sưng đau dữ dội", "Hơi thở hôi thối", "Miệng khô khát", "Mạch sác lực"], pdt: "Thanh nhiệt tả hỏa, tiêu thũng", bt: "Thanh vị tán gia giảm", tpbt: ["Thạch cao", "Hoàng liên", "Sinh địa", "Mẫu đơn bì", "Đại hoàng"]
  },
  "vi_khis_hu_han": { hc: "Vị dương hư hàn", phanloai: ["Phủ Vị", "Hàn", "Hư", "Dương hư"], tc: ["Thượng vị đau âm ỉ thích chườm ấm", "Nôn ra nước trong", "Tay chân không ấm", "Mạch trầm trì"], pdt: "Ôn trung tán hàn, kiện vị", bt: "Hoàng kỳ kiến trung thang", tpbt: ["Hoàng kỳ", "Quế chi", "Bạch thược", "Cam thảo", "Sinh khương", "Đại táo", "Th đường"]
  },
  "dai_trang_thap_nhiet": { hc: "Đại tràng thấp nhiệt", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Bụng quặn đau", "Đại tiện nhầy máu", "Mót rặn", "Hậu môn nóng rát", "Rêu lưỡi vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, điều khí chỉ lỵ", bt: "Thược dược thang", tpbt: ["Bạch thược", "Đương quy", "Hậu phác", "Binh lang", "Mộc hương", "Cam thảo", "Hoàng liên", "Hoàng cầm"]
  },
  "dai_trang_han_thap": { hc: "Đại tràng hàn thấp", phanloai: ["Phủ Đại tràng", "Hàn", "Thực", "Hàn thấp"], tc: ["Bụng đau âm ỉ", "Đại tiện phân lỏng nhầy trắng", "Sợ lạnh tay chân lạnh", "Mạch trầm hoãn"], pdt: "Ôn trung hóa thấp, chỉ tả", bt: "Bất hoán kim chính khí tán", tpbt: ["Hoắc hương", "Bạch truật", "Hậu phác", "Trần bì", "Phục linh", "Can khương"]
  },
  "dai_trang_tan_kho": { hc: "Đại tràng tân dịch khô kiệt (Táo bón)", phanloai: ["Phủ Đại tràng", "Nhiệt", "Hư", "Tân dịch khuy tổn"], tc: ["Đại tiện khô cứng như phân dê", "Nhiều ngày không đi", "Miệng khô", "Chất lưỡi đỏ", "Mạch tế sác"], pdt: "Tư âm nhuận táo, thông tiện", bt: "Tăng dịch thang hợp Ma tử nhân hoàn", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm", "Hỏa nhân", "Hạnh nhân", "Bạch thược"]
  },
  "dai_trang_khi_hu": { hc: "Đại tràng khí hư", phanloai: ["Phủ Đại tràng", "Bình", "Hư", "Khí hư"], tc: ["Đại tiện lỏng loãng hoặc sa trực tràng", "Mót rặn sau đi ngoài", "Mệt mỏi đoản khí", "Mạch tế nhược"], pdt: "Bổ khí kiện tỳ, thăng đề", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ", "Thăng ma"]
  },
  "dai_trang_u_trach": { hc: "Đại tràng ứ trệ huyết trệ", phanloai: ["Phủ Đại tràng", "Bình", "Thực", "Huyết ứ"], tc: ["Bụng dưới đau nhói", "Đại tiện ra máu sẫm", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Chỉ xác"]
  },
  "truong_phong_ha_huyet": { hc: "Trường phong hạ huyết", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Thấp nhiệt tràng vị"], tc: ["Đại tiện ra máu tươi phun thành tia", "Hậu môn sưng đau", "Rêu lưỡi vàng", "Mạch hoạt sác"], pdt: "Thanh nhiệt lợi thấp, lương huyết chỉ huyết", bt: "Hòe hoa tán", tpbt: ["Hòe hoa", "Trắc bách diệp", "Kinh giới tuệ", "Chỉ xác", "Hoàng cầm", "Đương quy"]
  },
  "dai_trang_tien_huyet": { hc: "Đại tràng hư hàn tiện huyết", phanloai: ["Phủ Đại tràng", "Hàn", "Hư", "Hư hàn"], tc: ["Đại tiện ra máu rỉ rả máu nhạt", "Bụng lạnh đau", "Sắc mặt nhợt", "Mạch trầm tế"], pdt: "Ôn dương kiện tỳ, nhiếp huyết", bt: "Hoàng thổ thang", tpbt: ["Can địa hoàng", "Cam thảo", "Bạch truật", "Phụ tử", "A giao", "Hoàng cầm", "Xích thạch chi"]
  },
  "dai_trang_khi_tre": { hc: "Đại trang khí trệ", phanloai: ["Phủ Đại tràng", "Bình", "Thực", "Khí trệ"], tc: ["Bụng trướng đau cự án", "Đại tiện khó khăn muốn đi mà không rặn được", "Mạch huyền"], pdt: "Hành khí đạo trệ", bt: "Lục ma thang", tpbt: ["Đại hoàng", "Binh lang", "Trầm hương", "Mộc hương", "Chỉ xác", "Ô dược"]
  },
  "dai_trang_tiet_ta": { hc: "Đại tràng thấp nhiệt tiết tả", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Tiêu chảy phân tóe nước như bùn vàng", "Hậu môn nóng rát", "Khát nước", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, chỉ tả", bt: "Cát căn hoàng cầm hoàng liên thang", tpbt: ["Cát căn", "Hoàng cầm", "Hoàng liên", "Cam thảo"]
  },
  "dai_trang_tan_khu": { hc: "Đại tràng hư mạn tiết tả", phanloai: ["Phủ Đại tràng", "Hàn", "Hư", "Tỳ thận dương hư"], tc: ["Đại tiện lỏng vào sáng sớm (ngũ canh tả)", "Bụng lạnh đau", "Chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, sáp trường chỉ tả", bt: "Tứ thần hoàn", tpbt: ["Bổ cốt t脂", "Ngô thù du", "Nhục đậu khấu", "Ngũ vị tử", "Sinh khương", "Đại táo"]
  },
  "tieu_truong_thap_nhiet": { hc: "Tiểu trường thấp nhiệt", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Tiểu tiện buốt rát", "Tiểu đỏ", "Bụng dưới trướng căng", "Rêu lưỡi vàng", "Mạch sác"], pdt: "Thanh nhiệt lợi thấp, thông lâm", bt: "Đạo xích tán", tpbt: ["Sinh địa", "Mộc thông", "Cam thảo khiếu", "Trúc diệp", "Xa tiền tử"]
  },
  "tieu_truong_huyet_u": { hc: "Tiểu trường ứ trệ", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Huyết ứ"], tc: ["Bụng dưới đau nhói cố định", "Cự án", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, lý khí", bt: "Thiếu phúc trục ứ thang", tpbt: ["Đương quy", "Xuyên khung", "Xích thược", "Đào nhân", "Hồng hoa", "Quan quế"]
  },
  "tieu_truong_khi_tre": { hc: "Tiểu trường khí trệ", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Khí trệ"], tc: ["Bụng dưới trướng đau lan tinh hoàn", "Đau tăng khi vận động", "Mạch huyền"], pdt: "Hành khí chỉ thống", bt: "Thiên đài ô dược tán", tpbt: ["Ô dược", "Mộc hương", "Tiểu hồi hương", "Thanh bì", "Lương khương", "Trầm hương"]
  },
  "tieu_truong_han": { hc: "Tiểu trường hư hàn", phanloai: ["Phủ Tiểu trường", "Hàn", "Hư", "Dương hư"], tc: ["Bụng dưới đau âm ỉ thích chườm ấm", "Sợ lạnh", "Tiểu tiện trong dài", "Mạch trầm trì"], pdt: "Ôn bổ thận dương, tán hàn", bt: "Hữu quy hoàn gia giảm", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Đỗ trọng", "Kỷ tử"]
  },
  "tieu_truong_thanh_coc": { hc: "Tiểu trường thanh cốc bất phân", phanloai: ["Phủ Tiểu trường", "Hàn", "Hư", "Tỳ thận hư"], tc: ["Ăn vào đi ngoài nguyên thức ăn chưa tiêu", "Bụng sôi đau", "Tay chân lạnh", "Mạch trầm tế"], pdt: "Ôn trung kiện tỳ, cố sáp", bt: "Lý trung hoàn hợp Sâm linh bạch truật tán", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Cam thảo", "Phục linh", "Ý dĩ"]
  },
  "tieu_truong_nhiet": { hc: "Tiểu trường thiệt châm nhiệt", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Thực", "Hỏa nhiệt"], tc: ["Miệng lưỡi lở loét", "Tiểu tiện đỏ rát buốt", "Phiền táo", "Lưỡi đỏ", "Mạch sác"], pdt: "Thanh tâm tả tiểu trường hỏa", bt: "Đạo xích tán", tpbt: ["Sinh địa", "Mộc thông", "Cam thảo khiếu", "Trúc diệp"]
  },
  "tieu_truong_binh_truong": { hc: "Tiểu trường sán khí", phanloai: ["Phủ Tiểu trường", "Hàn", "Thực", "Hàn trệ"], tc: ["Bụng dưới đau quặn lan xuống dịch hoàn", "Sa giáng tinh hoàn đau", "Gặp lạnh đau tăng", "Mạch huyền khẩn"], pdt: "Ôn kinh tán hàn, lý khí định thống", bt: "Noãn can tiễn", tpbt: ["Tiểu hồi hương", "Nhục quế", "Đương quy", "Câu kỷ tử", "Ô dược", "Trầm hương"]
  },
  "tieu_truong_tan_hu": { hc: "Tiểu trường tân dịch hư", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khát thích uống nước mát", "Tiểu tiện ít đỏ", "Đại tiện khô", "Mạch tế sác"], pdt: "Tư âm sinh tân", bt: "Tăng dịch thang", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm"]
  },
  "tieu_truong_thuc_tich": { hc: "Tiểu trường thực tích", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Thực tích"], tc: ["Bụng trướng đau quặn", "Sôi bụng", "Đại tiện phân thối", "Mạch hoạt"], pdt: "Tiêu thực hóa tích", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì"]
  },
  "tieu_truong_khi_huyet_hu": { hc: "Tiểu trường khí huyết hư", phanloai: ["Phủ Tiểu trường", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Bụng dưới co thắt âm ỉ", "Sắc mặt nhợt", "Mệt mỏi hoa mắt", "Mạch tế nhược"], pdt: "Bổ khí dưỡng huyết", bt: "Thập toàn đại bổ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Cam thảo", "Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "Quế chi", "Phục linh"]
  },
  "bang_quang_thap_nhiet": { hc: "Bàng quang thấp nhiệt", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Tiểu tiện khó", "Tiểu buốt tiểu rắt", "Tiểu đỏ đục", "Đau tức hạ vị", "Rêu lưỡi vàng nhớt", "Mạch sác"], pdt: "Thanh nhiệt lợi thấp, thông lâm", bt: "Bát chính tán", tpbt: ["Xa tiền tử", "Cù mạch", "Biển súc", "Hoạt thạch", "Cam thảo", "Đại hoàng", "Chi tử", "Mộc thông"]
  },
  "bang_quang_hu_han": { hc: "Bàng quang hư hàn", phanloai: ["Phủ Bàng quang", "Hàn", "Hư", "Dương hư"], tc: ["Tiểu tiện nhiều lần", "Tiểu dầm", "Tiểu rỉ rả không chủ động", "Sợ lạnh tay chân lạnh", "Mạch trầm trì"], pdt: "Ôn thận cố sáp, súc niệu", bt: "Tang tiêu tiêu tán hợp Súc tuyền hoàn", tpbt: ["Tang tiêu tiêu", "Ích trí nhân", "Ô dược", "Phục thần", "Long cốt", "Quy bản"]
  },
  "bang_quang_thuc_lau": { hc: "Bàng quang thạch lâm", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Thấp nhiệt thạch lậu"], tc: ["Tiểu tiện tắc nghẽn đột ngột", "Đau buốt buốt rát", "Tiểu ra sỏi hoặc ra máu", "Mạch huyền sác"], pdt: "Thanh nhiệt lợi thấp, bài thạch", bt: "Thạch vĩ tán gia giảm", tpbt: ["Thạch vĩ", "Xa tiền tử", "Biển súc", "Cù mạch", "Hoạt thạch", "Kim tiền thảo"]
  },
  "bang_quang_huyet_u": { hc: "Bàng quang huyết ứ", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Huyết ứ"], tc: ["Hạ vị đau nhói", "Tiểu ra máu cục", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, chỉ huyết", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "bang_quang_khi_hu": { hc: "Bàng quang khí hư", phanloai: ["Phủ Bàng quang", "Bình", "Hư", "Khí hư"], tc: ["Tiểu không tự chủ", "Tiểu đêm nhiều lần", "Lưng mỏi", "Mạch tế nhược"], pdt: "Ích khí cố sáp", bt: "Bổ trung ích khí thang hợp Tang tiêu tiêu tán", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Tang tiêu tiêu", "Ích trí nhân"]
  },
  "bang_quang_am_hu": { hc: "Bàng quang âm hư", phanloai: ["Phủ Bàng quang", "Nhiệt", "Hư", "Âm hư"], tc: ["Tiểu tiện ít buốt rát nhẹ", "Lòng bàn tay chân nóng", "Miệng khô", "Mạch tế sác"], pdt: "Tư âm thanh nhiệt", bt: "Lục vị địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh"]
  },
  "bang_quang_khis_tret": { hc: "Bàng quang khí trệ", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Khí trệ"], tc: ["Hạ vị trướng căng", "Tiểu tiện khó khăn không thông", "Mạch huyền"], pdt: "Hành khí lợi thủy", bt: "Trầm hương tán", tpbt: ["Trầm hương", "Biển súc", "Hoạt thạch", "Mộc thông", "Đương quy"]
  },
  "bang_quang_nhiet_lo": { hc: "Bàng quang cao lâm", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Tiểu tiện đục như nước vo gạo", "Buốt rát", "Rêu lưỡi vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, hóa trọc", bt: "Thanh tâm liên tử ẩm", tpbt: ["Hoàng liên", "Hoàng cầm", "Mạch môn", "Xa tiền tử", "Thạch xương bồ"]
  },
  "bang_quang_phong_thap": { hc: "Bàng quang phong thấp", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Phong thấp"], tc: ["Tiểu tiện bất định", "Đầu nặng người mỏi", "Mạch phù nhu"], pdt: "Khu phong trừ thấp, lợi niệu", bt: "Phòng phong thang", tpbt: ["Phòng phong", "Tần giao", "Đương quy", "Xích thược", "Ý dĩ"]
  },
  "bang_quang_tan_hu": { hc: "Bàng quang tân dịch khuy tổn", phanloai: ["Phủ Bàng quang", "Nhiệt", "Hư", "Tân dịch hư"], tc: ["Tiểu tiện sẻn ít", "Miệng khô khát", "Lưỡi đỏ", "Mạch tế sác"], pdt: "Tư âm sinh tân, lợi niệu", bt: "Trư linh thang", tpbt: ["Trư linh", "Phục linh", "Trạch tả", "Hoạt thạch", "A giao"]
  },
  "dom_uat_dam_nhieu": { hc: "Đởm uất đàm nhiễu", phanloai: ["Phủ Đờm", "Nhiệt", "Thực", "Đàm nhiệt"], tc: ["Hồi hộp dễ sợ hãi", "Mất ngủ nhiều mộng", "Chóng mặt miệng đắng", "Nôn mửa nấc cụt", "Rêu lưỡi vàng nhớt", "Mạch hoạt sác"], pdt: "Thanh đởm hòa vị, hóa đàm định chí", bt: "Ôn đởm thang", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Chỉ thực", "Trúc nhự", "Sinh khương", "Cam thảo"]
  },
  "dam_thach_thap_nhiet": { hc: "Đảm thạch thấp nhiệt", phanloai: ["Can Đảm", "Nhiệt", "Thực", "Thấp nhiệt uất kết"], tc: ["Đau vùng sườn phải đột ngột", "Lan lên vai phải hoặc lưng", "Sốt rét run", "Da mắt vàng", "Mạch huyền sác"], pdt: "Thanh nhiệt lợi thấp, thông lợi đản đạo", bt: "Đại sài hồ thang hợp Nhân trần cao thang", tpbt: ["Sài hồ", "Hoàng cầm", "Bạch thược", "Chỉ thực", "Đại hoàng", "Nhân trần", "Chi tử", "Kim tiền thảo"]
  },
  "dom_khi_hu": { hc: "Đởm khí hư", phanloai: ["Phủ Đờm", "Bình", "Hư", "Khí hư"], tc: ["Hay khiếp sợ", "Dễ giật mình", "Tinh thần bất an", "Mạch tế nhược"], pdt: "Ích khí ôn đởm, an thần", bt: "An thần định chí hoàn", tpbt: ["Phục thần", "Phục linh", "Nhân sâm", "Xương bồ", "Viễn chí", "Long răng"]
  },
  "dom_nhiet_uat": { hc: "Đởm nhiệt uất kết", phanloai: ["Phủ Đờm", "Nhiệt", "Thực", "Đàm hỏa"], tc: ["Miệng đắng họng khô", "Hay thở dài", "Tâm phiền bứt rứt", "Mạch huyền sác"], pdt: "Thanh tả đởm hỏa", bt: "Long đởm tả can thang", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Sài hồ", "Sinh địa"]
  },
  "dam_han_tre": { hc: "Đởm hàn trệ", phanloai: ["Phủ Đờm", "Hàn", "Thực", "Hàn trệ"], tc: ["Sườn phải đau âm ỉ", "Sợ lạnh tay chân lạnh", "Mạch trầm khẩn"], pdt: "Ôn kinh tán hàn, lý khí", bt: "Ôn đởm thang gia vị quế chi", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Quế chi", "Can khương"]
  },
  "dam_huyet_u": { hc: "Đởm lạc huyết ứ", phanloai: ["Phủ Đờm", "Bình", "Thực", "Huyết ứ"], tc: ["Sườn phải đau nhói cố định", "Cự án", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Sài hồ"]
  },
  "dam_vi_bat_hoa": { hc: "Can Đởm bất hòa", phanloai: ["Phủ Đờm", "Bình", "Thực", "Khí trệ"], tc: ["Miệng đắng sườn đau", "Buồn nôn ăn kém", "Mạch huyền"], pdt: "Sơ can hòa đởm", bt: "Tiểu sài hồ thang", tpbt: ["Sài hồ", "Hoàng cầm", "Bán hạ", "Đảng sâm", "Cam thảo", "Sinh khương", "Đại táo"]
  },
  "dam_thap_tru": { hc: "Đởm thấp trệ", phanloai: ["Phủ Đờm", "Bình", "Thực", "Thấp trệ"], tc: ["Đầu nặng mắt mờ", "Miệng đắng dính", "Rêu lưỡi nhớt", "Mạch nhu"], pdt: "Hóa thấp tả đởm", bt: "Nhân trần cao thang", tpbt: ["Nhân trần", "Chi tử", "Đại hoàng"]
  },
  "dom_am_hu": { hc: "Đởm âm hư", phanloai: ["Phủ Đờm", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khô đắng họng ráo", "Hồi hộp khó ngủ", "Mạch tế sác"], pdt: "Tư âm thanh đởm", bt: "Tư âm địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Miết giáp"]
  },
  "dom_thuc_tich": { hc: "Đởm vị thực tích", phanloai: ["Phủ Đờm", "Bình", "Thực", "Thực tích"], tc: ["Sườn phải trướng đau", "Ăn không tiêu buồn nôn", "Mạch hoạt"], pdt: "Tiêu thực hóa trệ, hòa đởm", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì"]
  },
  "tam_tieu_thap_nhiet": { hc: "Tam tiêu thấp nhiệt", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Bụng trướng đầy", "Tiểu tiện khó khăn buốt rát", "Nước tiểu đỏ đục", "Sốt nhẹ người nặng nề", "Rêu lưỡi vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, hóa trọc", bt: "Tam nhân thang", tpbt: ["Hạnh nhân", "Ý dĩ", "Bạch đậu khấu", "Hậu phác", "Thông thảo", "Trúc diệp", "Hoạt thạch", "Bán hạ"]
  },
  "tam_tieu_han_thap": { hc: "Tam tiêu hàn thấp", phanloai: ["Phủ Tam tiêu", "Hàn", "Thực", "Hàn thấp"], tc: ["Thân thể nặng nề", "Bụng trướng nước", "Sợ lạnh tay chân lạnh", "Mạch trầm trì"], pdt: "Ôn dương hóa thấp, lợi thủy", bt: "Ngũ linh tán hợp Phụ tử lý trung", tpbt: ["Phục linh", "Trư linh", "Trạch tả", "Bạch truật", "Quế chi", "Hắc phụ tử"]
  },
  "tam_tieu_khi_tre": { hc: "Tam tiêu khí trệ", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Khí trệ"], tc: ["Tam tiêu đều trướng tức", "Ngực sườn bụng dưới đầy căng", "Mạch huyền"], pdt: "Hành khí khai uất, thông tam tiêu", bt: "Tứ ma thang", tpbt: ["Trần bì", "Hương phụ", "Ô dược", "Binh lang"]
  },
  "tam_tieu_thuy_thung": { hc: "Tam tiêu thủy thũng", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Thực", "Thủy thũng"], tc: ["Phù toàn thân từ mặt xuống chân", "Tiểu tiện rất ít", "Rêu lưỡi trắng dày", "Mạch phù sác"], pdt: "Tuyên phế lợi thủy, tiêu thũng", bt: "Việt tí thang hợp Ngũ linh tán", tpbt: ["Ma hoàng", "Thạch cao", "Sinh khương", "Phục linh", "Trạch tả"]
  },
  "tam_tieu_am_hu": { hc: "Tam tiêu âm hư", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Hư", "Âm hư"], tc: ["Tam tiêu khô rát", "Miệng khát tiểu ít đỏ", "Triều nhiệt", "Mạch tế sác"], pdt: "Tư âm thanh nhiệt", bt: "Lục vị địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh"]
  },
  "tam_tieu_duong_hu": { hc: "Tam tiêu dương hư", phanloai: ["Phủ Tam tiêu", "Hàn", "Hư", "Dương hư"], tc: ["Sợ lạnh rõ rệt", "Tay chân lạnh ngắt", "Thủy thũng ấn lõm", "Mạch trầm tế"], pdt: "Ôn bổ tam tiêu dương khí", bt: "Hữu quy hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Đỗ trọng"]
  },
  "tam_tieu_phong_nhiet": { hc: "Tam tiêu phong nhiệt", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Thực", "Ngoại cảm"], tc: ["Sốt cao sợ gió", "Họng sưng đau", "Tiểu tiện vàng", "Mạch phù sác"], pdt: "Tân lương giải biểu, thanh nhiệt", bt: "Ngân kiều tán", tpbt: ["Kim ngân hoa", "Liên kiều", "Bạc hà", "Cát cánh", "Ngưu bàng tử"]
  },
  "tam_tieu_huyet_u": { hc: "Tam tiêu huyết ứ", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Huyết ứ"], tc: ["Toàn thân có chỗ đau nhói cố định", "Sắc mặt tối sạm", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông tam tiêu", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Sài hồ"]
  },
  "tam_tieu_khi_hu": { hc: "Tam tiêu khí hư", phanloai: ["Phủ Tam tiêu", "Bình", "Hư", "Khí hư"], tc: ["Mệt mỏi toàn thân", "Đoản khí lười nói", "Sức đề kháng kém", "Mạch tế nhược"], pdt: "Bổ khí ích vệ", bt: "Ngọc bình phong tán hợp Tứ quân tử", tpbt: ["Hoàng kỳ", "Bạch truật", "Phòng phong", "Đảng sâm", "Phục linh"]
  },
  "tam_tieu_thuc_tich": { hc: "Tam tiêu thực tích trệ", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Thực tích"], tc: ["Bụng ngực trướng đầy", "Ăn uống không tiêu", "Đại tiện bất thường", "Mạch hoạt"], pdt: "Tiêu thực hóa trệ", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì"]
  },
  "ho_phong_han_thuong_phe": { hc: "Ho phong hàn thương phế", phanloai: ["Khái thấu", "Hàn", "Thực", "Ngoại cảm"], tc: ["Ho ngứa cổ khạc đờm trắng loãng", "Sợ lạnh sốt không có mồ hôi", "Ngạt mũi chảy nước mũi trong", "Mạch phù khẩn"], pdt: "Sơ phong tán hàn, tuyên phế chỉ khái", bt: "Tam ảo thang hợp Chỉ thấu tán", tpbt: ["Ma hoàng", "Hạnh nhân", "Cát cánh", "Bạch tiền", "Bách bộ", "Trần bì", "Chích cam thảo"]
  },
  "ho_phong_nhiet_pham_phe": { hc: "Ho phong nhiệt phạm phế", phanloai: ["Khái thấu", "Nhiệt", "Thực", "Ngoại cảm"], tc: ["Ho khạc đờm vàng đặc khó khạc", "Sốt cao sợ gió đau đầu", "Họng sưng đau khát nước", "Mạch phù sác"], pdt: "Sơ phong thanh nhiệt, tuyên phế hóa đàm", bt: "Tang cúc ẩm", tpbt: ["Tang diệp", "Cúc hoa", "Hạnh nhân", "Cát cánh", "Liên kiều", "Bạc hà", "Cam thảo"]
  },
  "ho_phong_tao_thuong_phe": { hc: "Ho phong táo thương phế", phanloai: ["Khái thấu", "Nhiệt", "Thực", "Phong táo"], tc: ["Ho khan ít đờm quánh dính khó khạc", "Họng khô đau rát", "Mũi khô môi khô", "Mạch phù sác"], pdt: "Sơ phong thanh phế, nhuận táo chỉ khái", bt: "Tang hạnh thang", tpbt: ["Tang diệp", "Hạnh nhân", "Bối mẫu", "Sa sâm", "Lô căn", "Chi tử"]
  },
  "ho_thu_nhiet_pham_phe": { hc: "Ho thử nhiệt phạm phế", phanloai: ["Khái thấu", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Ho khạc đờm vàng", "Sốt cao khát nước mệt mỏi", "Ra mồ hôi nhiều", "Mạch nhu sác"], pdt: "Thanh thử giải biểu, nhuận phế", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Tri mẫu", "Mạch môn", "Đảng sâm", "Hoàng kỳ"]
  },
  "ho_dam_nhiet_noi_dinh": { hc: "Ho đàm nhiệt nội đình", phanloai: ["Khái thấu", "Nhiệt", "Thực", "Đàm nhiệt"], tc: ["Ho nhiều đờm vàng đặc sánh tanh hôi", "Ngực tức họng rát", "Sốt phiền táo", "Mạch hoạt sác"], pdt: "Thanh phế hóa đàm, chỉ khái", bt: "Thanh kim hóa đàm thang", tpbt: ["Hoàng cầm", "Chi tử", "Tri mẫu", "Bối mẫu", "Qua lâu", "Tang bạch bì"]
  },
  "ho_dam_han_tro_phe": { hc: "Ho đàm hàn trở phế", phanloai: ["Khái thấu", "Hàn", "Thực", "Đàm hàn"], tc: ["Ho đờm trắng loãng nhiều bọt", "Ngực tức sườn đầy", "Sợ lạnh tay chân lạnh", "Mạch huyền khẩn"], pdt: "Ôn phế hóa đàm, chỉ khái", bt: "Tiểu thanh long thang", tpbt: ["Ma hoàng", "Quế chi", "Can khương", "Tế tân", "Bán hạ", "Ngũ vị tử", "Bạch thược"]
  },
  "ho_khat_huyet_lac_u": { hc: "Ho khái huyết lạc ứ", phanloai: ["Khái thấu", "Bình", "Thực", "Huyết ứ"], tc: ["Ho ngực đau nhói cố định", "Đờm lẫn máu thẫm", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Cát cánh"]
  },
  "ho_phe_khi_khuy_ton": { hc: "Phế khí khuy tổn khái thấu", phanloai: ["Khái thấu", "Bình", "Hư", "Khí hư"], tc: ["Ho tiếng nhỏ đờm loãng trong", "Thở ngắn mệt mỏi", "Sợ gió dễ cảm", "Mạch tế nhược"], pdt: "Bổ ích phế khí, chỉ khái", bt: "Bổ phế thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Tang bạch bì", "Ngũ vị tử", "Thục địa"]
  },
  "ho_phe_am_noi_nhiet": { hc: "Phế âm nội nhiệt khái thấu", phanloai: ["Khái thấu", "Nhiệt", "Hư", "Âm hư"], tc: ["Ho khan lâu ngày ít đờm hoặc đờm lẫn tia máu", "Gò má đỏ chiều nhiệt", "Đạo hãn", "Mạch tế sác"], pdt: "Tư âm nhuận phế, chỉ khái", bt: "Bách hợp cố kim thang", tpbt: ["Bách hợp", "Sinh địa", "Thục địa", "Đương quy", "Bạch thược", "Bối mẫu", "Mạch môn"]
  },
  "ho_can_hoa_pham_phe": { hc: "Can hỏa phạm phế khái thấu", phanloai: ["Khái thấu", "Nhiệt", "Thực", "Can hỏa"], tc: ["Ho từng cơn theo cảm xúc khi cáu gắt", "Ngực sườn trướng đau", "Miệng đắng", "Mạch huyền sác"], pdt: "Thanh can tả phế, chỉ khái", bt: "Đại cáp tán hợp Tiêu dao tán", tpbt: ["Đại cáp", "Thanh đại", "Sài hồ", "Bạch thược", "Hoàng cầm"]
  },
  "ho_vi_nhiet_dong_phe": { hc: "Vị nhiệt động phế khái thấu", phanloai: ["Khái thấu", "Nhiệt", "Thực", "Vị nhiệt"], tc: ["Ho kèm đầy bụng ợ chua", "Miệng khát họng khô", "Ăn nhiều chóng đói", "Mạch sác"], pdt: "Thanh vị tả hỏa, hóa đàm chỉ khái", bt: "Thanh vị tán hợp Nhị trần thang", tpbt: ["Hoàng liên", "Thăng ma", "Sinh địa", "Bán hạ", "Trần bì"]
  },
  "ho_than_duong_hu_suyen": { hc: "Thận dương hư suy khái thấu", phanloai: ["Khái thấu", "Hàn", "Hư", "Thận dương hư"], tc: ["Ho hen lâu ngày thở gấp khi vận động", "Lưng mỏi chân lạnh", "Đoản khí", "Mạch trầm tế"], pdt: "Ôn bổ thận dương, nạp khí định suyễn", bt: "Kim quỹ thận khí hoàn", tpbt: ["Thục địa", "Sơn thù", "Đỗ trọng", "Phụ tử", "Nhục quế", "Hải mã"]
  },
  "ho_han_am_noi_dinh": { hc: "Hàn ẩm nội đình khái thấu", phanloai: ["Khái thấu", "Hàn", "Thực", "Hàn ẩm"], tc: ["Ho đờm loãng trắng nhiều bọt", "Nằm ngửa không được", "Ngực tức", "Mạch huyền khẩn"], pdt: "Ôn dương hóa ẩm, chỉ khái", bt: "Linh quý truật cam thang", tpbt: ["Phục linh", "Quế chi", "Bạch truật", "Cam thảo"]
  },
  "ho_lao_khai_am_hu": { hc: "Lão khái thận hư khái thấu", phanloai: ["Khái thấu", "Bình", "Hư", "Thận hư"], tc: ["Ho mạn tính ở người cao tuổi", "Lưng mỏi tiểu đêm", "Đoản khí", "Mạch trầm tế"], pdt: "Bổ thận ích phế", bt: "Bổ phế thang hợp Lục vị", tpbt: ["Đảng sâm", "Hoàng kỳ", "Thục địa", "Sơn thù", "Ngũ vị tử"]
  },
  "ho_ky_uu_phe_khi_tre": { hc: "Khí uất phế trệ khái thấu", phanloai: ["Khái thấu", "Bình", "Thực", "Khí trệ"], tc: ["Ho từng cơn co thắt", "Ngực tức hay thở dài", "Tinh thần u uất", "Mạch huyền"], pdt: "Lý khí giải uất, chỉ khái", bt: "Tứ ma thang gia giảm", tpbt: ["Trần bì", "Hương phụ", "Ô dược", "Binh lang", "Hạnh nhân"]
  },
  "ho_phong_thap_pham_phe": { hc: "Phong thấp phạm phế khái thấu", phanloai: ["Khái thấu", "Bình", "Thực", "Phong thấp"], tc: ["Ho khạc đờm dính", "Đầu nặng như đội khăn", "Ngực tức nặng nề", "Mạch nhu"], pdt: "Khu phong hóa thấp, tuyên phế", bt: "Tam nhân thang", tpbt: ["Hạnh nhân", "Ý dĩ", "Bạch đậu khấu", "Hậu phác", "Bán hạ"]
  },
  "ho_vi_truong_thuc_tich": { hc: "Vị tràng thực tích khái thấu", phanloai: ["Khái thấu", "Bình", "Thực", "Thực tích"], tc: ["Ho kèm đầy bụng sau ăn", "Ợ chua buồn nôn", "Rêu lưỡi dày", "Mạch hoạt"], pdt: "Tiêu thực hóa tích, chỉ khái", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì"]
  },
  "ho_thu_tao_thuong_phe": { hc: "Thử táo thương phế khái thấu", phanloai: ["Khái thấu", "Nhiệt", "Thực", "Thử táo"], tc: ["Ho khan rát họng mùa hè thu", "Khát nước tiểu vàng", "Mạch phù sác"], pdt: "Thanh thử nhuận táo", bt: "Thanh táo cứu phế thang", tpbt: ["Tang diệp", "Thạch cao", "Hạnh nhân", "Mạch môn", "A giao", "Hồ ma nhân"]
  },
  "ho_am_hu_hoa_vuong": { hc: "Âm hư hỏa vượng khái thấu", phanloai: ["Khái thấu", "Nhiệt", "Hư", "Âm hư"], tc: ["Ho khan rát họng về đêm", "Đạo hãn triều nhiệt", "Mạch tế sác"], pdt: "Dưỡng âm thanh phế", bt: "Dưỡng âm thanh phế thang", tpbt: ["Sinh địa", "Mạch môn", "Bối mẫu", "Đan bì", "Địa cốt bì"]
  },
  "ho_khi_huyet_luong_hu": { hc: "Khí huyết lưỡng hư khái thấu", phanloai: ["Khái thấu", "Bình", "Hư", "Khí huyết hư"], tc: ["Ho kéo dài mệt mỏi sắc mặt nhợt", "Chóng mặt", "Mạch tế nhược"], pdt: "Bổ ích khí huyết, chỉ khái", bt: "Thập toàn đại bổ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Thục địa", "Đương quy", "Bạch thược"]
  }, 
  "tiet_ta_thap_nhiet": { hc: "Tiết tả thấp nhiệt", phanloai: ["Tiết tả", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Tiêu chảy phân tóe nước vàng", "Hậu môn nóng rát", "Khát nước tiểu đỏ", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, hóa trọc chỉ tả", bt: "Cát căn hoàng cầm hoàng liên thang", tpbt: ["Cát căn", "Hoàng cầm", "Hoàng liên", "Cam thảo"]
  },
  "tiet_ta_han_thap": { hc: "Tiết tả hàn thấp", phanloai: ["Tiết tả", "Hàn", "Thực", "Hàn thấp"], tc: ["Tiêu chảy phân loãng trắng", "Bụng đau sôi bụng", "Sợ lạnh tay chân lạnh", "Mạch trầm hoãn"], pdt: "Ôn trung hóa thấp, chỉ tả", bt: "Hoắc hương chính khí tán", tpbt: ["Hoắc hương", "Tô diệp", "Bạch chỉ", "Bán hạ", "Hậu phác", "Trần bì", "Phục linh"]
  },
  "tiet_ta_thu_thap": { hc: "Tiết tả thử thấp", phanloai: ["Tiết tả", "Nhiệt", "Thực", "Thử thấp"], tc: ["Tiêu chảy mùa hè phân tóe nước", "Sốt khát nước mệt mỏi", "Nặng đầu tức ngực", "Mạch nhu sác"], pdt: "Thanh thử hóa thấp, hòa vị", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Hoàng liên", "Mạch môn", "Đảng sâm", "Trúc diệp", "Thạch hộc"]
  },
  "tiet_ta_thuc_tich": { hc: "Tiết tả thực tích", phanloai: ["Tiết tả", "Bình", "Thực", "Thực tích"], tc: ["Tiêu chảy phân thối khắm", "Bụng trướng đau sau giảm", "Ợ hơi chua hôi", "Mạch hoạt"], pdt: "Tiêu thực hóa trệ, đạo trệ chỉ tả", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì", "Phục linh"]
  },
  "tiet_ta_can_ty_bat_hoa": { hc: "Can tỳ bất hòa tiết tả", phanloai: ["Tiết tả", "Bình", "Thực", "Thống tả"], tc: ["Đau bụng muốn đi ngoài ngay sau đau", "Đi xong đỡ đau", "Hay cáu gắt trướng sườn", "Mạch huyền"], pdt: "Sơ can kiện tỳ, thống tả", bt: "Thống tả yếu phương", tpbt: ["Bạch truật", "Bạch thược", "Trần bì", "Phòng phong"]
  },
  "tiet_ta_ty_khi_hu": { hc: "Tỳ khí hư tiết tả", phanloai: ["Tiết tả", "Bình", "Hư", "Khí hư"], tc: ["Tiêu chảy mạn tính ăn kém", "Mệt mỏi chân tay rã rời", "Sắc mặt vàng úa", "Mạch tế nhược"], pdt: "Kiện tỳ ích khí, chỉ tả", bt: "Sâm linh bạch truật tán", tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Cam thảo", "Hoài sơn", "Ý dĩ", "Bạch biển đậu"]
  },
  "tiet_ta_ty_duong_hu": { hc: "Tỳ dương hư tiết tả", phanloai: ["Tiết tả", "Hàn", "Hư", "Dương hư"], tc: ["Tiêu chảy phân sống ăn đồ lạnh là đi", "Bụng lạnh đau thích chườm ấm", "Chân tay lạnh", "Mạch trầm trì"], pdt: "Ôn trung kiện tỳ, tán hàn chỉ tả", bt: "Lý trung hoàn", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Cam thảo"]
  },
  "tiet_ta_ngu_canh_ta": { hc: "Ngũ canh tả (Thận dương hư)", phanloai: ["Tiết tả", "Hàn", "Hư", "Thận dương hư"], tc: ["Tiêu chảy vào lúc sáng sớm (5h sáng)", "Bụng lạnh đau sôi bụng", "Thắt lưng mỏi yếu", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, sáp trường chỉ tả", bt: "Tứ thần hoàn", tpbt: ["Bổ cốt t脂", "Ngô thù du", "Nhục đậu khấu", "Ngũ vị tử", "Sinh khương", "Đại táo"]
  },
  "tiet_ta_khi_ham": { hc: "Tỳ khí hạ hãm tiết tả", phanloai: ["Tiết tả", "Bình", "Hư", "Khí hãm"], tc: ["Tiêu chảy kéo dài kèm sa trực tràng", "Bụng dưới nặng tức", "Mệt mỏi đoản khí", "Mạch nhược"], pdt: "Bổ khí thăng dương, nhiếp trọc", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ", "Thăng ma", "Đương quy"]
  },
  "tiet_ta_dam_troc": { hc: "Đàm trọc trở trệ tiết tả", phanloai: ["Tiết tả", "Bình", "Thực", "Đàm trọc"], tc: ["Tiêu chảy phân nhầy dính", "Đầu nặng người mỏi", "Rêu lưỡi nhớt dày", "Mạch nhu nhược"], pdt: "Hóa thấp trừ đàm, chỉ tả", bt: "Bình vị tán hợp Nhị trần thang", tpbt: ["Thương truật", "Hậu phác", "Trần bì", "Bán hạ", "Phục linh"]
  },
  "tiet_ta_huyet_u": { hc: "Trường lạc huyết ứ tiết tả", phanloai: ["Tiết tả", "Bình", "Thực", "Huyết ứ"], tc: ["Bụng đau nhói cố định kèm tiêu chảy", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Sài hồ"]
  },
  "tiet_ta_vi_han_tich": { hc: "Vị hàn tích trệ tiết tả", phanloai: ["Tiết tả", "Hàn", "Thực", "Hàn tích"], tc: ["Tiêu chảy do nhiễm lạnh ăn đồ sống lạnh", "Bụng quặn đau thích ấm", "Mạch trầm khẩn"], pdt: "Ôn vị tán hàn, tiêu tích", bt: "Hương sa bình vị tán", tpbt: ["Hương phụ", "Sa nhân", "Thương truật", "Hậu phác", "Trần bì"]
  },
  "tiet_ta_vi_khi_nghich": { hc: "Vị khí thượng nghịch tiết tả", phanloai: ["Tiết tả", "Bình", "Thực", "Khí nghịch"], tc: ["Tiêu chảy kèm buồn nôn nôn mửa", "Nấc cụt trướng bụng", "Mạch huyền hoạt"], pdt: "Giáng nghịch hóa trọc, chỉ tả", bt: "Bán hạ sái tâm thang", tpbt: ["Bán hạ", "Hoàng cầm", "Đảng sâm", "Can khương", "Cam thảo", "Hoàng liên"]
  },
  "tiet_ta_am_duong_luong_hu": { hc: "Tỳ thận âm dương lưỡng hư tiết tả", phanloai: ["Tiết tả", "Bình", "Hư", "Âm dương lưỡng hư"], tc: ["Tiêu chảy mạn tính gầy sút", "Vừa sợ lạnh vừa lòng bàn tay chân nóng", "Mạch trầm tế sác"], pdt: "Âm dương song bổ, sáp trường", bt: "Chân vũ thang hợp Tứ thần hoàn", tpbt: ["Hắc phụ tử", "Bạch truật", "Phục linh", "Bổ cốt t脂", "Ngũ vị tử"]
  },
  "tiet_ta_khi_am_luong_hu": { hc: "Khí âm lưỡng hư tiết tả", phanloai: ["Tiết tả", "Nhiệt", "Hư", "Khí âm hư"], tc: ["Tiêu chảy lâu ngày miệng khô khát", "Mệt mỏi đoản khí", "Lưỡi đỏ ít rêu", "Mạch tế sác"], pdt: "Ích khí dưỡng âm, sinh tân chỉ tả", bt: "Sinh mạch tán hợp Sâm linh bạch truật", tpbt: ["Nhân sâm", "Mạch môn", "Ngũ vị tử", "Đảng sâm", "Bạch truật"]
  },
  "tiet_ta_phong_ta_khon_ty": { hc: "Phong tà khốn tỳ tiết tả", phanloai: ["Tiết tả", "Bình", "Thực", "Phong thấp"], tc: ["Tiêu chảy kèm đau đầu sợ gió", "Đau mỏi người", "Mạch phù nhu"], pdt: "Sơ phong hóa thấp, kiện tỳ", bt: "Kinh giới liên kiều thang gia vị", tpbt: ["Kinh giới", "Phòng phong", "Thương truật", "Hậu phác", "Bạch truật"]
  },
  "tiet_ta_nhiet_doc_thinh": { hc: "Nhiệt độc thịnh tiết tả", phanloai: ["Tiết tả", "Nhiệt", "Thực", "Nhiệt độc"], tc: ["Tiêu chảy phân máu mủ nhầy", "Sốt cao bứt rứt mót rặn dữ dội", "Mạch sác lực"], pdt: "Thanh nhiệt giải độc, lương huyết hóa thấp", bt: "Bạch đầu ông thang", tpbt: ["Bạch đầu ông", "Hoàng liên", "Hoàng bá", "Tần giao"]
  },
  "tiet_ta_lao_suy_tuan_hoan": { hc: "Lão suy tỳ thận hư suy tiết tả", phanloai: ["Tiết tả", "Bình", "Hư", "Lão suy"], tc: ["Người cao tuổi tiêu chảy mạn tính", "Sức lực suy kiệt chân tay yếu", "Mạch tế nhược vô lực"], pdt: "Ôn bổ tỳ thận, cố thoát", bt: "Sâm phụ thang hợp Tứ thần hoàn", tpbt: ["Nhân sâm", "Phụ tử", "Bổ cốt t脂", "Ngô thù du", "Phục linh"]
  },
  "tiet_ta_can_vi_bat_hoa": { hc: "Can vị bất hòa tiết tả", phanloai: ["Tiết tả", "Bình", "Thực", "Khí trệ"], tc: ["Tiêu chảy do tức giận", "Đau vùng thượng vị lan sườn", "Ợ hơi", "Mạch huyền"], pdt: "Sơ can hòa vị, chỉ tả", bt: "Tứ nghịch tán hợp Bình vị tán", tpbt: ["Sài hồ", "Bạch thược", "Chỉ thực", "Cam thảo", "Thương truật", "Hậu phác"]
  },
  "tiet_ta_tan_dich_hao_ton": { hc: "Tân dịch hao tổn tiết tả", phanloai: ["Tiết tả", "Nhiệt", "Hư", "Tân dịch khuy tổn"], tc: ["Tiêu chảy nhiều lần mất nước", "Miệng khô khát da khô", "Mạch tế sác"], pdt: "Sinh tân dưỡng dịch, chỉ tả", bt: "Tăng dịch thang", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm", "Bạch thược"]
  }, 
  "ty_hu_dam_thap_beo_phi": { hc: "Tỳ hư đàm thấp béo phì", phanloai: ["Béo phì", "Hư", "Thực", "Đàm thấp"], tc: ["Béo trệ mỡ bụng nhiều", "Mệt mỏi chân tay nặng nề", "Ăn kém đầy bụng", "Mạch nhu nhược"], pdt: "Kiện tỳ ích khí, hóa đàm trừ thấp", bt: "Lục quân tử thang gia giảm", tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Cam thảo", "Bán hạ", "Trần bì"]
  },
  "vi_nhiet_thua_can": { hc: "Vị nhiệt thặng thực béo phì", phanloai: ["Béo phì", "Nhiệt", "Thực", "Vị nhiệt"], tc: ["Mau đói ăn nhiều béo phì thể thực", "Miệng hôi khát nước", "Táo bón rêu vàng", "Mạch hoạt sác"], pdt: "Thanh vị tả hỏa, tiêu thực hóa trọc", bt: "Thanh vị tán hợp Hợp hoan hoàn", tpbt: ["Hoàng liên", "Thăng ma", "Sinh địa", "Mẫu đơn bì", "Đại hoàng"]
  },
  "can_khi_uat_trie_beo_bung": { hc: "Can khí uất trệ béo bụng", phanloai: ["Béo phì", "Bình", "Thực", "Khí trệ"], tc: ["Bụng trướng căng sườn đau", "Tinh thần u uất hay thở dài", "Kinh nguyệt không đều", "Mạch huyền"], pdt: "Sơ can giải uất, lý khí tiêu mỡ", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Bạch thược", "Chỉ xác", "Xuyên khung", "Trần bì", "Hương phụ"]
  },
  "than_duong_hu_thuy_thap": { hc: "Thận dương hư thủy thấp béo phì", phanloai: ["Béo phì", "Hàn", "Hư", "Thận dương hư"], tc: ["Béo phì phù thủng nửa người dưới", "Sợ lạnh tay chân lạnh", "Lưng mỏi tiểu đêm", "Mạch trầm trì"], pdt: "Ôn bổ thận dương, hóa khí lợi thủy", bt: "Hữu quy hoàn hợp Ngũ linh tán", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Đỗ trọng", "Phục linh", "Trạch tả"]
  },
  "dam_truc_tro_trung_tieu": { hc: "Đàm trọc trở trệ trung tiêu", phanloai: ["Béo phì", "Bình", "Thực", "Đàm trọc"], tc: ["Bụng trướng to mỡ dày", "Đầu nặng hoa mắt", "Đờm nhiều miệng dính", "Mạch huyền hoạt"], pdt: "Táo thấp hóa đàm, kiện tỳ tiêu trệ", bt: "Ôn đởm thang hợp Bình vị tán", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Chỉ thực", "Trúc nhự", "Thương truật"]
  },
  "khi_hu_huyet_u_beo_phi": { hc: "Khí hư huyết ứ béo phì", phanloai: ["Béo phì", "Bình", "Hư thực", "Khí hư huyết ứ"], tc: ["Béo phì mệt mỏi đoản khí", "Chất lưỡi tím điểm ứ huyết", "Đau tức ngực sườn", "Mạch tế sáp"], pdt: "Ích khí kiện tỳ, hoạt huyết hóa ứ", bt: "Bổ trung ích khí thang hợp Huyết phủ trục ứ", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Đương quy", "Đào nhân", "Hồng hoa"]
  },
  "tam_tieu_thap_nhiet_beo_phu": { hc: "Tam tiêu thấp nhiệt béo phì", phanloai: ["Béo phì", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Béo phì người nặng nề nóng bức", "Tiểu tiện đỏ sẻn", "Rêu lưỡi vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, hóa trọc", bt: "Tam nhân thang", tpbt: ["Hạnh nhân", "Ý dĩ", "Bạch đậu khấu", "Hậu phác", "Thông thảo", "Trúc diệp"]
  },
  "am_hu_noi_nhiet_beo_phi": { hc: "Âm hư nội nhiệt béo phì", phanloai: ["Béo phì", "Nhiệt", "Hư", "Âm hư"], tc: ["Béo phì kèm lòng bàn tay chân nóng", "Miệng khô khát", "Triều nhiệt đạo hãn", "Mạch tế sác"], pdt: "Tư âm giáng hỏa, thanh nhiệt", bt: "Lục vị địa hoàng hoàn gia giảm", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Tri mẫu"]
  },
  "ty_vi_thuc_tich_beo_phi": { hc: "Tỳ Vị thực tích béo phì", phanloai: ["Béo phì", "Bình", "Thực", "Thực tích"], tc: ["Bụng trướng đau sau ăn", "Ợ hơi chua hôi", "Đại tiện táo hoặc thối", "Mạch hoạt"], pdt: "Tiêu thực hóa tích, giảm béo", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì", "Phục linh"]
  },
  "phong_thap_tro_trung_beo_phi": { hc: "Phong thấp trở trệ béo phì", phanloai: ["Béo phì", "Bình", "Thực", "Phong thấp"], tc: ["Béo phì kèm chân tay nặng nề đau mỏi", "Đầu như đội khăn", "Mạch nhu", "Rêu trắng nhớt"], pdt: "Khu phong hóa thấp, kiện tỳ", bt: "Phòng phong thông thánh tán", tpbt: ["Phòng phong", "Kinh giới", "Bạc hà", "Ma hoàng", "Thạch cao", "Đại hoàng"]
  },
  "can_dam_thap_nhiet_beo_bung": { hc: "Can Đảm thấp nhiệt béo bụng", phanloai: ["Béo phì", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Béo phì mệt mỏi miệng đắng", "Sườn phải trướng đau", "Nước tiểu vàng", "Mạch huyền sác"], pdt: "Thanh nhiệt lợi thấp, sơ can", bt: "Long đởm tả can thang", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Trạch tả", "Xa tiền tử", "Sài hồ"]
  },
  "thu_nhiet_dong_tieu_beo_phi": { hc: "Thử nhiệt động tiêu béo phì", phanloai: ["Béo phì", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Béo phì mùa hè mệt mỏi khát nước", "Nước tiểu ít đỏ", "Mạch nhu sác"], pdt: "Thanh thử ích khí, hóa thấp", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Mạch môn", "Đảng sâm", "Hoàng kỳ", "Phục linh"]
  },
  "huyet_u_khoi_tieu_beo_phu": { hc: "Huyết ứ trệ trung tiêu béo phì", phanloai: ["Béo phì", "Bình", "Thực", "Huyết ứ"], tc: ["Bụng trướng đau nhói cố định", "Da sạm tối màu", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, tiêu trệ", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Sài hồ"]
  },
  "khi_trie_dam_truc_bung_to": { hc: "Khí trệ đàm trọc bụng to", phanloai: ["Béo phì", "Bình", "Thực", "Khí trệ đàm trọc"], tc: ["Bụng trướng to căng tức", "Ngực sườn đầy", "Tinh thần u uất", "Mạch huyền hoạt"], pdt: "Hành khí khai uất, hóa đàm tiêu béo", bt: "Tứ ma thang hợp Nhị trần thang", tpbt: ["Trần bì", "Hương phụ", "Ô dược", "Binh lang", "Bán hạ", "Phục linh"]
  },
  "than_am_hu_hu_nhiet_beo_phi": { hc: "Thận âm hư nội nhiệt béo phì", phanloai: ["Béo phì", "Nhiệt", "Hư", "Thận âm hư"], tc: ["Béo phì lưng mỏi chóng mặt", "Triều nhiệt đạo hãn", "Mạch tế sác"], pdt: "Tư bổ thận âm, thanh nhiệt", bt: "Tri bách địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Tri mẫu", "Hoàng bá"]
  },
  "tam_khi_hu_beo_phi_met_moi": { hc: "Tâm khí hư béo phì mệt mỏi", phanloai: ["Béo phì", "Bình", "Hư", "Tâm khí hư"], tc: ["Béo phì kèm hồi hộp trống ngực", "Thở ngắn mệt mỏi", "Mạch tế nhược"], pdt: "Ích khí bổ tâm, kiện tỳ", bt: "Bảo nguyên thang hợp Tứ quân tử", tpbt: ["Đảng sâm", "Hoàng kỳ", "Phục linh", "Cam thảo", "Ngũ vị tử"]
  },
  "phe_khi_hu_thuy_thap_beo": { hc: "Phế khí hư thủy thấp béo phì", phanloai: ["Béo phì", "Bình", "Hư", "Phế khí hư"], tc: ["Béo phì đoản khí tiếng nói nhỏ", "Sợ gió dễ cảm", "Mạch hư nhược"], pdt: "Bổ ích phế khí, lợi thủy", bt: "Bổ phế thang hợp Ngũ linh tán", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Phục linh", "Trạch tả", "Ngũ vị tử"]
  },
  "vi_am_hu_hu_nhiet_beo_bung": { hc: "Vị âm hư nội nhiệt béo bụng", phanloai: ["Béo phì", "Nhiệt", "Hư", "Vị âm hư"], tc: ["Béo phì kèm miệng khô họng khát", "Thượng vị nóng rát", "Mạch tế sác"], pdt: "Tư dưỡng vị âm, thanh nhiệt", bt: "Ích vị thang", tpbt: ["Ngọc trúc", "Sinh địa", "Sa sâm", "Mạch môn"]
  },
  "can_duong_thuong_khang_beo": { hc: "Can dương thượng kháng béo phì", phanloai: ["Béo phì", "Nhiệt", "Hư thực", "Can dương"], tc: ["Béo phì kèm đau đầu chóng mặt", "Mặt đỏ mắt đỏ", "Dễ cáu gắt", "Mạch huyền lực"], pdt: "Bình can tiềm dương, thanh nhiệt", bt: "Thiên ma câu đằng ẩm", tpbt: ["Thiên ma", "Câu đằng", "Thạch quyết minh", "Chi tử", "Hoàng cầm", "Ngưu tất"]
  },
  "thap_nhiet_khon_ty_beo_phi": { hc: "Thấp nhiệt khốn tỳ béo phì", phanloai: ["Béo phì", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Béo phì bụng trướng buồn nôn", "Đại tiện nhầy dính", "Nước tiểu vàng", "Mạch nhu sác"], pdt: "Tحanh nhiệt hóa thấp, vận tỳ", bt: "Nhân trần cao thang hợp Bình vị tán", tpbt: ["Nhân trần", "Chi tử", "Đại hoàng", "Thương truật", "Hậu phác", "Trần bì"]
  }, 
  "liet_duong_than_duong_hu": { hc: "Liệt dương do Thận dương hư", phanloai: ["Nam khoa", "Hàn", "Hư", "Thận dương hư"], tc: ["Dương vật không cương cứng", "Sợ lạnh tay chân lạnh", "Thắt lưng mỏi yếu", "Mạch trầm trì tế"], pdt: "Ôn bổ thận dương, tráng dương", bt: "Hữu quy hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Kỷ tử", "Đỗ trọng", "Lộc giác giao"]
  },
  "xuat_tinh_som_tam_than_bat_giao": { hc: "Xuất tinh sớm do Tâm thận bất giao", phanloai: ["Nam khoa", "Nhiệt", "Hư", "Tâm thận bất giao"], tc: ["Xuất tinh sớm tinh thần bất an", "Hồi hộp mất ngủ", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư âm giáng hỏa, giao hội tâm thận", bt: "Giao thái hoàn hợp Thanh tâm liên tử ẩm", tpbt: ["Hoàng liên", "Nhục quế", "Sinh địa", "Mạch môn", "Bách hợp"]
  },
  "di_tinh_than_khi_bat_co": { hc: "Di tinh do Thận khí bất cố", phanloai: ["Nam khoa", "Bình", "Hư", "Thận khí hư"], tc: ["Di tinh hoạt tinh ban ngày khi mệt", "Thắt lưng mỏi yếu", "Tiểu rỉ rả", "Mạch trầm tế"], pdt: "Bổ thận cố sáp, ích tinh", bt: "Tang tiêu tiêu tán", tpbt: ["Tang tiêu tiêu", "Long cốt", "Quy bản", "Thạch xương bồ", "Viễn chí", "Phục thần"]
  },
  "mong_tinh_tam_ti_luong_hu": { hc: "Mộng tinh do Tâm Tỳ lưỡng hư", phanloai: ["Nam khoa", "Bình", "Hư", "Tâm Tỳ hư"], tc: ["Mộng tinh nhiều lần kèm hồi hộp", "Hay quên ăn kém", "Sắc mặt nhợt", "Mạch tế nhược"], pdt: "Ích khí kiện tỳ, dưỡng tâm an thần", bt: "Quy tỳ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Phục thần", "Đương quy", "Long nhãn", "Toan táo nhân"]
  },
  "thap_nhiet_ha_tieu_tien_liet": { hc: "Viêm tiền liệt tuyến mạn do thấp nhiệt hạ tiêu", phanloai: ["Nam khoa", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Đau tức vùng tầng sinh môn và hạ vị", "Tiểu buốt tiểu rắt nước tiểu đục", "Rêu lưỡi vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, hóa trọc thông lâm", bt: "Bát chính tán hợp Long đởm tả can thang", tpbt: ["Xa tiền tử", "Cù mạch", "Biển súc", "Hoạt thạch", "Chi tử", "Hoàng bá", "Xa tiền thảo"]
  },
  "can_kinh_thap_nhiet_tinh_hoan": { hc: "Sưng đau tinh hoàn do Can kinh thấp nhiệt", phanloai: ["Nam khoa", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Tinh hoàn sưng đau đỏ rát", "Miệng đắng họng khô", "Tiểu đỏ", "Mạch huyền sác"], pdt: "Thanh can lợi thấp, tiêu thũng", bt: "Long đởm tả can thang", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Trạch tả", "Xa tiền tử", "Sài hồ", "Mộc thông"]
  },
  "than_am_hu_hoa_vuong_di_tinh": { hc: "Di tinh do Thận âm hư hỏa vượng", phanloai: ["Nam khoa", "Nhiệt", "Hư", "Âm hư hỏa vượng"], tc: ["Mộng tinh liên tục dâm dục vọng động", "Lòng bàn tay chân nóng", "Triều nhiệt", "Mạch tế sác"], pdt: "Tư âm dưỡng huyết, thanh hóa hỏa", bt: "Tri bách địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Tri mẫu", "Hoàng bá"]
  },
  "khi_trie_huyet_u_tinh_lac": { hc: "Đau tức tinh hoàn do khí trệ huyết ứ", phanloai: ["Nam khoa", "Bình", "Thực", "Huyết ứ"], tc: ["Tinh hoàn đau tức cố định", "Cự án", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, lý khí chỉ thống", bt: "Thiếu phúc trục ứ thang", tpbt: ["Đương quy", "Xuyên khung", "Xích thược", "Đào nhân", "Hồng hoa", "Quan quế", "Uất kim"]
  },
  "han_tre_can_mach_san_khi": { hc: "Sán khí do hàn trệ Can mạch", phanloai: ["Nam khoa", "Hàn", "Thực", "Hàn trệ"], tc: ["Đau quặn bụng dưới lan xuống tinh hoàn", "Gặp lạnh đau tăng ấm giảm", "Mạch huyền khẩn"], pdt: "Ôn kinh tán hàn, noãn can chỉ thống", bt: "Noãn can tiễn", tpbt: ["Tiểu hồi hương", "Nhục quế", "Đương quy", "Câu kỷ tử", "Ô dược", "Trầm hương"]
  },
  "ty_vi_khi_hu_nuy_chung": { hc: "Dương nuy do Tỳ Vị khí hư", phanloai: ["Nam khoa", "Bình", "Hư", "Khí hư"], tc: ["Dương vật khó cương kèm mệt mỏi ăn kém", "Đại tiện lỏng", "Chất lưỡi nhợt", "Mạch tế nhược"], pdt: "Ích khí kiện tỳ, thăng dương", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ", "Thăng ma"]
  },
  "tam_khi_hu_liet_duong": { hc: "Liệt dương do Tâm khí hư", phanloai: ["Nam khoa", "Bình", "Hư", "Tâm khí hư"], tc: ["Dương nuy kèm hồi hộp trống ngực", "Thở ngắn mệt mỏi", "Mạch tế nhược"], pdt: "Ích khí bổ tâm, an thần", bt: "Bảo nguyên thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Phục linh", "Cam thảo", "Ngũ vị tử"]
  },
  "thap_nhiet_dong_tinh_phu": { hc: "Động tinh do thấp nhiệt hạ tiêu", phanloai: ["Nam khoa", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Di tinh tự xuất khi bứt rứt thấp nhiệt", "Nước tiểu vàng đỏ", "Rêu vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt hóa thấp, cố tinh", bt: "Biển súc tán hợp Bát chính tán", tpbt: ["Biển súc", "Cù mạch", "Hoạt thạch", "Xa tiền tử", "Mộc thông", "Long đởm thảo"]
  },
  "than_tinh_bat_tuc_vo_tinh": { hc: "Vô tinh do Thận tinh bất túc", phanloai: ["Nam khoa", "Bình", "Hư", "Tinh hư"], tc: ["Không có tinh trùng hoặc chất lượng tinh dịch kém", "Đầu choáng tai ù", "Lưng mỏi", "Mạch trầm tế"], pdt: "Bổ thận ích tinh, điền tủy", bt: "Hà xa đại tạo hoàn hợp Ngũ tử diễn tông hoàn", tpbt: ["Hà xa", "Thục địa", "Câu kỷ tử", "Thỏ ti tử", "Phúc bồn tử", "Ngũ vị tử"]
  },
  "khi_huyet_luong_hu_nam_khoa": { hc: "Suy giảm sinh lý do khí huyết lưỡng hư", phanloai: ["Nam khoa", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Giảm ham muốn sinh lý mệt mỏi sắc mặt nhợt", "Chóng mặt", "Mạch tế nhược"], pdt: "Bổ ích khí huyết, sung dưỡng tinh tạng", bt: "Thập toàn đại bổ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "Quế chi"]
  },
  "can_khi_uat_ket_nam_khoa": { hc: "Rối loạn cương dương do Can khí uất kết", phanloai: ["Nam khoa", "Bình", "Thực", "Khí trệ"], tc: ["Dương nuy do căng thẳng stress u uất", "Ngực sườn trướng đau", "Hay thở dài", "Mạch huyền"], pdt: "Sơ can giải uất, lý khí", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Bạch thược", "Chỉ xác", "Xuyên khung", "Trần bì", "Hương phụ"]
  },
  "thu_nhiet_ha_tieu_nam": { hc: "Bệnh lý nam khoa do thử nhiệt hạ tiêu", phanloai: ["Nam khoa", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Bứt rứt hạ vị nóng bức mùa hè", "Tiểu buốt nhẹ", "Mạch nhu sác"], pdt: "Thanh thử lợi thấp", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Đảng sâm", "Hoàng liên", "Mạch môn"]
  },
  "dam_trac_tro_tinh_lac": { hc: "Đàm trọc trở trệ tinh lạc", phanloai: ["Nam khoa", "Bình", "Thực", "Đàm trọc"], tc: ["Nặng đầu mệt mỏi kèm suy giảm chức năng sinh dục", "Rêu nhớt", "Mạch huyền hoạt"], pdt: "Táo thấp hóa đàm, thông lạc", bt: "Ôn đởm thang", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Chỉ thực", "Trúc nhự", "Sinh khương"]
  },
  "thanh_coc_bat_phan_sinh_tinh": { hc: "Tinh dịch loãng do tỳ thận hư hàn", phanloai: ["Nam khoa", "Hàn", "Hư", "Tỳ thận hư"], tc: ["Tinh dịch loãng ít số lượng", "Bụng lạnh sôi bụng", "Chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, sinh tinh", bt: "Hữu quy hoàn hợp Lý trung hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Đảng sâm", "Can khương", "Bạch truật"]
  },
  "can_hoa_thuong_viem_nam": { hc: "Can hỏa vượng gây nhiễu tinh thất", phanloai: ["Nam khoa", "Nhiệt", "Thực", "Can hỏa"], tc: ["Dễ kích thích mộng tinh di tinh khi cáu gắt", "Mắt đỏ miệng đắng", "Mạch huyền sác"], pdt: "Thanh can tả hỏa, an định tinh thất", bt: "Long đởm tả can thang", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Trạch tả", "Đương quy", "Sinh địa", "Sài hồ"]
  },
  "than_am_duong_luong_hu_nam": { hc: "Suy sinh dục do Thận âm dương lưỡng hư", phanloai: ["Nam khoa", "Bình", "Hư", "Âm dương lưỡng hư"], tc: ["Liệt dương kèm vừa sợ lạnh vừa lòng bàn tay chân nóng", "Đau lưng mỏi gối", "Mạch trầm tế sác"], pdt: "Âm dương song bổ, tráng dương ích tinh", bt: "Nhị tiên thang hợp Hữu quy hoàn", tpbt: ["Tiên mao", "Tiên linh tỳ", "Ba kích", "Phụ tử", "Nhục quế", "Thục địa", "Sơn thù"]
  }, 
  "kinh_nguyet_khong_deu_can_khi_uat": { hc: "Kinh nguyệt không đều do Can khí uất", phanloai: ["Phụ khoa", "Bình", "Thực", "Khí trệ"], tc: ["Kinh nguyệt trước kỳ hoặc sau kỳ không định", "Sắc kinh tối có cục", "Ngực sườn trướng đau", "Mạch huyền"], pdt: "Sơ can giải uất, điều kinh", bt: "Sài hồ sơ can tán hợp Tứ vật thang", tpbt: ["Sài hồ", "Bạch thược", "Chỉ xác", "Xuyên khung", "Đương quy", "Thục địa"]
  },
  "thong_kinh_han_thap": { hc: "Thống kinh do hàn thấp", phanloai: ["Phụ khoa", "Hàn", "Thực", "Hàn thấp"], tc: ["Đau bụng kinh dữ dội trước hoặc trong kỳ", "Chườm ấm đỡ đau", "Sợ lạnh tay chân lạnh", "Mạch trầm khẩn"], pdt: "Ôn kinh tán hàn, hành khí chỉ thống", bt: "Ôn kinh thang gia giảm", tpbt: ["Đương quy", "Xuyên khung", "Bạch thược", "Ngô thù du", "Quế chi", "Hán diệp"]
  },
  "rong_kinh_ty_khi_hu": { hc: "Rong kinh rong huyết do Tỳ khí hư", phanloai: ["Phụ khoa", "Bình", "Hư", "Khí hư"], tc: ["Kinh ra kéo dài số lượng nhiều sắc nhạt", "Mệt mỏi sắc mặt vàng nhợt", "Ăn kém", "Mạch tế nhược"], pdt: "Kiện tỳ ích khí, nhiếp huyết", bt: "Quy tỳ thang hợp Cửu vị hoàn", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Phục linh", "Đương quy", "Long nhãn", "Thán khương"]
  },
  "bang_lau_huyet_nhiet": { hc: "Băng lậu do huyết nhiệt", phanloai: ["Phụ khoa", "Nhiệt", "Thực", "Huyết nhiệt"], tc: ["Kinh ra đột ngột ào ạt sắc đỏ sẫm dính", "Mặt đỏ bứt rứt", "Miệng khát", "Mạch sác lực"], pdt: "Thanh nhiệt lương huyết, cố kinh", bt: "Thanh nhiệt cố kinh thang", tpbt: ["Sinh địa", "Hoàng cầm", "Địa cốt bì", "A giao", "Bạch thược", "Hải tiêu tiêu"]
  },
  "doi_ha_thap_nhiet": { hc: "Đới hạ do thấp nhiệt", phanloai: ["Phụ khoa", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Khí hư ra nhiều màu vàng xanh dính hôi", "Âm hộ ngứa rát", "Tiểu đỏ", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, chỉ đới", bt: "Hoàng đới thang", tpbt: ["Hoàng bá", "Xa tiền tử", "Xích thược", "Ý dĩ", "Tỳ giải", "Cam thảo"]
  },
  "doi_ha_ty_than_duong_hu": { hc: "Đới hạ do Tỳ Thận dương hư", phanloai: ["Phụ khoa", "Hàn", "Hư", "Tỳ Thận dương hư"], tc: ["Khí hư ra nhiều màu trắng loãng như nước", "Lưng mỏi chân lạnh", "Bụng dưới nặng", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, cố sáp chỉ đới", bt: "Uyển đới thang", tpbt: ["Bạch truật", "Sơn dược", "Nhân sâm", "Bạch thược", "Xa tiền tử", "Cang truật"]
  },
  "vo_kinh_huyet_u": { hc: "Vô kinh do huyết ứ", phanloai: ["Phụ khoa", "Bình", "Thực", "Huyết ứ"], tc: ["Kinh nguyệt không thấy nhiều tháng", "Bụng dưới đau nhói cố định", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông kinh", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Sài hồ", "Ngưu tất"]
  },
  "thong_kinh_khi_huyet_hu": { hc: "Thống kinh do khí huyết lưỡng hư", phanloai: ["Phụ khoa", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Đau bụng kinh âm ỉ sau kỳ kinh", "Thích xoa bóp", "Sắc mặt nhợt nhạt", "Mạch tế nhược"], pdt: "Bổ khí dưỡng huyết, ôn kinh chỉ thống", bt: "Thánh dụ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "A giao"]
  },
  "kho_chiu_tien_kinh_nguyet_can_duong": { hc: "Hội chứng tiền kinh nguyệt do Can dương vượng", phanloai: ["Phụ khoa", "Nhiệt", "Hư thực", "Can dương vượng"], tc: ["Trước kỳ kinh dễ cáu gắt đau đầu chóng mặt", "Mặt đỏ", "Mất ngủ", "Mạch huyền sác"], pdt: "Bình can tiềm dương, điều kinh", bt: "Thiên ma câu đằng ẩm", tpbt: ["Thiên ma", "Câu đằng", "Thạch quyết minh", "Chi tử", "Hoàng cầm", "Đương quy"]
  },
  "hau_san_phuc_thong_huyet_u": { hc: "Hậu sản phúc thống do huyết ứ", phanloai: ["Phụ khoa", "Bình", "Thực", "Huyết ứ"], tc: ["Sau sinh đau bụng dưới dữ dội", "Sản dịch ra ít hoặc cục sẫm", "Lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, chỉ thống", bt: "Sinh hóa thang", tpbt: ["Đương quy", "Xuyên khung", "Đào nhân", "Can khương", "Chích cam thảo"]
  },
  "hau_san_met_moi_khi_huyet_hu": { hc: "Hậu sản mệt mỏi do khí huyết lưỡng hư", phanloai: ["Phụ khoa", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Sau sinh mệt mỏi hoa mắt chóng mặt", "Sắc mặt trắng nhợt", "Mạch tế nhược"], pdt: "Bổ ích khí huyết", bt: "Bát trân thang", tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Cam thảo", "Thục địa", "Đương quy", "Bạch thược", "Xuyên khung"]
  },
  "tac_tia_sua_can_khi_uat": { hc: "Tắc tia sữa do Can khí uất trệ", phanloai: ["Phụ khoa", "Bình", "Thực", "Khí trệ"], tc: ["Vú sưng căng đau tức sữa không ra", "Tinh thần u uất", "Mạch huyền"], pdt: "Sơ can lý khí, thông sữa", bt: "Qua lâu uyên tán gia giảm", tpbt: ["Qua lâu nhân", "Sài hồ", "Thanh bì", "Xuyên khung", "Bồ công anh", "Thông thảo"]
  },
  "viem_tuyen_vu_nhiet_doc": { hc: "Viêm tuyến vú cấp do nhiệt độc", phanloai: ["Phụ khoa", "Nhiệt", "Thực", "Nhiệt độc"], tc: ["Vú sưng nóng đỏ đau dữ dội", "Sốt cao rét run", "Mạch sác lực"], pdt: "Thanh nhiệt giải độc, tiêu thũng thán ung", bt: "Tiền căn dược độc thang hợp Tiên phương hoạt mệnh ẩm", tpbt: ["Bồ công anh", "Kim ngân hoa", "Liên kiều", "Xích thược", "Đương quy", "Trần bì"]
  },
  "sa_tu_cung_khi_ham": { hc: "Sa tử cung do Tỳ khí hạ hãm", phanloai: ["Phụ khoa", "Bình", "Hư", "Khí hãm"], tc: ["Cảm giác sa giáng vùng âm đạo hạ vị nặng tức", "Mệt mỏi đoản khí", "Mạch nhược"], pdt: "Bổ khí thăng dương", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ", "Thăng ma", "Đương quy"]
  },
  "hoi_chung_tien_man_kinh_am_hu": { hc: "Hội chứng tiền mãn kinh do Âm hư", phanloai: ["Phụ khoa", "Nhiệt", "Hư", "Âm hư"], tc: ["Cơn bốc hỏa vã mồ hôi về chiều", "Lòng bàn tay chân nóng", "Mất ngủ", "Mạch tế sác"], pdt: "Tư âm giáng hỏa", bt: "Tri bách địa hoàng hoàn hợp Nhị tiên thang", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Tri mẫu", "Hoàng bá", "Tiên mao"]
  },
  "kinh_thua_ky_huyet_hu": { hc: "Kinh thưa do huyết hư", phanloai: ["Phụ khoa", "Bình", "Hư", "Huyết hư"], tc: ["Kinh nguyệt chậm kỳ 40-50 ngày mới có", "Lượng ít sắc nhạt", "Sắc mặt úa vàng", "Mạch tế nhược"], pdt: "Bổ huyết điều kinh", bt: "Tứ vật thang gia vị", tpbt: ["Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "Hoàng kỳ", "Đảng sâm"]
  },
  "vo_sinh_do_than_duong_hu": { hc: "Vô sinh nữ do Thận dương hư", phanloai: ["Phụ khoa", "Hàn", "Hư", "Thận dương hư"], tc: ["Lâu không có con tử cung lạnh", "Kinh muộn sắc nhạt", "Sợ lạnh tay chân lạnh", "Mạch trầm trì"], pdt: "Ôn bổ thận dương, sưởi ấm cung bào", bt: "Ôn thận tráng dương thang hợp Ôn kinh hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Đỗ trọng", "Ba kích", "Cẩu tích"]
  },
  "vo_sinh_do_than_am_hu": { hc: "Vô sinh nữ do Thận âm hư", phanloai: ["Phụ khoa", "Nhiệt", "Hư", "Thận âm hư"], tc: ["Hiếm muộn kèm kinh ít khô hạn", "Lòng bàn tay chân nóng", "Đầu choáng tai ù", "Mạch tế sác"], pdt: "Tư bổ thận âm, dưỡng huyết sinh tinh", bt: "Dưỡng tinh chủng ngọc thang", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Đương quy", "Bạch thược", "Kỷ tử", "Thỏ ti tử"]
  },
  "dong_thai_than_khi_hu": { hc: "Động thai do Thận khí hư", phanloai: ["Phụ khoa", "Bình", "Hư", "Thận khí hư"], tc: ["Đau thắt lưng ra huyết âm đạo khi mang thai", "Mệt mỏi", "Mạch trầm tế", "Chất lưỡi nhợt"], pdt: "Bổ thận an thai", bt: "Thọ thai hoàn", tpbt: ["Thỏ ti tử", "Tang ký sinh", "Xuyên tục đoạn", "A giao"]
  },
  "sua_it_hau_san_khi_huyet_hu": { hc: "Thiếu sữa sau sinh do khí huyết hư", phanloai: ["Phụ khoa", "Bình", "Hư", "Khí huyết hư"], tc: ["Sau sinh sữa rất ít hoặc không có", "Vú mềm không đau", "Mệt mỏi sắc mặt nhợt", "Mạch tế nhược"], pdt: "Ích khí dưỡng huyết, thông sữa", bt: "Thông nhũ dụng pháp thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Đương quy", "Xuyên khung", "Mộc thông", "Vương bất lưu hành"]
  }, 
  "can_khi_thu_nghich": { hc: "Can khí thượng nghịch", phanloai: ["Tạng Can", "Bình", "Thực", "Khí nghịch"], tc: ["Đau tức ngực sườn lên đỉnh đầu", "Đau đầu hoa mắt", "Ợ hơi nấc cụt", "Mạch huyền"], pdt: "Bình can giáng nghịch, lý khí", bt: "Toàn phúc đại giá hoàn gia giảm", tpbt: ["Toàn phúc hoa", "Đại giả thạch", "Hương phụ", "Trần bì", "Bán hạ"]
  },
  "can_vi_bat_hoa_thuc_tich": { hc: "Can Vị bất hòa kèm thực tích", phanloai: ["Tạng Can", "Bình", "Thực", "Khí trệ thực tích"], tc: ["Thượng vị trướng đau lan sườn", "Ăn không tiêu ợ chua", "Đại tiện táo hoặc không thông", "Mạch huyền hoạt"], pdt: "Sơ can lý khí, tiêu tích hòa vị", bt: "Sài hồ sơ can tán hợp Bảo hòa hoàn", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Sơn tra", "Thần khúc", "Lai phục tử"]
  },
  "can_than_am_hu": { hc: "Can Thận âm hư", phanloai: ["Tạng Can", "Nhiệt", "Hư", "Âm hư"], tc: ["Đau lưng mỏi gối chóng mặt tai ù", "M mắt khô nhìn mờ", "Triều nhiệt đạo hãn", "Mạch tế sác"], pdt: "Tư bổ can thận âm", bt: "Kỷ cúc địa hoàng hoàn hợp Nhất trí ẩm", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Kỷ tử", "Cúc hoa"]
  },
  "can_ty_bat_hoa": { hc: "Can Tỳ bất hòa", phanloai: ["Tạng Can", "Bình", "Thực", "Khí trệ"], tc: ["Bụng trướng đau lúc đau lúc thôi", "Đại tiện lỏng hoặc táo thất thường", "Ngực sườn đầy trướng", "Mạch huyền"], pdt: "Sơ can kiện tỳ", bt: "Thống tả yếu phương hợp Tứ nghịch tán", tpbt: ["Sài hồ", "Bạch thược", "Chỉ thực", "Cam thảo", "Bạch truật", "Phòng phong"]
  },
  "can_hoa_nhieu_tinh_that": { hc: "Can hỏa nhiễu tinh thất", phanloai: ["Tạng Can", "Nhiệt", "Thực", "Can hỏa"], tc: ["Mộng tinh di tinh liên tục", "Tâm phiền dễ cáu gắt", "Miệng đắng tiểu vàng", "Mạch huyền sác"], pdt: "Thanh can tả hỏa, cố tinh", bt: "Long đởm tả can thang gia vị", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Trạch tả", "Đương quy", "Sinh địa", "Sa uyển tật lê"]
  },
  "can_lac_u_huyet_nhieu_lac": { hc: "Can lạc ứ huyết nhiễu lạc", phanloai: ["Tạng Can", "Bình", "Thực", "Huyết ứ"], tc: ["Sườn ngực đau nhói cố định lan vai lưng", "Chất lưỡi tím sẫm", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Sài hồ", "Ngưu tất"]
  },
  "can_han_pham_vi": { hc: "Can hàn phạm Vị", phanloai: ["Tạng Can", "Hàn", "Thực", "Hàn trệ"], tc: ["Thượng vị đau quặn lan ra sườn ngực", "Gặp lạnh đau tăng chườm ấm giảm", "Nôn mửa nước trong", "Mạch huyền khẩn"], pdt: "Ôn can tán hàn, hành khí hòa vị", bt: "Ngô thù du thang hợp Lương phụ hoàn", tpbt: ["Ngô thù du", "Cao lương khương", "Hương phụ", "Đảng sâm", "Sinh khương"]
  },
  "can_huyet_bat_tuc_hoa_phong": { hc: "Can huyết bất túc hóa phong", phanloai: ["Tạng Can", "Bình", "Hư", "Huyết hư nội phong"], tc: ["Chân tay tê mỏi run rẩy nhẹ", "Chóng mặt hoa mắt", "Móng tay nhợt", "Mạch tế huyền"], pdt: "Dưỡng huyết nhuận can, tức phong", bt: "Tứ vật thang hợp Câu đằng ẩm", tpbt: ["Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "Câu đằng", "Cúc hoa"]
  },
  "can_khi_hoanh_nghich_pham_ty": { hc: "Can khí hoành nghịch phạm Tỳ", phanloai: ["Tạng Can", "Bình", "Thực", "Khí trệ"], tc: ["Bụng trướng đau sau ăn buồn nôn", "Hay thở dài cáu gắt", "Đại tiện lỏng nhão", "Mạch huyền"], pdt: "Sơ can kiện tỳ, lý khí", bt: "Sài hu sâm truật thang", tpbt: ["Sài hồ", "Bạch truật", "Phục linh", "Trần bì", "Bạch thược", "Cam thảo"]
  },
  "can_doc_hoa_thinh": { hc: "Can độc hỏa thịnh", phanloai: ["Tạng Can", "Nhiệt", "Thực", "Can hỏa độc"], tc: ["M mắt đỏ sưng đau dữ dội", "Đầu thống tai ù", "Miệng đắng bứt rứt", "Mạch huyền sác hữu lực"], pdt: "Thanh can tả hỏa, giải độc", bt: "Long đởm tả can thang gia Cúc hoa Thảo quyết minh", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Trạch tả", "Xa tiền tử", "Cúc hoa", "Thảo quyết minh"]
  },
  "can_dam_khi_hu": { hc: "Can Đởm khí hư", phanloai: ["Tạng Can", "Bình", "Hư", "Khí hư"], tc: ["Hay sợ hãi dễ giật mình", "Tinh thần bất an", "Mệt mỏi", "Mạch tế nhược"], pdt: "Ích khí ôn đởm, an thần", bt: "An thần định chí hoàn", tpbt: ["Phục thần", "Phục linh", "Nhân sâm", "Xương bồ", "Viễn chí"]
  },
  "can_lac_thap_nhiet": { hc: "Can lạc thấp nhiệt", phanloai: ["Tạng Can", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Sườn phải trướng đau âm ỉ", "Miệng đắng ăn kém", "Nước tiểu vàng", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, thông lạc", bt: "In trần hào thang gia giảm", tpbt: ["Nhân trần", "Chi tử", "Đại hoàng", "Sài hồ", "Uất kim"]
  },
  "can_duong_hoa_phong": { hc: "Can dương hóa phong", phanloai: ["Tạng Can", "Nhiệt", "Hư thực", "Can phong"], tc: ["Đột ngột chóng mặt hoa mắt dữ dội", "Chân tay run co giật", "Mặt đỏ", "Mạch huyền sác"], pdt: "Bình can tiềm dương, tức phong", bt: "Thiên ma câu đằng ẩm hợp Khởi giao thang", tpbt: ["Thiên ma", "Câu đằng", "Thạch quyết minh", "Ngưu tất", "Bạch thược", "Huyền sâm"]
  },
  "can_am_khuy_ton_sinh_phong": { hc: "Can âm khuy tổn sinh phong", phanloai: ["Tạng Can", "Nhiệt", "Hư", "Âm hư nội phong"], tc: ["Tay chân run giật nhẹ âm ỉ", "Chóng mặt ù tai", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư âm dưỡng huyết, tức phong", bt: "Trấn can tức phong thang gia giảm", tpbt: ["Ngưu tất", "Đại giả thạch", "Quy bản", "Bạch thược", "Huyền sâm", "Thiên ma"]
  },
  "can_huyet_u_tre_ha_tieu": { hc: "Can huyết ứ trệ hạ tiêu", phanloai: ["Tạng Can", "Bình", "Thực", "Huyết ứ"], tc: ["Đau quặn bụng dưới cố định", "Kinh nguyệt cục huyết sẫm", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, chỉ thống", bt: "Thiếu phúc trục ứ thang", tpbt: ["Đương quy", "Xuyên khung", "Xích thược", "Đào nhân", "Hồng hoa", "Quan quế", "Hồ nhiên"]
  },
  "can_khi_uat_hoa_hoa": { hc: "Can khí uất hóa hỏa", phanloai: ["Tạng Can", "Nhiệt", "Thực", "Khí uất hóa hỏa"], tc: ["Ngực sườn trướng đau cáu gắt", "Miệng đắng họng khô", "Mắt đỏ ngủ kém", "Mạch huyền sác"], pdt: "Sơ can tả hỏa, lý khí", bt: "Đan tiêu tiêu dao tán", tpbt: ["Sài hồ", "Bạch thược", "Đương quy", "Bạch truật", "Phục linh", "Đan bì", "Chi tử"]
  },
  "can_than_luong_hu": { hc: "Can Thận lưỡng hư", phanloai: ["Tạng Can", "Bình", "Hư", "Can thận lưỡng hư"], tc: ["Lưng mỏi gối mỏi chóng mặt", "Mắt khô giảm thị lực", "Kinh ít hoặc di tinh", "Mạch trầm tế"], pdt: "Bổ can thận", bt: "Hà xa đại tạo hoàn", tpbt: ["Hà xa", "Thục địa", "Sơn thù", "Đỗ trọng", "Kỷ tử", "Quy bản"]
  },
  "can_lac_khi_tri": { hc: "Can lạc khí trệ", phanloai: ["Tạng Can", "Bình", "Thực", "Khí trệ"], tc: ["Sườn ngực trướng đau không cố định", "Hay thở dài", "Mạch huyền"], pdt: "Hành khí hoạt lạc", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Xuyên khung", "Hương phụ", "Uất kim"]
  },
  "can_phong_thu_nhiet": { hc: "Can phong thử nhiệt", phanloai: ["Tạng Can", "Nhiệt", "Thực", "Thử nhiệt nội phong"], tc: ["Sốt cao co giật hôn mê vào mùa hè", "Mặt đỏ bứt rứt", "Mạch huyền sác"], pdt: "Thanh thử lương huyết, tức phong", bt: "Thanh nhiễu phong đàm thang hợp Tê giác địa hoàng thang", tpbt: ["Sinh địa", "Xích thược", "Mẫu đơn bì", "Câu đằng", "Thiên ma"]
  },
  "can_tam_bat_giao": { hc: "Can Tâm bất giao", phanloai: ["Tạng Can", "Nhiệt", "Hư thực", "Can Tâm bất giao"], tc: ["Hồi hộp mất ngủ dễ cáu gắt", "Tâm phiền bứt rứt", "Đầu choáng", "Mạch huyền sác"], pdt: "Sơ can dưỡng tâm, an thần", bt: "Toan táo nhân thang hợp Tiêu dao tán", tpbt: ["Toan táo nhân", "Bạch phục linh", "Tri mẫu", "Xuyên khung", "Sài hồ", "Bạch thược"]
  }, 
  "tam_khi_am_luong_hu": { hc: "Tâm khí âm lưỡng hư", phanloai: ["Tạng Tâm", "Bình", "Hư", "Khí âm lưỡng hư"], tc: ["Hồi hộp trống ngực mệt mỏi", "Miệng khô gò má đỏ", "Đoản khí tự hãn", "Mạch tế sác vô lực"], pdt: "Ích khí dưỡng âm, bổ tâm", bt: "Sinh mạch tán hợp Bảo nguyên thang", tpbt: ["Nhân sâm", "Mạch môn", "Ngũ vị tử", "Đảng sâm", "Hoàng kỳ", "Cam thảo"]
  },
  "tam_mach_uat_tro": { hc: "Tâm mạch ứ trệ", phanloai: ["Tạng Tâm", "Bình", "Thực", "Huyết ứ"], tc: ["Đau thắt ngực lan ra vai trái lưng", "Môi lưỡi tím tái", "Mạch sáp hoặc kết đại"], pdt: "Hoạt huyết hóa ứ, thông mạch", bt: "Huyết phủ trục ứ thang hợp Hoắc hương chính khí", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Đan sâm"]
  },
  "tam_than_duong_hu_tam": { hc: "Tâm Thận dương hư", phanloai: ["Tạng Tâm", "Hàn", "Hư", "Dương hư"], tc: ["Hồi hộp đau tức ngực sợ lạnh", "Tay chân lạnh ngắt", "Lưng mỏi tiểu đêm", "Mạch trầm tế vi"], pdt: "Ôn bổ tâm thận dương", bt: "Quế chi cam thảo long cốt mẫu lệ thang hợp Tứ nghịch thang", tpbt: ["Quế chi", "Cam thảo", "Phụ tử", "Can khương", "Long cốt", "Mẫu lệ"]
  },
  "tam_ty_khi_huyet_hu": { hc: "Tâm Tỳ khí huyết hư", phanloai: ["Tạng Tâm", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Hồi hộp hay quên ăn kém", "Mệt mỏi sắc mặt nhợt", "Mất ngủ nhiều mộng", "Mạch tế nhược"], pdt: "Ích khí dưỡng huyết, kiện tỳ an thần", bt: "Quy tỳ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Phục thần", "Đương quy", "Long nhãn", "Toan táo nhân"]
  },
  "tam_can_huyet_bat_tuc": { hc: "Tâm Can huyết bất túc", phanloai: ["Tạng Tâm", "Bình", "Hư", "Huyết hư"], tc: ["Hồi hộp chóng mặt hoa mắt", "Mất ngủ hay quên", "Móng tay nhợt", "Mạch tế nhược"], pdt: "Dưỡng huyết an thần, bổ tâm can", bt: "Tứ vật thang hợp A giao kê tử hoàng thang", tpbt: ["Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "A giao", "Hoàng liên"]
  },
  "tam_than_phiền_táo": { hc: "Tâm thần phiền táo", phanloai: ["Tạng Tâm", "Nhiệt", "Thực", "Hỏa nhiệt"], tc: ["Bứt rứt khó ngủ tâm phiền", "Mặt đỏ miệng khát", "Lưỡi đỏ", "Mạch sác"], pdt: "Thanh tâm trừ phiền, an thần", bt: "Chu sa an thần hoàn", tpbt: ["Chu sa", "Hoàng liên", "Sinh địa", "Đương quy", "Cam thảo"]
  },
  "tam_lac_huyet_u_suyt": { hc: "Tâm lạc ứ trệ đau thắt", phanloai: ["Tạng Tâm", "Bình", "Thực", "Huyết ứ"], tc: ["Đau thắt ngực dữ dội đột ngột", "Môi lưỡi tím thẫm", "Mạch sáp hoặc kết đại"], pdt: "Hoạt huyết hóa ứ, lý khí chỉ thống", bt: "Thất tiễu tán hợp Huyết phủ trục ứ thang", tpbt: ["Ngũ linh tử", "Bồ hoàng", "Đương quy", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "tam_hoa_nhieu_tam_bao": { hc: "Tâm bào hỏa thịnh nhiễu thần", phanloai: ["Tạng Tâm", "Nhiệt", "Thực", "Hỏa nhiệt"], tc: ["Hôn mê nói sảng cuồng loạn", "Bứt rứt mất ngủ", "Lưỡi đỏ thẫm", "Mạch sác hữu lực"], pdt: "Thanh tâm lương huyết, định kinh", bt: "An cung ngưu hoàng hoàn", tpbt: ["Ngưu hoàng", "Tê giác", "Uất kim", "Hoàng liên", "Chu sa"]
  },
  "tam_khi_trie_nghich": { hc: "Tâm khí thượng nghịch", phanloai: ["Tạng Tâm", "Bình", "Thực", "Khí nghịch"], tc: ["Hồi hộp kèm tức ngực thở gấp", "Đầu choáng váng", "Mạch huyền đại"], pdt: "Giáng khí định tâm", bt: "Toàn phúc đại giả thạch thang gia giảm", tpbt: ["Toàn phúc hoa", "Đại giả thạch", "Đảng sâm", "Bán hạ", "Trần bì"]
  },
  "tam_am_hu_hoa_vuong": { hc: "Tâm âm hư hỏa vượng", phanloai: ["Tạng Tâm", "Nhiệt", "Hư", "Âm hư hỏa vượng"], tc: ["Hồi hộp mất ngủ bứt rứt", "Lòng bàn tay chân nóng", "Miệng khô gò má đỏ", "Mạch tế sác"], pdt: "Tư âm giáng hỏa, an thần", bt: "Thiên vương bổ tâm đan hợp Giao thái hoàn", tpbt: ["Sinh địa", "Đảng sâm", "Đan sâm", "Bách hợp", "Toan táo nhân", "Hoàng liên", "Nhục quế"]
  },
  "tam_duong_khuy_tton": { hc: "Tâm dương khuy tổn", phanloai: ["Tạng Tâm", "Hàn", "Hư", "Dương hư"], tc: ["Hồi hộp trống ngực sợ lạnh", "Tay chân không ấm", "Lưỡi nhợt bệu", "Mạch trầm tế"], pdt: "Ôn bổ tâm dương", bt: "Quế chi cam thảo thang", tpbt: ["Quế chi", "Chích cam thảo", "Đảng sâm", "Phụ tử"]
  },
  "tam_lac_khi_tret": { hc: "Tâm lạc khí trệ", phanloai: ["Tạng Tâm", "Bình", "Thực", "Khí trệ"], tc: ["Ngực tức đau lan sau lưng", "Tinh thần u uất", "Hay thở dài", "Mạch huyền"], pdt: "Hành khí khai uất, thông tâm lạc", bt: "Sài hồ sơ can tán hợp Xích thược đương quy", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Xuyên khung", "Đương quy", "Uất kim"]
  },
  "tam_huyet_nhiet_chinh": { hc: "Tâm huyết nhiệt chứng", phanloai: ["Tạng Tâm", "Nhiệt", "Thực", "Huyết nhiệt"], tc: ["Lở loét miệng lưỡi đau xót", "Phiền táo khó ngủ", "Tiểu tiện đỏ rát", "Mạch sác"], pdt: "Thanh tâm lương huyết", bt: "Đạo xích tán hợp Hoàng liên giải độc thang", tpbt: ["Sinh địa", "Mộc thông", "Trúc diệp", "Hoàng liên", "Hoàng cầm", "Chi tử"]
  },
  "tam_than_bat_dinh": { hc: "Tâm thần bất định", phanloai: ["Tạng Tâm", "Bình", "Hư", "Thần khí hư"], tc: ["Hồi hộp hay hoảng hốt dễ sợ hãi", "Mất ngủ nhiều mộng", "Mạch tế nhược"], pdt: "Dưỡng tâm an thần", bt: "Cam mạch đại táo thang", tpbt: ["Cam thảo", "Tiểu mạch", "Đại táo"]
  },
  "tam_khi_thap_tre": { hc: "Tâm khí thấp trệ", phanloai: ["Tạng Tâm", "Bình", "Thực", "Thấp trệ"], tc: ["Ngực tức nặng nề đầu nặng", "Ăn kém rêu lưỡi nhớt", "Mạch nhu hoãn"], pdt: "Hóa thấp thông dương, lý khí", bt: "Ôn đởm thang", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Chỉ thực", "Trúc nhự", "Hậu phác"]
  },
  "tam_am_duong_luong_khuy": { hc: "Tâm âm dương lưỡng khuy", phanloai: ["Tạng Tâm", "Bình", "Hư", "Âm dương lưỡng hư"], tc: ["Hồi hộp trống ngực mệt mỏi", "Vừa sợ lạnh vừa lòng bàn tay chân nóng", "Mạch trầm tế sác"], pdt: "Âm dương song bổ, an thần", bt: "Chấn can tức phong thang hợp Bảo nguyên", tpbt: ["Nhân sâm", "Phụ tử", "Sinh địa", "Mạch môn", "Long cốt", "Mẫu lệ"]
  },
  "tam_lac_sthis_u": { hc: "Tâm lạc ứ trọc", phanloai: ["Tạng Tâm", "Bình", "Thực", "Huyết ứ đàm trọc"], tc: ["Đau thắt ngực kèm đờm nhiều nặng ngực", "Môi tím", "Mạch huyền sác hoặc sáp"], pdt: "Hoạt huyết hóa ứ, hóa đàm thông lạc", bt: "Huyết phủ trục ứ thang hợp Nhị trần thang", tpbt: ["Đương quy", "Đào nhân", "Hồng hoa", "Bán hạ", "Trần bì", "Phục linh"]
  },
  "tam_phong_tam_nhieu": { hc: "Tâm phong nhiễu động", phanloai: ["Tạng Tâm", "Nhiệt", "Thực", "Tâm phong"], tc: ["Hồi hộp đột ngột co giật tinh thần hoảng hốt", "Mạch huyền sác"], pdt: "Trấn phong định kinh, thanh tâm", bt: "Chấn can tức phong thang", tpbt: ["Ngưu tất", "Đại giả thạch", "Long cốt", "Mẫu lệ", "Thiên ma", "Câu đằng"]
  },
  "tam_tinh_huyet_khao_thuong": { hc: "Tâm tinh huyết hao tổn", phanloai: ["Tạng Tâm", "Bình", "Hư", "Tinh huyết hư"], tc: ["Hay quên mất ngủ trí nhớ giảm sút", "Sắc mặt nhợt", "Mạch tế nhược"], pdt: "Bổ tâm tinh, dưỡng huyết", bt: "Đại bổ âm hoàn hợp Thiên vương bổ tâm đan", tpbt: ["Thục địa", "Quy bản", "Tri mẫu", "Hoàng bá", "Sinh địa", "Đảng sâm"]
  },
  "tam_khi_khuy_vuc_thoat": { hc: "Tâm khí khuy hư dục thoát", phanloai: ["Tạng Tâm", "Hàn", "Hư", "Khí hư thoát"], tc: ["Hồi hộp dữ dội vã mồ hôi đầm đìa", "Tay chân lạnh ngắt", "Mạch vi dục tuyệt"], pdt: "Hồi dương cứu nghịch, ích khí cố thoát", bt: "Sâm phụ thang", tpbt: ["Nhân sâm", "Hắc phụ tử"]
  }, 
  "ty_khi_trie_nghich": { hc: "Tỳ khí thượng nghịch", phanloai: ["Tạng Tỳ", "Bình", "Thực", "Khí nghịch"], tc: ["Ợ hơi buồn nôn sau ăn", "Đầy trướng thượng vị", "Mệt mỏi", "Mạch huyền hoạt"], pdt: "Giáng nghịch hóa trọc, kiện tỳ", bt: "Bàn hạ sái tâm thang", tpbt: ["Bán hạ", "Hoàng cầm", "Đảng sâm", "Can khương", "Cam thảo", "Hoàng liên"]
  },
  "ty_duong_hu_thuy_thap": { hc: "Tỳ dương hư thủy thấp", phanloai: ["Tạng Tỳ", "Hàn", "Hư", "Dương hư thủy thấp"], tc: ["Bụng trướng đầy phù thũng chân tay", "Sợ lạnh tay chân lạnh", "Đại tiện lỏng", "Mạch trầm trì"], pdt: "Ôn dương lợi thủy, kiện tỳ", bt: "Chân vũ thang", tpbt: ["Hắc phụ tử", "Bạch truật", "Phục linh", "Bạch thược", "Sinh khương"]
  },
  "ty_vi_am_hu_sinh_tan": { hc: "Tỳ Vị âm hư sinh tân kém", phanloai: ["Tạng Tỳ", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khô khát không muốn uống nước", "Lòng bàn tay chân nóng", "Đại tiện khô", "Mạch tế sác"], pdt: "Tư dưỡng tỳ vị âm", bt: "Ích vị thang", tpbt: ["Ngọc trúc", "Sinh địa", "Sa sâm", "Mạch môn"]
  },
  "ty_han_thap_tro_trung": { hc: "Tỳ hàn thấp trở trung tiêu", phanloai: ["Tạng Tỳ", "Hàn", "Thực", "Hàn thấp"], tc: ["Bụng trướng đau thích chườm ấm", "Nôn mửa nước trong", "Người nặng nề", "Mạch trầm hoãn"], pdt: "Ôn trung hóa thấp", bt: "Lý trung hoàn", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Cam thảo"]
  },
  "ty_nhiet_thap_khon_tieu": { hc: "Tỳ thấp nhiệt khốn trở", phanloai: ["Tạng Tỳ", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Bụng trướng buồn nôn ăn kém", "Đại tiện nhầy dính hôi", "Nước tiểu vàng", "Mạch nhu sác"], pdt: "Thanh nhiệt hóa thấp", bt: "Nhân trần cao thang", tpbt: ["Nhân trần", "Chi tử", "Đại hoàng"]
  },
  "ty_khi_ha_ham_vi_truong": { hc: "Tỳ khí hạ hãm vị tràng", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Khí hãm"], tc: ["Sa giáng nội tạng bụng dưới nặng tức", "Đại tiện mót rặn", "Mệt mỏi đoản khí", "Mạch nhược"], pdt: "Bổ khí thăng dương", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ", "Thăng ma", "Đương quy"]
  },
  "ty_khong_nhiep_huyet_truong": { hc: "Tỳ không thống huyết xuất huyết", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Huyết hư"], tc: ["Xuất huyết mạn tính dưới da hoặc rong kinh", "Sắc mặt nhợt nhạt", "Mệt mỏi", "Mạch tế nhược"], pdt: "Kiện tỳ ích khí, nhiếp huyết", bt: "Quy tỳ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Phục linh", "Đương quy", "Long nhãn"]
  },
  "ty_than_duong_hu_ta": { hc: "Tỳ Thận dương hư tiết tả", phanloai: ["Tạng Tỳ", "Hàn", "Hư", "Tỳ thận dương hư"], tc: ["Tiêu chảy lúc sáng sớm ngũ canh tả", "Bụng lạnh đau", "Chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, sáp trường", bt: "Tứ thần hoàn", tpbt: ["Bổ cốt t脂", "Ngô thù du", "Nhục đậu khấu", "Ngũ vị tử", "Sinh khương"]
  },
  "ty_vi_khi_huyet_luong_hu": { hc: "Tỳ Vị khí huyết lưỡng hư", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Ăn kém đầy bụng mệt mỏi", "Sắc mặt nhợt nhạt", "Chóng mặt", "Mạch tế nhược"], pdt: "Ích khí dưỡng huyết, kiện tỳ", bt: "Bổ trung ích khí thang hợp Tứ vật", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Thục địa", "Đương quy", "Bạch thược"]
  },
  "ty_am_duong_luong_khuy": { hc: "Tỳ âm dương lưỡng khuy", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Âm dương lưỡng hư"], tc: ["Ăn kém mệt mỏi kèm lòng bàn tay chân nóng", "Sợ lạnh nhẹ", "Mạch trầm tế sác"], pdt: "Âm dương song bổ, kiện tỳ", bt: "Dưỡng vị thang hợp Lý trung", tpbt: ["Sa sâm", "Mạch môn", "Đảng sâm", "Can khương", "Bạch truật"]
  },
  "ty_lac_huyet_u_tre": { hc: "Tỳ lạc huyết ứ trệ", phanloai: ["Tạng Tỳ", "Bình", "Thực", "Huyết ứ"], tc: ["Bụng trướng đau nhói cố định", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "ty_khi_uat_trie": { hc: "Tỳ khí uất trệ", phanloai: ["Tạng Tỳ", "Bình", "Thực", "Khí trệ"], tc: ["Bụng trướng đầy sau ăn", "Tinh thần u uất", "Ợ hơi", "Mạch huyền"], pdt: "Hành khí kiện tỳ", bt: "Hương sa lục quân tử thang", tpbt: ["Hương phụ", "Sa nhân", "Đảng sâm", "Bạch truật", "Phục linh", "Trần bì"]
  },
  "ty_dam_troc_tro_trung": { hc: "Tỳ đàm trọc trở trệ", phanloai: ["Tạng Tỳ", "Bình", "Thực", "Đàm trọc"], tc: ["Bụng trướng đầy người nặng nề", "Đờm nhiều miệng dính", "Mạch nhu hoạt"], pdt: "Táo thấp hóa đàm, kiện tỳ", bt: "Lục quân tử thang", tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Cam thảo", "Bán hạ", "Trần bì"]
  },
  "ty_vi_thuc_tich_trệ": { hc: "Tỳ Vị thực tích đình trệ", phanloai: ["Tạng Tỳ", "Bình", "Thực", "Thực tích"], tc: ["Bụng trướng đau sau ăn uống", "Ợ chua hôi", "Đại tiện thối", "Mạch hoạt"], pdt: "Tiêu thực hóa tích, kiện tỳ", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì"]
  },
  "ty_duong_khuy_tton_phu": { hc: "Tỳ dương khuy tổn phù thủng", phanloai: ["Tạng Tỳ", "Hàn", "Hư", "Dương hư phù thủng"], tc: ["Phù thũng toàn thân nhất là chân", "Sợ lạnh tay chân lạnh", "Mạch trầm trì"], pdt: "Ôn dương kiện tỳ, lợi thủy", bt: "Thực tỳ ẩm", tpbt: ["Bạch truật", "Phục linh", "Can khương", "Phụ tử", "Hậu phác", "Trần bì"]
  },
  "ty_khi_khuy_nhuoc_met": { hc: "Tỳ khí khuy nhược vô lực", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Khí hư"], tc: ["Mệt mỏi rã rời chân tay không muốn động", "Ăn kém", "Mạch tế nhược"], pdt: "Bổ khí kiện tỳ", bt: "Tứ quân tử thang", tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Cam thảo"]
  },
  "ty_am_khuy_ton_tan": { hc: "Tỳ âm khuy tổn sinh tân", phanloai: ["Tạng Tỳ", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khô khát lưỡi đỏ ít rêu", "Đại tiện táo", "Mạch tế sác"], pdt: "Tư dưỡng tỳ âm", bt: "Dưỡng vị thang", tpbt: ["Sa sâm", "Mạch môn", "Ngọc trúc", "Bạch thược"]
  },
  "ty_vi_han_tich": { hc: "Tỳ Vị hàn tích quặn đau", phanloai: ["Tạng Tỳ", "Hàn", "Thực", "Hàn tích"], tc: ["Bụng lạnh quặn đau đột ngột", "Chườm ấm đỡ", "Mạch trầm khẩn"], pdt: "Ôn trung tán hàn", bt: "Lương phụ hoàn", tpbt: ["Cao lương khương", "Hương phụ"]
  },
  "ty_lac_khi_tret": { hc: "Tỳ lạc khí trệ trướng đau", phanloai: ["Tạng Tỳ", "Bình", "Thực", "Khí trệ"], tc: ["Bụng trướng đau tức âm ỉ", "Hay thở dài", "Mạch huyền"], pdt: "Hành khí lý tỳ", bt: "Hương phụ tử khương thang", tpbt: ["Hương phụ", "Can khương", "Trần bì", "Cam thảo"]
  },
  "ty_than_am_duong_luong_hu": { hc: "Tỳ Thận âm dương lưỡng hư", phanloai: ["Tạng Tỳ", "Bình", "Hư", "Âm dương lưỡng hư"], tc: ["Tiêu chảy mạn tính gầy sút kèm bốc hỏa nhẹ", "Mạch trầm tế sác"], pdt: "Âm dương song bổ, kiện tỳ", bt: "Chân vũ thang hợp Tứ thần hoàn", tpbt: ["Phụ tử", "Bạch truật", "Phục linh", "Bổ cốt t脂", "Ngũ vị tử"]
  }, 
  "phe_khi_am_luong_hu": { hc: "Phế khí âm lưỡng hư", phanloai: ["Tạng Phế", "Bình", "Hư", "Khí âm lưỡng hư"], tc: ["Ho khan ít đờm mệt mỏi", "Thở ngắn tiếng nói nhỏ", "Miệng khô gò má đỏ", "Mạch tế sác vô lực"], pdt: "Ích khí dưỡng âm, nhuận phế", bt: "Sinh mạch tán hợp Bổ phế thang", tpbt: ["Nhân sâm", "Mạch môn", "Ngũ vị tử", "Đảng sâm", "Hoàng kỳ", "Thục địa"]
  },
  "phe_lac_huyet_u_tre": { hc: "Phế lạc huyết ứ trệ", phanloai: ["Tạng Phế", "Bình", "Thực", "Huyết ứ"], tc: ["Ngực đau nhói cố định", "Ho khạc đờm lẫn máu", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Cát cánh"]
  },
  "phe_vi_bat_hoa": { hc: "Phế Vị bất hòa", phanloai: ["Tạng Phế", "Bình", "Thực", "Khí trệ"], tc: ["Ho kèm đầy bụng ợ hơi", "Ăn kém", "Mạch huyền"], pdt: "Tuyên phế hòa vị", bt: "Tân ma thang hợp Nhị trần", tpbt: ["Ma hoàng", "Hạnh nhân", "Bán hạ", "Trần bì", "Phục linh"]
  },
  "phe_than_am_hu_phe": { hc: "Phế Thận âm hư", phanloai: ["Tạng Phế", "Nhiệt", "Hư", "Âm hư"], tc: ["Ho khan lâu ngày gò má đỏ", "Đau lưng mỏi gối đạo hãn", "Mạch tế sác"], pdt: "Tư dưỡng phế thận âm", bt: "Bách hợp cố kim thang hợp Lục vị", tpbt: ["Bách hợp", "Sinh địa", "Thục địa", "Sơn thù", "Mạch môn", "Bối mẫu"]
  },
  "phe_khi_trie_nghich": { hc: "Phế khí thượng nghịch", phanloai: ["Tạng Phế", "Bình", "Thực", "Khí nghịch"], tc: ["Ho hen thở gấp tức ngực", "Không nằm ngửa được", "Mạch huyền hoạt"], pdt: "Tuyên phế giáng nghịch, bình suyễn", bt: "Tô tử giáng khí thang", tpbt: ["Tô tử", "Bán hạ", "Tiền hồ", "Hậu phác", "Đương quy", "Quế tâm"]
  },
  "phe_nhiet_dam_ung": { hc: "Phế nhiệt đàm ủng", phanloai: ["Tạng Phế", "Nhiệt", "Thực", "Đàm nhiệt"], tc: ["Ho đờm vàng đặc sánh sốt cao", "Ngực tức", "Mạch hoạt sác"], pdt: "Thanh phế hóa đàm", bt: "Thanh kim hóa đàm thang", tpbt: ["Hoàng cầm", "Chi tử", "Tri mẫu", "Bối mẫu", "Qua lâu", "Tang bạch bì"]
  },
  "phe_han_dam_sthis": { hc: "Phế hàn đàm trệ", phanloai: ["Tạng Phế", "Hàn", "Thực", "Đàm hàn"], tc: ["Ho đờm trắng loãng nhiều", "Sợ lạnh tay chân lạnh", "Mạch trầm huyền"], pdt: "Ôn phế hóa đàm", bt: "Tiểu thanh long thang", tpbt: ["Ma hoàng", "Quế chi", "Can khương", "Tế tân", "Bán hạ", "Ngũ vị tử"]
  },
  "phe_lac_khi_tret": { hc: "Phế lạc khí trệ", phanloai: ["Tạng Phế", "Bình", "Thực", "Khí trệ"], tc: ["Ngực tức thở ngắn", "Ho hắng", "Mạch huyền"], pdt: "Tuyên phế lý khí", bt: "Tứ ma thang", tpbt: ["Trần bì", "Hương phụ", "Ô dược", "Binh lang"]
  },
  "phe_khi_khuy_khai": { hc: "Phế khí khuy hư", phanloai: ["Tạng Phế", "Bình", "Hư", "Khí hư"], tc: ["Ho tiếng nhỏ đờm loãng", "Thở ngắn tự hãn", "Mạch tế nhược"], pdt: "Bổ ích phế khí", bt: "Bổ phế thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Bạch truật", "Tang bạch bì", "Ngũ vị tử"]
  },
  "phe_am_khuy_ton": { hc: "Phế âm khuy tổn", phanloai: ["Tạng Phế", "Nhiệt", "Hư", "Âm hư"], tc: ["Ho khan ít đờm chiều nhiệt đạo hãn", "Mạch tế sác"], pdt: "Tư âm nhuận phế", bt: "Bách hợp cố kim thang", tpbt: ["Bách hợp", "Sinh địa", "Thục địa", "Đương quy", "Mạch môn"]
  },
  "phe_khi_vuc_thoat": { hc: "Phế khí dục thoát", phanloai: ["Tạng Phế", "Hàn", "Hư", "Khí hư thoát"], tc: ["Thở gấp mồ hôi đầm đìa tay chân lạnh", "Mạch vi dục tuyệt"], pdt: "Ích khí cố thoát, cứu nghịch", bt: "Sâm phụ thang", tpbt: ["Nhân sâm", "Hắc phụ tử"]
  },
  "phong_han_thuc_phe": { hc: "Phong hàn thúc phế", phanloai: ["Tạng Phế", "Hàn", "Thực", "Ngoại cảm"], tc: ["Ho ngứa cổ sợ lạnh sốt không mồ hôi", "Mạch phù khẩn"], pdt: "Sơ phong tán hàn", bt: "Tam ảo thang", tpbt: ["Ma hoàng", "Hạnh nhân", "Chích cam thảo", "Sinh khương"]
  },
  "phong_nhiet_pham_phe_chung": { hc: "Phong nhiệt phạm phế chứng", phanloai: ["Tạng Phế", "Nhiệt", "Thực", "Ngoại cảm"], tc: ["Sốt đau đầu ho đờm vàng", "Mạch phù sác"], pdt: "Sơ phong thanh nhiệt", bt: "Tang cúc ẩm", tpbt: ["Tang diệp", "Cúc hoa", "Hạnh nhân", "Cát cánh", "Liên kiều"]
  },
  "tao_nhiet_pham_phe": { hc: "Táo nhiệt phạm phế", phanloai: ["Tạng Phế", "Nhiệt", "Thực", "Táo nhiệt"], tc: ["Ho khan không đờm họng rát", "Mạch sác"], pdt: "Thanh nhiệt nhuận táo", bt: "Tang hạnh thang", tpbt: ["Tang diệp", "Hạnh nhân", "Bối mẫu", "Sa sâm", "Lô căn"]
  },
  "thu_nhiet_thuong_phe": { hc: "Thử nhiệt thương phế", phanloai: ["Tạng Phế", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Ho khạc đờm vàng sốt cao khát nước", "Mạch nhu sác"], pdt: "Thanh thử giải biểu", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Mạch môn", "Đảng sâm", "Hoàng kỳ"]
  },
  "dam_nhiet_pham_phe": { hc: "Đàm nhiệt phạm phế", phanloai: ["Tạng Phế", "Nhiệt", "Thực", "Đàm nhiệt"], tc: ["Ho đờm vàng đặc ngực tức", "Mạch hoạt sác"], pdt: "Thanh phế hóa đàm", bt: "Thanh kim hóa đàm thang", tpbt: ["Hoàng cầm", "Chi tử", "Tri mẫu", "Bối mẫu", "Qua lâu"]
  },
  "dam_han_tro_phe": { hc: "Đàm hàn trở phế", phanloai: ["Tạng Phế", "Hàn", "Thực", "Đàm hàn"], tc: ["Ho đờm trắng loãng ngực tức", "Mạch huyền khẩn"], pdt: "Ôn phế hóa đàm", bt: "Tiểu thanh long thang", tpbt: ["Ma hoàng", "Quế chi", "Can khương", "Tế tân", "Bán hạ"]
  },
  "huyet_u_pham_phe": { hc: "Huyết ứ phạm phế", phanloai: ["Tạng Phế", "Bình", "Thực", "Huyết ứ"], tc: ["Ngực đau nhói đờm lẫn máu", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "phe_than_duong_hu": { hc: "Phế Thận dương hư", phanloai: ["Tạng Phế", "Hàn", "Hư", "Phế thận dương hư"], tc: ["Ho hen lâu ngày sợ lạnh chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn bổ phế thận dương", bt: "Kim quỹ thận khí hoàn", tpbt: ["Thục địa", "Sơn thù", "Đỗ trọng", "Phụ tử", "Nhục quế"]
  },
  "phe_lac_huyet_u_dong": { hc: "Phế lạc huyết ứ động", phanloai: ["Tạng Phế", "Bình", "Thực", "Huyết ứ"], tc: ["Ngực đau thắt khạc đờm đen", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang gia giảm", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Cát cánh"]
  }, 
  "than_khi_am_luong_khuy": { hc: "Thận khí âm lưỡng khuy", phanloai: ["Tạng Thận", "Bình", "Hư", "Khí âm lưỡng hư"], tc: ["Đau lưng mỏi gối ù tai chóng mặt", "Triều nhiệt đạo hãn", "Tiểu đêm nhiều", "Mạch trầm tế sác"], pdt: "Ích khí tư âm, bổ thận", bt: "Lục vị địa hoàng hoàn hợp Sinh mạch tán", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Nhân sâm", "Mạch môn"]
  },
  "than_duong_khuy_tton_thuy": { hc: "Thận dương khuy tổn thủy thũng", phanloai: ["Tạng Thận", "Hàn", "Hư", "Thận dương hư thủy thũng"], tc: ["Phù thũng nửa người dưới ấn lõm", "Sợ lạnh tay chân lạnh", "Lưng mỏi", "Mạch trầm trì"], pdt: "Ôn bổ thận dương, hóa khí lợi thủy", bt: "Hữu quy hoàn hợp Chân vũ thang", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Bạch truật", "Phục linh", "Sinh khương"]
  },
  "than_tinh_khuy_tton_tri": { hc: "Thận tinh khuy tổn trí tuệ giảm", phanloai: ["Tạng Thận", "Bình", "Hư", "Tinh hư"], tc: ["Trí nhớ giảm sút đầu choáng tai ù", "Tóc rụng răng lung lay", "Chân tay mỏi yếu", "Mạch trầm tế"], pdt: "Bổ thận ích tinh, điền tủy", bt: "Hà xa đại tạo hoàn", tpbt: ["Hà xa", "Thục địa", "Quy bản", "Kỷ tử", "Đỗ trọng", "Sơn thù"]
  },
  "than_lac_huyet_u_trach": { hc: "Thận lạc huyết ứ trệ", phanloai: ["Tạng Thận", "Bình", "Thực", "Huyết ứ"], tc: ["Thắt lưng đau nhói cố định lan mông chân", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Thân thống trục ứ thang", tpbt: ["Đương quy", "Xuyên khung", "Đào nhân", "Hồng hoa", "Ngưu tất", "Địa long"]
  },
  "than_khi_trie_nghich": { hc: "Thận khí thượng nghịch", phanloai: ["Tạng Thận", "Bình", "Thực", "Khí nghịch"], tc: ["Ho hen thở gấp khi vận động", "Lưng mỏi ngực tức", "Mạch trầm huyền"], pdt: "Ôn thận nạp khí, giáng nghịch", bt: "Kim quỹ thận khí hoàn gia giảm", tpbt: ["Thục địa", "Sơn thù", "Đỗ trọng", "Phụ tử", "Nhục quế", "Hải mã"]
  },
  "than_am_hu_hoa_vuong_chung": { hc: "Thận âm hư hỏa vượng chứng", phanloai: ["Tạng Thận", "Nhiệt", "Hư", "Âm hư hỏa vượng"], tc: ["Đau lưng mỏi gối lòng bàn tay chân nóng", "Triều nhiệt đạo hãn", "Di tinh", "Mạch tế sác"], pdt: "Tư âm giáng hỏa, thanh thận", bt: "Tri bách địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Tri mẫu", "Hoàng bá"]
  },
  "than_duong_hu_suy_kiet": { hc: "Thận dương hư suy kiệt", phanloai: ["Tạng Thận", "Hàn", "Hư", "Dương hư khí thoát"], tc: ["Sợ lạnh rõ rệt tay chân lạnh ngắt", "Mồ hôi vã lạnh", "Mạch vi dục tuyệt"], pdt: "Hồi dương cứu nghịch, ôn bổ thận dương", bt: "Sâm phụ thang", tpbt: ["Nhân sâm", "Hắc phụ tử"]
  },
  "than_nap_khi_vo_luc": { hc: "Thận nạp khí vô lực", phanloai: ["Tạng Thận", "Bình", "Hư", "Thận bất nạp khí"], tc: ["Ho hen lâu ngày thở gấp", "Hơi thở ngắn tiếng nói nhỏ", "Mạch trầm tế vô lực"], pdt: "Ôn thận nạp khí", bt: "Hà xa đại tạo hoàn hợp Kim quỹ thận khí", tpbt: ["Hà xa", "Thục địa", "Sơn thù", "Đỗ trọng", "Phụ tử", "Nhục quế"]
  },
  "than_khi_bat_co_tieu": { hc: "Thận khí bất cố tiểu tiện", phanloai: ["Tạng Thận", "Bình", "Hư", "Thận khí hư"], tc: ["Tiểu tiện rỉ rả tiểu đêm nhiều lần", "Tiểu dầm không chủ động", "Mạch trầm tế nhược"], pdt: "Bổ thận cố sáp, súc niệu", bt: "Tang tiêu tiêu tán hợp Súc tuyền hoàn", tpbt: ["Tang tiêu tiêu", "Ích trí nhân", "Ô dược", "Phục thần", "Long cốt", "Quy bản"]
  },
  "than_am_duong_luong_khuy_chung": { hc: "Thận âm dương lưỡng khuy chứng", phanloai: ["Tạng Thận", "Bình", "Hư", "Âm dương lưỡng hư"], tc: ["Đau lưng mỏi gối vừa sợ lạnh vừa sốt nóng về chiều", "Tai ù chóng mặt", "Mạch trầm tế sác"], pdt: "Âm dương song bổ", bt: "Nhị tiên thang hợp Lục vị địa hoàng hoàn", tpbt: ["Tiên mao", "Tiên linh tỳ", "Đương quy", "Ba kích", "Thục địa", "Sơn thù"]
  },
  "than_tinh_bat_tuc_phat_duc": { hc: "Thận tinh bất túc phát dục kém", phanloai: ["Tạng Thận", "Bình", "Hư", "Tinh hư"], tc: ["Thóp chậm liền xương mềm yếu", "Trí tuệ chậm phát triển", "Mạch trầm tế"], pdt: "Bổ thận ích tinh, điền tủy", bt: "Hà xa đại tạo hoàn", tpbt: ["Hà xa", "Thục địa", "Quy bản", "Kỷ tử", "Đỗ trọng"]
  },
  "than_vi_bat_hoa_than": { hc: "Thận Vị bất hòa", phanloai: ["Tạng Thận", "Bình", "Hư thực", "Thận vị bất hòa"], tc: ["Đau lưng mỏi gối kèm buồn nôn ăn kém", "Sợ lạnh", "Mạch trầm tế"], pdt: "Ôn thận kiện vị", bt: "Hữu quy hoàn hợp Lương phương", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Đảng sâm", "Can khương"]
  },
  "than_tam_bat_giao_than": { hc: "Tâm Thận bất giao chứng", phanloai: ["Tạng Thận", "Nhiệt", "Hư thực", "Tâm thận bất giao"], tc: ["Hồi hộp mất ngủ bứt rứt", "Đầu choáng tai ù", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư âm giáng hỏa, giao hội tâm thận", bt: "Giao thái hoàn", tpbt: ["Hoàng liên", "Nhục quế"]
  },
  "than_can_am_hu_than": { hc: "Can Thận âm hư chứng", phanloai: ["Tạng Thận", "Nhiệt", "Hư", "Can thận âm hư"], tc: ["Đau lưng mỏi gối chóng mặt tai ù", "Mắt khô nhìn mờ", "Mạch tế sác"], pdt: "Tư bổ can thận âm", bt: "Kỷ cúc địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Kỷ tử", "Cúc hoa"]
  },
  "than_duong_hu_thuy_chieu": { hc: "Thận dương hư thủy thấp trệ", phanloai: ["Tạng Thận", "Hàn", "Hư", "Thận dương hư thủy thũng"], tc: ["Phù toàn thân nhất là nửa người dưới", "Bụng trướng nước", "Sợ lạnh", "Mạch trầm trì"], pdt: "Ôn dương lợi thủy", bt: "Chân vũ thang", tpbt: ["Hắc phụ tử", "Bạch truật", "Phục linh", "Bạch thược", "Sinh khương"]
  },
  "than_khi_uat_trie_than": { hc: "Thận khí uất trệ", phanloai: ["Tạng Thận", "Bình", "Thực", "Khí trệ"], tc: ["Thắt lưng trướng đau tức", "Tiểu tiện không thông suốt", "Mạch huyền"], pdt: "Hành khí lợi thủy", bt: "Trầm hương tán", tpbt: ["Trầm hương", "Biển súc", "Hoạt thạch", "Mộc thông", "Đương quy"]
  },
  "than_lac_khi_tret_than": { hc: "Thận lạc khí trệ", phanloai: ["Tạng Thận", "Bình", "Thực", "Khí trệ"], tc: ["Thắt lưng đau tức lan mông", "Mạch huyền"], pdt: "Hành khí thông lạc", bt: "Thiếu phúc trục ứ thang gia giảm", tpbt: ["Đương quy", "Xuyên khung", "Đào nhân", "Hồng hoa", "Ô dược"]
  },
  "than_am_khuy_sinh_noi_nhiet": { hc: "Thận âm khuy tổn sinh nội nhiệt", phanloai: ["Tạng Thận", "Nhiệt", "Hư", "Âm hư nội nhiệt"], tc: ["Triều nhiệt đạo hãn lòng bàn tay chân nóng", "Miệng khô", "Mạch tế sác"], pdt: "Tư âm thanh nhiệt", bt: "Lục vị địa hoàng hoàn gia Tri mẫu Hoàng bá", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Tri mẫu", "Hoàng bá"]
  },
  "than_duong_khuy_ha_tieu": { hc: "Thận dương khuy tổn hạ tiêu hàn", phanloai: ["Tạng Thận", "Hàn", "Hư", "Thận dương hư"], tc: ["Đau bụng dưới lạnh sợ lạnh tay chân lạnh", "Tiểu trong dài", "Mạch trầm trì"], pdt: "Ôn bổ thận dương", bt: "Hữu quy hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Đỗ trọng", "Kỷ tử"]
  },
  "than_khi_huyet_luong_hu_than": { hc: "Thận khí huyết lưỡng hư", phanloai: ["Tạng Thận", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Thắt lưng mỏi yếu sắc mặt nhợt", "Mệt mỏi hoa mắt", "Mạch tế nhược"], pdt: "Bổ khí dưỡng huyết thận tạng", bt: "Thập toàn đại bổ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Thục địa", "Đương quy", "Bạch thược", "Xuyên khung"]
  }, 
  "vi_khi_thu_nghich_nang": { hc: "Vị khí thượng nghịch nặng", phanloai: ["Phủ Vị", "Bình", "Thực", "Khí nghịch"], tc: ["Nấc cụt dữ dội liên tục", "Buồn nôn và nôn mửa thức ăn ra ngay", "Thượng vị trướng căng", "Mạch huyền hoạt"], pdt: "Giáng nghịch chỉ ẩu, hòa vị", bt: "Đại bán hạ thang", tpbt: ["Bán hạ", "Nhân sâm", "Mật ong", "Can khương"]
  },
  "vi_am_hu_hoa_vuong_vi": { hc: "Vị âm hư hỏa vượng", phanloai: ["Phủ Vị", "Nhiệt", "Hư", "Âm hư hỏa vượng"], tc: ["Thượng vị nóng rát đau âm ỉ", "Miệng khô khát thích uống nước lạnh", "Lưỡi đỏ ít rêu", "Mạch tế sác"], pdt: "Tư dưỡng vị âm, thanh nhiệt giáng hỏa", bt: "Ích vị thang gia Tri mẫu Hoàng bá", tpbt: ["Ngọc trúc", "Sinh địa", "Sa sâm", "Mạch môn", "Tri mẫu", "Hoàng bá"]
  },
  "vi_duong_hu_han_tre_vi": { hc: "Vị dương hư hàn trệ", phanloai: ["Phủ Vị", "Hàn", "Hư", "Dương hư"], tc: ["Thượng vị đau âm ỉ thích xoa thích ấm", "Nôn ra nước trong", "Tay chân không ấm", "Mạch trầm trì"], pdt: "Ôn vị tán hàn, kiện vị", bt: "Hoàng kỳ kiến trung thang hợp Ngô thù du thang", tpbt: ["Hoàng kỳ", "Quế chi", "Bạch thược", "Cam thảo", "Ngô thù du", "Can khương"]
  },
  "vi_lac_huyet_u_dau_that": { hc: "Vị lạc huyết ứ đau thắt", phanloai: ["Phủ Vị", "Bình", "Thực", "Huyết ứ"], tc: ["Thượng vị đau nhói cố định cự án", "Đau về đêm hoặc sau ăn", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, lý khí chỉ thống", bt: "Thất tiễu tán hợp Diên hồ sách tán", tpbt: ["Ngũ linh tử", "Bồ hoàng", "Diên hồ sách", "Đương quy", "Xích thược", "Xuyên khung"]
  },
  "vi_nhiet_thang_thuc_vi": { hc: "Vị nhiệt thặng thực", phanloai: ["Phủ Vị", "Nhiệt", "Thực", "Vị nhiệt"], tc: ["Thượng vị nóng rát đau ăn nhiều mau đói", "Miệng hôi khát nước", "Táo bón rêu vàng", "Mạch sác lực"], pdt: "Thanh vị tả hỏa, tiêu thực", bt: "Thanh vị tán hợp Điều vị thừa khí thang", tpbt: ["Hoàng liên", "Thăng ma", "Sinh địa", "Mẫu đơn bì", "Đại hoàng", "Hậu phác", "Mang tiêu"]
  },
  "vi_han_ta_pham_vi_cap": { hc: "Vị hàn tà phạm vị cấp", phanloai: ["Phủ Vị", "Hàn", "Thực", "Ngoại cảm hàn"], tc: ["Thượng vị đột ngột đau quặn dữ dội", "Gặp lạnh đau tăng chườm ấm giảm", "Miệng không khát", "Mạch trầm khẩn"], pdt: "Ôn vị tán hàn, hành khí", bt: "Lương phương ngô thù du thang", tpbt: ["Ngô thù du", "Can khương", "Sinh khương", "Đảng sâm"]
  },
  "vi_khi_uat_tret_vi": { hc: "Vị khí uất trệ", phanloai: ["Phủ Vị", "Bình", "Thực", "Khí trệ"], tc: ["Thượng vị trướng đầy sau ăn", "Ợ hơi ợ chua", "Tinh thần u uất", "Mạch huyền"], pdt: "Hành khí hòa vị", bt: "Việt cúc hoàn hợp Hương sa bình vị tán", tpbt: ["Thương truật", "Hương phụ", "Xuyên khung", "Thần khúc", "Chi tử", "Sa nhân"]
  },
  "vi_thuc_tich_dinh_tre_vi": { hc: "Vị thực tích đình trệ", phanloai: ["Phủ Vị", "Bình", "Thực", "Thực tích"], tc: ["Bụng trên trướng đau cự án", "Ợ hơi chua hôi thối", "Nôn ra thức ăn cũ", "Mạch hoạt"], pdt: "Tiêu thực hóa tích, giáng nghịch", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì", "Phục linh"]
  },
  "vi_dam_troc_tro_trung_vi": { hc: "Vị đàm trọc trở trệ", phanloai: ["Phủ Vị", "Bình", "Thực", "Đàm trọc"], tc: ["Thượng vị trướng tức buồn nôn", "Đầu nặng hoa mắt đờm nhiều", "Rêu nhớt", "Mạch huyền hoạt"], pdt: "Táo thấp hóa đàm, hòa vị", bt: "Ôn đởm thang hợp Bình vị tán", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Chỉ thực", "Trúc nhự", "Thương truật"]
  },
  "vi_huyet_u_xuat_huyet_vi": { hc: "Vị huyết ứ xuất huyết", phanloai: ["Phủ Vị", "Bình", "Thực", "Huyết ứ"], tc: ["Nôn ra máu sẫm hoặc đi ngoài phân đen", "Thượng vị đau nhói cố định", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, lương huyết chỉ huyết", bt: "Thất tiễu tán hợp Tiểu hội ẩm", tpbt: ["Ngũ linh tử", "Bồ hoàng", "Đương quy", "Xích thược", "Hắc chi", "A giao"]
  },
  "vi_khi_am_luong_hu_vi": { hc: "Vị khí âm lưỡng hư", phanloai: ["Phủ Vị", "Bình", "Hư", "Khí âm lưỡng hư"], tc: ["Thượng vị đau âm ỉ miệng khô khát", "Mệt mỏi ăn kém", "Lưỡi đỏ ít rêu", "Mạch tế sác vô lực"], pdt: "Ích khí dưỡng âm, kiện vị", bt: "Ích vị thang hợp Tứ quân tử", tpbt: ["Ngọc trúc", "Sinh địa", "Sa sâm", "Mạch môn", "Đảng sâm", "Bạch truật"]
  },
  "vi_am_khuy_ton_sinh_tan_vi": { hc: "Vị âm khuy tổn sinh tân kém", phanloai: ["Phủ Vị", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khô họng khát thích uống nước mát", "Thượng vị nóng rát nhẹ", "Mạch tế sác"], pdt: "Tư dưỡng vị âm, sinh tân", bt: "Ích vị thang", tpbt: ["Ngọc trúc", "Sinh địa", "Sa sâm", "Mạch môn"]
  },
  "vi_thu_nhiet_pham_vi_vi": { hc: "Vị thử nhiệt phạm vị", phanloai: ["Phủ Vị", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Thượng vị nóng bức buồn nôn mùa hè", "Khát nước mệt mỏi", "Mạch nhu sác"], pdt: "Thanh thử hóa thấp, hòa vị", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Mạch môn", "Đảng sâm", "Hoàng kỳ", "Phục linh"]
  },
  "vi_phong_han_pham_vi_vi": { hc: "Vị phong hàn phạm vị", phanloai: ["Phủ Vị", "Hàn", "Thực", "Ngoại cảm phong hàn"], tc: ["Thượng vị đau quặn kèm sốt sợ gió", "Đau đầu", "Mạch phù khẩn"], pdt: "Sơ phong tán hàn, ôn vị", bt: "Hương sa bình vị tán hợp Cát căn thang", tpbt: ["Hương phụ", "Sa nhân", "Thương truật", "Cát căn", "Ma hoàng", "Sinh khương"]
  },
  "vi_can_khi_pham_vi_chung": { hc: "Can khí phạm Vị chứng nặng", phanloai: ["Phủ Vị", "Bình", "Thực", "Khí trệ"], tc: ["Thượng vị trướng đau lan sườn ngực dữ dội", "Ợ hơi ợ chua nhiều", "Dễ cáu gắt", "Mạch huyền"], pdt: "Sơ can lý khí, hòa vị chỉ thống", bt: "Sài hồ sơ can tán hợp Tả kim hoàn", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Xuyên khung", "Hoàng liên", "Ngô thù du"]
  },
  "vi_tam_bat_giao_vi": { hc: "Tâm Vị bất hòa", phanloai: ["Phủ Vị", "Nhiệt", "Hư thực", "Tâm Vị bất hòa"], tc: ["Hồi hộp mất ngủ kèm thượng vị trướng đau", "Bứt rứt", "Mạch tế sác"], pdt: "An thần thanh tâm, hòa vị", bt: "Bán hạ sái tâm thang hợp Giao thái hoàn", tpbt: ["Bán hạ", "Hoàng cầm", "Đảng sâm", "Can khương", "Hoàng liên", "Nhục quế"]
  },
  "vi_ph_khuy_tton_vi": { hc: "Vị khí khuy nhược vô lực", phanloai: ["Phủ Vị", "Bình", "Hư", "Khí hư"], tc: ["Thượng vị đau âm ỉ sau ăn mệt mỏi", "Thích xoa ấm", "Mạch hư nhược"], pdt: "Ích khí kiện vị", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ"]
  },
  "vi_hoa_thinh_nhieu_loet_vi": { hc: "Vị hỏa thịnh gây lở loét", phanloai: ["Phủ Vị", "Nhiệt", "Thực", "Vị hỏa"], tc: ["Thượng vị nóng rát đau loét miệng lợi", "Hơi thở hôi khát nước", "Mạch sác lực"], pdt: "Thanh nhiệt tả hỏa, sinh cơ", bt: "Thanh vị tán hợp Bạch hổ thang", tpbt: ["Hoàng liên", "Thăng ma", "Sinh địa", "Mẫu đơn bì", "Thạch cao", "Tri mẫu"]
  },
  "vi_tan_dich_kho_kiet_vi": { hc: "Vị tân dịch khô kiệt", phanloai: ["Phủ Vị", "Nhiệt", "Hư", "Tân dịch khuy tổn"], tc: ["Miệng khô họng khát thích uống nước lạnh", "Đại tiện táo cứng", "Lưỡi đỏ", "Mạch tế sác"], pdt: "Tư âm sinh tân, nhuận táo", bt: "Tăng dịch thang", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm"]
  },
  "vi_huyet_u_lac_dinh_vi": { hc: "Vị lạc huyết ứ trệ kinh mạn", phanloai: ["Phủ Vị", "Bình", "Thực", "Huyết ứ"], tc: ["Thượng vị đau mạn tính cố định cự án", "Sắc mặt sạm tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc chỉ thống", bt: "Thất tiễu tán hợp Thiếu phúc trục ứ thang", tpbt: ["Ngũ linh tử", "Bồ hoàng", "Đương quy", "Xuyên khung", "Xích thược", "Đào nhân"]
  }, 
  "dai_trang_nhiet_ket_tao_bon": { hc: "Đại tràng nhiệt kết táo bón", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Vị trường nhiệt kết"], tc: ["Đại tiện khô cứng nhiều ngày không đi", "Bụng trướng đau cự án", "Miệng hôi rêu vàng", "Mạch sác lực"], pdt: "Thanh nhiệt tả hỏa, nhuận táo thông tiện", bt: "Đại thừa khí thang", tpbt: ["Đại hoàng", "Hậu phác", "Mang tiêu", "Chỉ thực"]
  },
  "dai_trang_khi_tret_thong_tien": { hc: "Đại tràng khí trệ không thông", phanloai: ["Phủ Đại tràng", "Bình", "Thực", "Khí trệ"], tc: ["Bụng trướng đau cự án muốn đi mà không rặn được", "Đại tiện khó khăn", "Mạch huyền"], pdt: "Hành khí đạo trệ", bt: "Lục ma thang", tpbt: ["Đại hoàng", "Binh lang", "Trầm hương", "Mộc hương", "Chỉ xác", "Ô dược"]
  },
  "dai_trang_thap_nhiet_ha_luy": { hc: "Đại tràng thấp nhiệt lỵ tật", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Bụng quặn đau đại tiện nhầy máu mót rặn", "Hậu môn nóng rát", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, điều khí chỉ lỵ", bt: "Thược dược thang", tpbt: ["Bạch thược", "Đương quy", "Hậu phác", "Binh lang", "Mộc hương", "Cam thảo", "Hoàng liên", "Hoàng cầm"]
  },
  "dai_trang_hu_han_phuc_thong": { hc: "Đại tràng hư hàn phúc thống", phanloai: ["Phủ Đại tràng", "Hàn", "Hư", "Hư hàn"], tc: ["Bụng lạnh đau thích chườm ấm", "Đại tiện lỏng loãng", "Chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn trung tán hàn, sáp trường", bt: "Hoàng thổ thang", tpbt: ["Can địa hoàng", "Cam thảo", "Bạch truật", "Phụ tử", "A giao", "Hoàng cầm", "Xích thạch chi"]
  },
  "dai_trang_am_hu_tao_ket": { hc: "Đại tràng âm hư táo kết", phanloai: ["Phủ Đại tràng", "Nhiệt", "Hư", "Âm hư tân dịch khô"], tc: ["Đại tiện khô cứng như phân dê nhiều ngày", "Miệng khô họng khát", "Lưỡi đỏ", "Mạch tế sác"], pdt: "Tư âm nhuận táo, thông tiện", bt: "Tăng dịch thang hợp Ma tử nhân hoàn", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm", "Hỏa nhân", "Hạnh nhân", "Bạch thược"]
  },
  "dai_trang_duong_hu_tien_tiet": { hc: "Đại tràng dương hư tiện tiết", phanloai: ["Phủ Đại tràng", "Hàn", "Hư", "Dương hư"], tc: ["Đại tiện lỏng nát kéo dài", "Bụng lạnh đau thích ấm", "Sợ lạnh", "Mạch trầm trì"], pdt: "Ôn bổ tỳ thận dương, chỉ tả", bt: "Tứ thần hoàn", tpbt: ["Bổ cốt t脂", "Ngô thù du", "Nhục đậu khấu", "Ngũ vị tử", "Sinh khương"]
  },
  "dai_trang_huyet_u_thong_ha": { hc: "Đại tràng huyết ứ thông hà", phanloai: ["Phủ Đại tràng", "Bình", "Thực", "Huyết ứ"], tc: ["Bụng dưới đau nhói cố định đại tiện ra máu sẫm", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Chỉ xác"]
  },
  "dai_trang_khi_am_luong_hu": { hc: "Đại tràng khí âm lưỡng hư", phanloai: ["Phủ Đại tràng", "Bình", "Hư", "Khí âm lưỡng hư"], tc: ["Đại tiện táo hoặc lỏng mạn tính", "Miệng khô mệt mỏi", "Mạch tế sác vô lực"], pdt: "Ích khí dưỡng âm, nhuận tràng", bt: "Sinh mạch tán hợp Tăng dịch thang", tpbt: ["Nhân sâm", "Mạch môn", "Ngũ vị tử", "Sinh địa", "Huyền sâm"]
  },
  "dai_trang_phong_nhiet_cam_mao": { hc: "Đại tràng phong nhiệt ngoại cảm", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Ngoại cảm phong nhiệt"], tc: ["Sốt đau đầu đại tiện táo bón", "Họng rát", "Mạch phù sác"], pdt: "Sơ phong thanh nhiệt, thông tiện", bt: "Ngân kiều tán gia Đại hoàng", tpbt: ["Kim ngân hoa", "Liên kiều", "Bạc hà", "Cát cánh", "Đại hoàng"]
  },
  "dai_trang_thu_nhiet_tiet_ta": { hc: "Đại tràng thử nhiệt tiết tả", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Tiêu chảy mùa hè phân tóe nước", "Khát nước mệt mỏi", "Mạch nhu sác"], pdt: "Thanh thử hóa thấp, chỉ tả", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Mạch môn", "Đảng sâm", "Hoàng kỳ"]
  },
  "dai_trang_dam_trac_tro_tre": { hc: "Đại tràng đàm trọc trở trệ", phanloai: ["Phủ Đại tràng", "Bình", "Thực", "Đàm trọc"], tc: ["Đại tiện nhầy dính nặng đầu mỏi người", "Rêu nhớt", "Mạch nhu hoạt"], pdt: "Táo thấp hóa đàm, thông tràng", bt: "Bình vị tán hợp Nhị trần", tpbt: ["Thương truật", "Hậu phác", "Trần bì", "Bán hạ", "Phục linh"]
  },
  "dai_trang_han_thap_uat_ket": { hc: "Đại tràng hàn thấp uất kết", phanloai: ["Phủ Đại tràng", "Hàn", "Thực", "Hàn thấp"], tc: ["Bụng đau âm ỉ đại tiện phân lỏng nhầy trắng", "Mạch trầm hoãn"], pdt: "Ôn trung hóa thấp", bt: "Hoắc hương chính khí tán", tpbt: ["Hoắc hương", "Bạch truật", "Hậu phác", "Trần bì", "Phục linh", "Can khương"]
  },
  "dai_trang_nhiet_doc_thinh_lac": { hc: "Đại tràng nhiệt độc thịnh", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Nhiệt độc"], tc: ["Đại tiện phân máu mủ nhầy sốt cao mót rặn dữ dội", "Mạch sác lực"], pdt: "Thanh nhiệt giải độc, lương huyết", bt: "Bạch đầu ông thang", tpbt: ["Bạch đầu ông", "Hoàng liên", "Hoàng bá", "Tần giao"]
  },
  "dai_trang_khi_ham_sa_truc": { hc: "Đại tràng khí hãm sa trực tràng", phanloai: ["Phủ Đại tràng", "Bình", "Hư", "Khí hãm"], tc: ["Sa trực tràng đại tiện lỏng loãng mót rặn", "Mệt mỏi", "Mạch nhược"], pdt: "Bổ khí thăng dương, nhiếp trọc", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Trần bì", "Sài hồ", "Thăng ma"]
  },
  "dai_trang_vi_nhiet_dong_trang": { hc: "Vị trường nhiệt động đại tràng", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Vị trường nhiệt"], tc: ["Bụng trướng đau táo bón đại tiện khô", "Miệng hôi rêu vàng", "Mạch sác"], pdt: "Thanh vị trường nhiệt", bt: "Điều vị thừa khí thang", tpbt: ["Đại hoàng", "Mang tiêu", "Cam thảo"]
  },
  "dai_trang_tan_dich_hao_ton_tao": { hc: "Đại tràng tân dịch hao tổn", phanloai: ["Phủ Đại tràng", "Nhiệt", "Hư", "Tân dịch khuy tổn"], tc: ["Đại tiện khô cứng miệng khô", "Lưỡi đỏ", "Mạch tế sác"], pdt: "Tư âm nhuận táo", bt: "Tăng dịch thang", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm"]
  },
  "dai_trang_can_khi_pham_truong": { hc: "Can khí phạm tràng vị", phanloai: ["Phủ Đại tràng", "Bình", "Thực", "Khí trệ"], tc: ["Bụng quặn đau muốn đi ngoài sau đau đi xong đỡ", "Hay cáu gắt", "Mạch huyền"], pdt: "Sơ can lý khí, chỉ tả", bt: "Thống tả yếu phương", tpbt: ["Bạch truật", "Bạch thược", "Trần bì", "Phòng phong"]
  },
  "dai_trang_ty_than_duong_khuy": { hc: "Tỳ Thận dương hư đại tràng", phanloai: ["Phủ Đại tràng", "Hàn", "Hư", "Tỳ thận dương hư"], tc: ["Ngũ canh tả phân lỏng lạnh đau bụng", "Chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, sáp trường", bt: "Tứ thần hoàn", tpbt: ["Bổ cốt t脂", "Ngô thù du", "Nhục đậu khấu", "Ngũ vị tử", "Sinh khương"]
  },
  "dai_trang_thu_tao_thuong_tan": { hc: "Thử táo thương đại tràng", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Thử táo"], tc: ["Đại tiện khô bón mùa hè nóng nực", "Miệng khát", "Mạch sác"], pdt: "Thanh thử nhuận táo", bt: "Thanh táo cứu phế thang gia giảm", tpbt: ["Tang diệp", "Thạch cao", "Hạnh nhân", "Mạch môn", "Hồ ma nhân"]
  },
  "dai_trang_huyet_nhiet_vong_hanh": { hc: "Đại tràng huyết nhiệt vọng hành", phanloai: ["Phủ Đại tràng", "Nhiệt", "Thực", "Huyết nhiệt"], tc: ["Đại tiện ra máu tươi phun thành tia", "Hậu môn sưng đau", "Mạch hoạt sác"], pdt: "Lương huyết chỉ huyết, thanh nhiệt", bt: "Hòe hoa tán", tpbt: ["Hòe hoa", "Trắc bách diệp", "Kinh giới tuệ", "Chỉ xác", "Hoàng cầm", "Đương quy"]
  }, 
  "tieu_truong_thap_nhiet_cap": { hc: "Tiểu trường thấp nhiệt cấp", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Tiểu tiện buốt rát đỏ sẻn", "Bụng dưới trướng căng", "Miệng khát", "Mạch sác"], pdt: "Thanh nhiệt lợi thấp, thông lâm", bt: "Đạo xích tán hợp Bát chính tán", tpbt: ["Sinh địa", "Mộc thông", "Cam thảo khiếu", "Trúc diệp", "Xa tiền tử"]
  },
  "tieu_truong_khi_tre_truong_thong": { hc: "Tiểu trường khí trệ trướng thống", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Khí trệ"], tc: ["Bụng dưới trướng đau lan tinh hoàn", "Đau tăng khi vận động", "Mạch huyền"], pdt: "Hành khí chỉ thống", bt: "Thiên đài ô dược tán", tpbt: ["Ô dược", "Mộc hương", "Tiểu hồi hương", "Thanh bì", "Lương khương"]
  },
  "tieu_truong_huyet_u_ha_tieu": { hc: "Tiểu trường huyết ứ hạ tiêu", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Huyết ứ"], tc: ["Bụng dưới đau nhói cố định cự án", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, lý khí", bt: "Thiếu phúc trục ứ thang", tpbt: ["Đương quy", "Xuyên khung", "Xích thược", "Đào nhân", "Hồng hoa", "Quan quế"]
  },
  "tieu_truong_han_thap_tiet": { hc: "Tiểu trường hàn thấp tiết tả", phanloai: ["Phủ Tiểu trường", "Hàn", "Thực", "Hàn thấp"], tc: ["Bụng dưới đau âm ỉ tiêu chảy phân lỏng", "Sợ lạnh", "Mạch trầm trì"], pdt: "Ôn trung hóa thấp, chỉ tả", bt: "Lý trung hoàn hợp Hoắc hương chính khí", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Cam thảo", "Hoắc hương"]
  },
  "tieu_truong_thanh_coc_bat_phan_nang": { hc: "Tiểu trường thanh cốc bất phân nặng", phanloai: ["Phủ Tiểu trường", "Hàn", "Hư", "Tỳ thận hư"], tc: ["Ăn vào đi ngoài nguyên thức ăn chưa tiêu", "Bụng sôi đau", "Chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn trung kiện tỳ, cố sáp", bt: "Lý trung hoàn hợp Sâm linh bạch truật tán", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Cam thảo", "Phục linh", "Ý dĩ"]
  },
  "tieu_truong_nhiet_loet_khieu": { hc: "Tiểu trường nhiệt thịnh lở miệng", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Thực", "Hỏa nhiệt"], tc: ["Miệng lưỡi lở loét đỏ đau", "Tiểu tiện đỏ rát buốt", "Mạch sác"], pdt: "Thanh tâm tả tiểu trường hỏa", bt: "Đạo xích tán", tpbt: ["Sinh địa", "Mộc thông", "Cam thảo khiếu", "Trúc diệp"]
  },
  "tieu_truong_san_khi_han_tre": { hc: "Tiểu trường sán khí hàn trệ", phanloai: ["Phủ Tiểu trường", "Hàn", "Thực", "Hàn trệ"], tc: ["Bụng dưới đau quặn lan dịch hoàn", "Sa giáng tinh hoàn đau", "Mạch huyền khẩn"], pdt: "Ôn kinh tán hàn, lý khí định thống", bt: "Noãn can tiễn", tpbt: ["Tiểu hồi hương", "Nhục quế", "Đương quy", "Câu kỷ tử", "Ô dược", "Trầm hương"]
  },
  "tieu_truong_tan_dich_khuy_ton": { hc: "Tiểu trường tân dịch khuy tổn", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khát thích uống nước mát", "Tiểu tiện ít đỏ", "Đại tiện khô", "Mạch tế sác"], pdt: "Tư âm sinh tân", bt: "Tăng dịch thang", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm"]
  },
  "tieu_truong_thuc_tich_dinh_tre": { hc: "Tiểu trường thực tích đình trệ", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Thực tích"], tc: ["Bụng trướng đau quặn sôi bụng", "Đại tiện phân thối", "Mạch hoạt"], pdt: "Tiêu thực hóa tích", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì"]
  },
  "tieu_truong_khi_huyet_luong_hu_vua": { hc: "Tiểu trường khí huyết lưỡng hư", phanloai: ["Phủ Tiểu trường", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Bụng dưới co thắt âm ỉ mệt mỏi", "Sắc mặt nhợt", "Mạch tế nhược"], pdt: "Bổ khí dưỡng huyết", bt: "Thập toàn đại bổ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Thục địa", "Đương quy", "Bạch thược", "Xuyên khung"]
  },
  "tieu_truong_hu_han_phuc_thong": { hc: "Tiểu trường hư hàn phúc thống", phanloai: ["Phủ Tiểu trường", "Hàn", "Hư", "Dương hư"], tc: ["Bụng dưới đau âm ỉ thích ấm", "Tiểu tiện trong dài", "Mạch trầm trì"], pdt: "Ôn bổ thận dương, tán hàn", bt: "Hữu quy hoàn gia giảm", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Đỗ trọng", "Kỷ tử"]
  },
  "tieu_truong_am_hu_noi_nhiet": { hc: "Tiểu trường âm hư nội nhiệt", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khô khát lòng bàn tay chân nóng", "Tiểu ít đỏ", "Mạch tế sác"], pdt: "Tư âm thanh nhiệt", bt: "Lục vị địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh"]
  },
  "tieu_truong_duong_hu_ha_tieu": { hc: "Tiểu trường dương hư hạ tiêu", phanloai: ["Phủ Tiểu trường", "Hàn", "Hư", "Dương hư"], tc: ["Sợ lạnh tay chân lạnh bụng dưới đau", "Tiểu trong dài", "Mạch trầm tế"], pdt: "Ôn bổ hạ tiêu dương khí", bt: "Hữu quy hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Đỗ trọng"]
  },
  "tieu_truong_phong_nhiet_ngoai_cam": { hc: "Tiểu trường phong nhiệt ngoại cảm", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Thực", "Ngoại cảm phong nhiệt"], tc: ["Sốt đau đầu tiểu tiện vàng đỏ", "Mạch phù sác"], pdt: "Sơ phong thanh nhiệt, lợi niệu", bt: "Ngân kiều tán hợp Đạo xích tán", tpbt: ["Kim ngân hoa", "Liên kiều", "Sinh địa", "Mộc thông", "Trúc diệp"]
  },
  "tieu_truong_dam_trac_tro_tre": { hc: "Tiểu trường đàm trọc trở trệ", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Đàm trọc"], tc: ["Bụng dưới trướng nặng đầu nặng mỏi", "Rêu nhớt", "Mạch nhu hoạt"], pdt: "Táo thấp hóa đàm", bt: "Bình vị tán hợp Nhị trần", tpbt: ["Thương truật", "Hậu phác", "Trần bì", "Bán hạ", "Phục linh"]
  },
  "tieu_truong_huyet_u_xuat_huyet": { hc: "Tiểu trường huyết ứ xuất huyết", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Huyết ứ"], tc: ["Bụng dưới đau nhói đi ngoài tiểu ra máu cục", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, chỉ huyết", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "tieu_truong_khi_uat_tre": { hc: "Tiểu trường khí uất trệ", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Khí trệ"], tc: ["Bụng dưới trướng căng tinh thần u uất", "Mạch huyền"], pdt: "Hành khí khai uất", bt: "Tứ ma thang", tpbt: ["Trần bì", "Hương phụ", "Ô dược", "Binh lang"]
  },
  "tieu_truong_ty_than_duong_khuy": { hc: "Tỳ Thận dương hư tiểu trường", phanloai: ["Phủ Tiểu trường", "Hàn", "Hư", "Tỳ thận dương hư"], tc: ["Ăn vào đi ngoài nguyên thức ăn lạnh bụng", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, sáp trường", bt: "Tứ thần hoàn hợp Lý trung", tpbt: ["Bổ cốt t脂", "Ngô thù du", "Đảng sâm", "Can khương", "Bạch truật"]
  },
  "tieu_truong_thu_nhiet_ha_tieu": { hc: "Tiểu trường thử nhiệt hạ tiêu", phanloai: ["Phủ Tiểu trường", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Tiểu buốt rát mùa hè khát nước mệt mỏi", "Mạch nhu sác"], pdt: "Thanh thử lợi thấp", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Mạch môn", "Đảng sâm", "Hoàng kỳ"]
  },
  "tieu_truong_can_khi_pham_tieu": { hc: "Can khí phạm tiểu trường", phanloai: ["Phủ Tiểu trường", "Bình", "Thực", "Khí trệ"], tc: ["Bụng dưới trướng đau lan tinh hoàn do cáu gắt", "Mạch huyền"], pdt: "Sơ can lý khí, chỉ thống", bt: "Sài hồ sơ can tán hợp Thiên đài ô dược tán", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Ô dược", "Mộc hương"]
  }, 
  "bang_quang_thap_nhiet_cap": { hc: "Bàng quang thấp nhiệt cấp", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Tiểu tiện buốt rát đột ngột", "Tiểu rắt tiểu đỏ đục", "Đau tức hạ vị", "Mạch sác"], pdt: "Thanh nhiệt lợi thấp, thông lâm", bt: "Bát chính tán", tpbt: ["Xa tiền tử", "Cù mạch", "Biển súc", "Hoạt thạch", "Cam thảo", "Đại hoàng", "Chi tử", "Mộc thông"]
  },
  "bang_quang_khi_tret_truong": { hc: "Bàng quang khí trệ trướng căng", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Khí trệ"], tc: ["Hạ vị trướng căng tiểu tiện khó khăn không thông", "Tức nặng", "Mạch huyền"], pdt: "Hành khí lợi thủy", bt: "Trầm hương tán", tpbt: ["Trầm hương", "Biển súc", "Hoạt thạch", "Mộc thông", "Đương quy"]
  },
  "bang_quang_huyet_u_tieu_ha": { hc: "Bàng quang huyết ứ hạ tiêu", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Huyết ứ"], tc: ["Hạ vị đau nhói cố định", "Tiểu ra máu cục", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, chỉ huyết", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "bang_quang_han_thap_phu": { hc: "Bàng quang hàn thấp phù", phanloai: ["Phủ Bàng quang", "Hàn", "Thực", "Hàn thấp"], tc: ["Tiểu tiện bất định người nặng nề", "Sợ lạnh tay chân lạnh", "Mạch trầm trì"], pdt: "Ôn dương hóa thấp, lợi niệu", bt: "Ngũ linh tán", tpbt: ["Phục linh", "Trư linh", "Trạch tả", "Bạch truật", "Quế chi"]
  },
  "bang_quang_thanh_coc_bat_phan": { hc: "Bàng quang cao lâm đục như sữa", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Thấp nhiệt cao lâm"], tc: ["Tiểu tiện đục như nước vo gạo", "Buốt rát", "Rêu lưỡi vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, hóa trọc", bt: "Thanh tâm liên tử ẩm", tpbt: ["Hoàng liên", "Hoàng cầm", "Mạch môn", "Xa tiền tử", "Thạch xương bồ"]
  },
  "bang_quang_nhiet_loet_khiu": { hc: "Bàng quang nhiệt thịnh lở khiếu", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Hỏa nhiệt"], tc: ["Tiểu tiện buốt rát đỏ đau", "Bứt rứt miệng khát", "Mạch sác"], pdt: "Thanh tâm tả hỏa, lợi niệu", bt: "Đạo xích tán", tpbt: ["Sinh địa", "Mộc thông", "Cam thảo khiếu", "Trúc diệp"]
  },
  "bang_quang_thach_lam_dot_ngot": { hc: "Bàng quang thạch lâm đột ngột", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Thấp nhiệt thạch lâm"], tc: ["Tiểu tiện tắc nghẽn đột ngột đau buốt rát", "Tiểu ra sỏi", "Mạch huyền sác"], pdt: "Thanh nhiệt lợi thấp, bài thạch", bt: "Thạch vĩ tán", tpbt: ["Thạch vĩ", "Xa tiền tử", "Biển súc", "Cù mạch", "Hoạt thạch", "Kim tiền thảo"]
  },
  "bang_quang_tan_dich_khuy_ton": { hc: "Bàng quang tân dịch khuy tổn", phanloai: ["Phủ Bàng quang", "Nhiệt", "Hư", "Tân dịch khuy tổn"], tc: ["Tiểu tiện sẻn ít", "Miệng khô khát", "Lưỡi đỏ", "Mạch tế sác"], pdt: "Tư âm sinh tân, lợi niệu", bt: "Trư linh thang", tpbt: ["Trư linh", "Phục linh", "Trạch tả", "Hoạt thạch", "A giao"]
  },
  "bang_quang_thuc_tich_dinh_tre": { hc: "Bàng quang thực tích đình trệ", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Thực tích"], tc: ["Hạ vị trướng căng đau quặn nhẹ", "Tiểu tiện bất thường", "Mạch hoạt"], pdt: "Tiêu thực lợi niệu", bt: "Bảo hòa hoàn hợp Ngũ linh tán", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Phục linh", "Trạch tả"]
  },
  "bang_quang_khi_huyet_luong_hu": { hc: "Bàng quang khí huyết lưỡng hư", phanloai: ["Phủ Bàng quang", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Tiểu không tự chủ tiểu đêm nhiều", "Sắc mặt nhợt", "Mạch tế nhược"], pdt: "Bổ khí dưỡng huyết, cố sáp", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Đương quy", "Thục địa"]
  },
  "bang_quang_hu_han_tieu_dem": { hc: "Bàng quang hư hàn tiểu đêm", phanloai: ["Phủ Bàng quang", "Hàn", "Hư", "Dương hư"], tc: ["Tiểu tiện nhiều lần tiểu dầm", "Sợ lạnh tay chân lạnh", "Mạch trầm trì"], pdt: "Ôn thận cố sáp, súc niệu", bt: "Tang tiêu tiêu tán hợp Súc tuyền hoàn", tpbt: ["Tang tiêu tiêu", "Ích trí nhân", "Ô dược", "Phục thần", "Long cốt"]
  },
  "bang_quang_am_hu_noi_nhiet": { hc: "Bàng quang âm hư nội nhiệt", phanloai: ["Phủ Bàng quang", "Nhiệt", "Hư", "Âm hư"], tc: ["Tiểu tiện ít buốt rát nhẹ", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư âm thanh nhiệt", bt: "Lục vị địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh"]
  },
  "bang_quang_duong_hu_ha_tieu": { hc: "Bàng quang dương hư hạ tiêu", phanloai: ["Phủ Bàng quang", "Hàn", "Hư", "Dương hư"], tc: ["Sợ lạnh rõ rệt tay chân lạnh ngắt", "Tiểu không tự chủ", "Mạch trầm tế"], pdt: "Ôn bổ tam tiêu dương khí", bt: "Hữu quy hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Đỗ trọng"]
  },
  "bang_quang_phong_nhiet_ngoai": { hc: "Bàng quang phong nhiệt ngoại cảm", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Ngoại cảm phong nhiệt"], tc: ["Tiểu tiện bất định kèm sốt đau đầu", "Mạch phù sác"], pdt: "Sơ phong thanh nhiệt, lợi niệu", bt: "Phòng phong thang hợp Bát chính tán", tpbt: ["Phòng phong", "Tần giao", "Xa tiền tử", "Cù mạch", "Hoạt thạch"]
  },
  "bang_quang_dam_trac_tro_tre": { hc: "Bàng quang đàm trọc trở trệ", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Đàm trọc"], tc: ["Tiểu tiện đục nặng đầu mỏi người", "Rêu nhớt", "Mạch nhu hoạt"], pdt: "Táo thấp hóa đàm, lợi niệu", bt: "Bình vị tán hợp Ngũ linh tán", tpbt: ["Thương truật", "Hậu phác", "Trần bì", "Phục linh", "Trạch tả"]
  },
  "bang_quang_huyet_u_xuat_huyet": { hc: "Bàng quang huyết ứ xuất huyết", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Huyết ứ"], tc: ["Hạ vị đau nhói tiểu ra máu cục", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, chỉ huyết", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "bang_quang_khi_uat_trie_ha": { hc: "Bàng quang khí uất trệ hạ vị", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Khí trệ"], tc: ["Hạ vị trướng căng tinh thần u uất", "Mạch huyền"], pdt: "Hành khí lợi thủy", bt: "Trầm hương tán", tpbt: ["Trầm hương", "Biển súc", "Hoạt thạch", "Mộc thông", "Đương quy"]
  },
  "bang_quang_ty_than_duong_khuy": { hc: "Tỳ Thận dương hư bàng quang", phanloai: ["Phủ Bàng quang", "Hàn", "Hư", "Tỳ thận dương hư"], tc: ["Tiểu dầm tiểu nhiều lần về đêm chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, cố sáp", bt: "Hữu quy hoàn hợp Lý trung", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Đảng sâm", "Can khương"]
  },
  "bang_quang_thu_nhiet_ha_tieu": { hc: "Bàng quang thử nhiệt hạ tiêu", phanloai: ["Phủ Bàng quang", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Tiểu buốt rát mùa hè khát nước mệt mỏi", "Mạch nhu sác"], pdt: "Thanh thử lợi thấp", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Mạch môn", "Đảng sâm", "Hoàng kỳ"]
  },
  "bang_quang_can_khi_pham_bang": { hc: "Can khí phạm bàng quang", phanloai: ["Phủ Bàng quang", "Bình", "Thực", "Khí trệ"], tc: ["Tiểu tiện khó khăn đau tức hạ vị do cáu gắt", "Mạch huyền"], pdt: "Sơ can lý khí, lợi thủy", bt: "Sài hồ sơ can tán hợp Trầm hương tán", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Trầm hương", "Biển súc"]
  }, 
  "dom_khi_tret_suon": { hc: "Đởm khí trệ sườn trướng", phanloai: ["Phủ Đởm", "Bình", "Thực", "Khí trệ"], tc: ["Sườn phải trướng đau âm ỉ", "Hay thở dài", "Miệng đắng", "Mạch huyền"], pdt: "Sơ can lý khí, thanh đởm", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Xuyên khung", "Trần bì"]
  },
  "dom_nhiet_uat_ket_suon": { hc: "Đởm nhiệt uất kết", phanloai: ["Phủ Đởm", "Nhiệt", "Thực", "Đàm hỏa"], tc: ["Miệng đắng họng khô", "Sườn phải đau tức", "Tâm phiền bứt rứt", "Mạch huyền sác"], pdt: "Thanh tả đởm hỏa", bt: "Long đởm tả can thang", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Sài hồ", "Sinh địa"]
  },
  "dom_thap_nhiet_uat_ket": { hc: "Đởm thấp nhiệt uất kết", phanloai: ["Can Đảm", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Đau vùng sườn phải lan ra sau lưng", "Sốt rét run da mắt vàng", "Mạch huyền sác"], pdt: "Thanh nhiệt lợi thấp, thông lợi đản đạo", bt: "Đại sài hồ thang hợp Nhân trần cao thang", tpbt: ["Sài hồ", "Hoàng cầm", "Bạch thược", "Chỉ thực", "Đại hoàng", "Nhân trần", "Chi tử"]
  },
  "dom_am_hu_noi_nhiet": { hc: "Đởm âm hư nội nhiệt", phanloai: ["Phủ Đởm", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khô đắng họng ráo", "Hồi hộp khó ngủ", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư âm thanh đởm", bt: "Tư âm địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Miết giáp"]
  },
  "dom_duong_hu_han_tre": { hc: "Đởm dương hư hàn trệ", phanloai: ["Phủ Đởm", "Hàn", "Hư", "Dương hư"], tc: ["Sườn phải đau âm ỉ thích ấm", "Sợ lạnh tay chân lạnh", "Mạch trầm khẩn"], pdt: "Ôn kinh tán hàn, lý khí", bt: "Ôn đởm thang gia vị quế chi", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Quế chi", "Can khương"]
  },
  "dom_huyet_u_lac_dinh": { hc: "Đởm lạc huyết ứ", phanloai: ["Phủ Đởm", "Bình", "Thực", "Huyết ứ"], tc: ["Sườn phải đau nhói cố định cự án", "Chất lưỡi tím", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Sài hồ"]
  },
  "dom_khi_huyet_luong_hu": { hc: "Đởm khí huyết lưỡng hư", phanloai: ["Phủ Đởm", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Sườn trướng âm ỉ mệt mỏi", "Sắc mặt nhợt", "Mạch tế nhược"], pdt: "Bổ khí dưỡng huyết", bt: "Thập toàn đại bổ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Thục địa", "Đương quy", "Bạch thược"]
  },
  "dom_vi_bat_hoa_dom": { hc: "Đởm Vị bất hòa", phanloai: ["Phủ Đởm", "Bình", "Thực", "Khí trệ"], tc: ["Miệng đắng sườn đau buồn nôn", "Ăn kém", "Mạch huyền"], pdt: "Sơ can hòa đởm, giáng nghịch", bt: "Tiểu sài hồ thang", tpbt: ["Sài hồ", "Hoàng cầm", "Bán hạ", "Đảng sâm", "Cam thảo", "Sinh khương"]
  },
  "dom_thuc_tich_dinh_tre": { hc: "Đởm thực tích đình trệ", phanloai: ["Phủ Đởm", "Bình", "Thực", "Thực tích"], tc: ["Sườn phải trướng đau ăn không tiêu", "Buồn nôn", "Mạch hoạt"], pdt: "Tiêu thực hóa trệ, hòa đởm", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì"]
  },
  "dom_phong_nhiet_ngoai_cam": { hc: "Đởm phong nhiệt ngoại cảm", phanloai: ["Phủ Đởm", "Nhiệt", "Thực", "Ngoại cảm"], tc: ["Sốt đau đầu miệng đắng", "Mạch phù sác"], pdt: "Sơ phong thanh nhiệt", bt: "Tiểu sài hồ thang hợp Ngân kiều", tpbt: ["Sài hồ", "Hoàng cầm", "Kim ngân hoa", "Liên kiều", "Bạc hà"]
  },
  "dom_han_thap_tro_trung": { hc: "Đởm hàn thấp trở trệ", phanloai: ["Phủ Đởm", "Hàn", "Thực", "Hàn thấp"], tc: ["Sườn đau âm ỉ người nặng nề", "Sợ lạnh", "Mạch trầm hoãn"], pdt: "Ôn trung hóa thấp", bt: "Hoắc hương chính khí tán", tpbt: ["Hoắc hương", "Bạch truật", "Hậu phác", "Trần bì", "Phục linh"]
  },
  "dom_tan_dich_hao_ton": { hc: "Đởm tân dịch hao tổn", phanloai: ["Phủ Đởm", "Nhiệt", "Hư", "Âm hư"], tc: ["Miệng khô đắng khát nước", "Lưỡi đỏ", "Mạch tế sác"], pdt: "Tư âm sinh tân", bt: "Tăng dịch thang", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm"]
  },
  "dom_khi_nghich_thuong": { hc: "Đởm khí thượng nghịch", phanloai: ["Phủ Đởm", "Bình", "Thực", "Khí nghịch"], tc: ["Sườn trướng đau nấc cụt buồn nôn", "Mạch huyền"], pdt: "Hành khí giáng nghịch", bt: "Toàn phúc đại giả thạch thang", tpbt: ["Toàn phúc hoa", "Đại giả thạch", "Bán hạ", "Trần bì", "Hương phụ"]
  },
  "can_dam_hoa_vuong": { hc: "Can Đởm hỏa vượng", phanloai: ["Phủ Đởm", "Nhiệt", "Thực", "Hỏa nhiệt"], tc: ["Đau đầu chóng mặt mắt đỏ miệng đắng", "Dễ cáu gắt", "Mạch huyền sác"], pdt: "Thanh can tả đởm hỏa", bt: "Long đởm tả can thang", tpbt: ["Long đởm thảo", "Hoàng cầm", "Chi tử", "Sài hồ", "Trạch tả"]
  },
  "dam_nhiet_nhieu_than": { hc: "Đởm uất đàm nhiễu thần", phanloai: ["Phủ Đởm", "Nhiệt", "Thực", "Đàm nhiệt"], tc: ["Hồi hộp dễ sợ hãi mất ngủ nhiều mộng", "Miệng đắng", "Mạch hoạt sác"], pdt: "Thanh đởm hòa vị, hóa đàm định chí", bt: "Ôn đởm thang", tpbt: ["Bán hạ", "Trần bì", "Phục linh", "Chỉ thực", "Trúc nhự", "Sinh khương"]
  },
  "thach_lam_ha_tieu": { hc: "Đởm thạch hạ tiêu thấp nhiệt", phanloai: ["Phủ Đởm", "Nhiệt", "Thực", "Thấp nhiệt sỏi"], tc: ["Đau sườn phải dữ dội lan vai", "Sốt vàng da", "Mạch huyền sác"], pdt: "Thanh nhiệt lợi thấp, bài thạch", bt: "Nhân trần cao thang hợp Kim tiền thảo", tpbt: ["Nhân trần", "Chi tử", "Đại hoàng", "Kim tiền thảo", "Xa tiền tử"]
  },
  "khi_uat_hoa_hoa_dom": { hc: "Đởm khí uất hóa hỏa", phanloai: ["Phủ Đởm", "Nhiệt", "Thực", "Khí uất hóa hỏa"], tc: ["Sườn trướng đau cáu gắt miệng đắng", "Mạch huyền sác"], pdt: "Sơ can tả hỏa", bt: "Đan tiêu tiêu dao tán", tpbt: ["Sài hồ", "Bạch thược", "Đương quy", "Chi tử", "Đan bì"]
  },
  "huyet_u_xuat_huyet_dom": { hc: "Đởm lạc huyết ứ xuất huyết", phanloai: ["Phủ Đởm", "Bình", "Thực", "Huyết ứ"], tc: ["Sườn đau nhói cố định da sạm", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "ty_than_duong_khuy_dom": { hc: "Tỳ Thận dương hư đởm thất", phanloai: ["Phủ Đởm", "Hàn", "Hư", "Dương hư"], tc: ["Sườn đau âm ỉ sợ lạnh chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận", bt: "Hữu quy hoàn hợp Lý trung", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Đảng sâm", "Can khương"]
  },
  "thu_nhiet_ha_tieu_dom": { hc: "Đởm thử nhiệt hạ tiêu", phanloai: ["Phủ Đởm", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Sườn phải trướng nhẹ mùa hè mệt mỏi", "Mạch nhu sác"], pdt: "Thanh thử lợi thấp", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Mạch môn", "Đảng sâm", "Hoàng kỳ"]
  },
  "tam_tieu_khi_tret_toan_than": { hc: "Tam tiêu khí trệ toàn thân", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Khí trệ"], tc: ["Ngực sườn bụng dưới đều trướng căng", "Hay thở dài", "Mạch huyền"], pdt: "Hành khí khai uất, thông tam tiêu", bt: "Tứ ma thang", tpbt: ["Trần bì", "Hương phụ", "Ô dược", "Binh lang"]
  },
  "tam_tieu_thap_nhiet_ha_tieu": { hc: "Tam tiêu thấp nhiệt hạ tiêu", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Thực", "Thấp nhiệt"], tc: ["Bụng trướng đầy tiểu tiện buốt rát đỏ đục", "Rêu vàng nhớt", "Mạch nhu sác"], pdt: "Thanh nhiệt lợi thấp, hóa trọc", bt: "Tam nhân thang", tpbt: ["Hạnh nhân", "Ý dĩ", "Bạch đậu khấu", "Hậu phác", "Thông thảo", "Trúc diệp"]
  },
  "tam_tieu_han_thap_thuy_thung": { hc: "Tam tiêu hàn thấp thủy thũng", phanloai: ["Phủ Tam tiêu", "Hàn", "Thực", "Hàn thấp"], tc: ["Thân thể nặng nề phù thũng toàn thân", "Sợ lạnh", "Mạch trầm trì"], pdt: "Ôn dương hóa thấp, lợi thủy", bt: "Ngũ linh tán hợp Phụ tử lý trung", tpbt: ["Phục linh", "Trư linh", "Trạch tả", "Bạch truật", "Hắc phụ tử"]
  },
  "tam_tieu_am_hu_noi_nhiet": { hc: "Tam tiêu âm hư nội nhiệt", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Hư", "Âm hư"], tc: ["Tam tiêu khô rát miệng khát tiểu ít đỏ", "Triều nhiệt", "Mạch tế sác"], pdt: "Tư âm thanh nhiệt", bt: "Lục vị địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh"]
  },
  "tam_tieu_duong_hu_han_tre": { hc: "Tam tiêu dương hư hàn trệ", phanloai: ["Phủ Tam tiêu", "Hàn", "Hư", "Dương hư"], tc: ["Sợ lạnh rõ rệt tay chân lạnh ngắt", "Thủy thũng ấn lõm", "Mạch trầm tế"], pdt: "Ôn bổ tam tiêu dương khí", bt: "Hữu quy hoàn", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Đỗ trọng"]
  },
  "tam_tieu_huyet_u_toan_than": { hc: "Tam tiêu huyết ứ toàn thân", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Huyết ứ"], tc: ["Toàn thân có chỗ đau nhói cố định sắc mặt tối sạm", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ, thông tam tiêu", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung", "Sài hồ"]
  },
  "tam_tieu_khi_huyet_luong_hu": { hc: "Tam tiêu khí huyết lưỡng hư", phanloai: ["Phủ Tam tiêu", "Bình", "Hư", "Khí huyết lưỡng hư"], tc: ["Mệt mỏi toàn thân đoản khí lười nói", "Sắc mặt nhợt", "Mạch tế nhược"], pdt: "Bổ khí ích vệ, dưỡng huyết", bt: "Thập toàn đại bổ thang", tpbt: ["Đảng sâm", "Hoàng kỳ", "Thục địa", "Đương quy", "Bạch thược", "Xuyên khung"]
  },
  "tam_tieu_thuc_tich_dinh_tre": { hc: "Tam tiêu thực tích đình trệ", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Thực tích"], tc: ["Bụng ngực trướng đầy ăn uống không tiêu", "Đại tiện bất thường", "Mạch hoạt"], pdt: "Tiêu thực hóa trệ", bt: "Bảo hòa hoàn", tpbt: ["Sơn tra", "Thần khúc", "Lai phục tử", "Bán hạ", "Trần bì"]
  },
  "tam_tieu_phong_nhiet_ngoai_cam": { hc: "Tam tiêu phong nhiệt ngoại cảm", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Thực", "Ngoại cảm phong nhiệt"], tc: ["Sốt cao sợ gió họng sưng đau", "Tiểu tiện vàng", "Mạch phù sác"], pdt: "Tân lương giải biểu, thanh nhiệt", bt: "Ngân kiều tán", tpbt: ["Kim ngân hoa", "Liên kiều", "Bạc hà", "Cát cánh", "Ngưu bàng tử"]
  },
  "tam_tieu_tan_dich_hao_ton": { hc: "Tam tiêu tân dịch hao tổn", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Hư", "Tân dịch khuy tổn"], tc: ["Miệng khô khát tiểu ít", "Lưỡi đỏ", "Mạch tế sác"], pdt: "Tư âm sinh tân", bt: "Tăng dịch thang", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm"]
  },
  "tam_tieu_khi_nghich_thuong": { hc: "Tam tiêu khí nghịch thượng", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Khí nghịch"], tc: ["Ngực tức nấc cụt ho hen", "Mạch huyền", "Trướng bụng"], pdt: "Giáng khí định suyễn", bt: "Tô tử giáng khí thang", tpbt: ["Tô tử", "Bán hạ", "Tiền hồ", "Hậu phác", "Đương quy"]
  },
  "tam_tieu_dam_trac_tro_trung": { hc: "Tam tiêu đàm trọc trở trệ", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Đàm trọc"], tc: ["Thân thể nặng nề bụng trướng đờm nhiều", "Rêu nhớt", "Mạch nhu hoạt"], pdt: "Táo thấp hóa đàm", bt: "Bình vị tán hợp Nhị trần", tpbt: ["Thương truật", "Hậu phác", "Trần bì", "Bán hạ", "Phục linh"]
  },
  "tam_tieu_huyet_nhiet_vong_hanh": { hc: "Tam tiêu huyết nhiệt vọng hành", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Thực", "Huyết nhiệt"], tc: ["Xuất huyết các khiếu sốt cao bứt rứt", "Mạch sác lực"], pdt: "Thanh nhiệt lương huyết, chỉ huyết", bt: "Tê giác địa hoàng thang", tpbt: ["Sinh địa", "Xích thược", "Mẫu đơn bì", "Trắc bách diệp"]
  },
  "tam_tieu_ty_than_duong_khuy": { hc: "Tỳ Thận dương hư tam tiêu", phanloai: ["Phủ Tam tiêu", "Hàn", "Hư", "Tỳ thận dương hư"], tc: ["Phù thũng toàn thân sợ lạnh chân tay lạnh", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, lợi thủy", bt: "Chân vũ thang hợp Hữu quy hoàn", tpbt: ["Hắc phụ tử", "Bạch truật", "Phục linh", "Thục địa", "Đỗ trọng"]
  },
  "tam_tieu_thu_nhiet_ngoai_cam": { hc: "Tam tiêu thử nhiệt ngoại cảm", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Thực", "Thử nhiệt"], tc: ["Sốt cao mùa hè khát nước mệt mỏi", "Mạch nhu sác"], pdt: "Thanh thử giải biểu", bt: "Thanh thử ích khí thang", tpbt: ["Tây qua diệp", "Thạch cao", "Mạch môn", "Đảng sâm", "Hoàng kỳ"]
  },
  "tam_tieu_can_khi_pham_tieu": { hc: "Can khí phạm tam tiêu", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Khí trệ"], tc: ["Ngực sườn bụng trướng căng do cáu gắt", "Mạch huyền"], pdt: "Sơ can lý khí", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Xuyên khung", "Trần bì"]
  },
  "tam_tieu_vi_khi_nghich": { hc: "Tam tiêu Vị khí thượng nghịch", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Khí nghịch"], tc: ["Buồn nôn nấc cụt trướng bụng", "Mạch huyền hoạt"], pdt: "Giáng nghịch hóa trọc", bt: "Bán hạ sái tâm thang", tpbt: ["Bán hạ", "Hoàng cầm", "Đảng sâm", "Can khương", "Hoàng liên"]
  },
  "tam_tieu_huyet_u_lac_dinh": { hc: "Tam tiêu huyết ứ trệ kinh lạc", phanloai: ["Phủ Tam tiêu", "Bình", "Thực", "Huyết ứ"], tc: ["Đau nhói nhiều chỗ sắc mặt sạm", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "tam_tieu_khi_uat_hoa_hoa": { hc: "Tam tiêu khí uất hóa hỏa", phanloai: ["Phủ Tam tiêu", "Nhiệt", "Thực", "Khí uất hóa hỏa"], tc: ["Bứt rứt ngực sườn trướng căng miệng đắng", "Mạch huyền sác"], pdt: "Sơ can tả hỏa, lý khí", bt: "Đan tiêu tiêu dao tán", tpbt: ["Sài hồ", "Bạch thược", "Đương quy", "Chi tử", "Đan bì"]
  },
  "tam_tieu_am_duong_luong_hu": { hc: "Tam tiêu âm dương lưỡng khuy", phanloai: ["Phủ Tam tiêu", "Bình", "Hư", "Âm dương lưỡng hư"], tc: ["Mệt mỏi toàn thân vừa sợ lạnh vừa lòng bàn tay chân nóng", "Mạch trầm tế sác"], pdt: "Âm dương song bổ", bt: "Nhị tiên thang hợp Lục vị", tpbt: ["Tiên mao", "Tiên linh tỳ", "Thục địa", "Sơn thù", "Hoài sơn"]
  }, 
  "bat_cuong_bieu_han": { hc: "Biểu hàn chứng", phanloai: ["Bát cương", "Biểu", "Hàn", "Thực"], tc: ["Sợ lạnh phát sốt không có mồ hôi", "Đau đầu mỏi người", "Mạch phù khẩn"], pdt: "Tân ôn giải biểu", bt: "Ma hoàng thang", tpbt: ["Ma hoàng", "Quế chi", "Hạnh nhân", "Cam thảo"]
  },
  "bat_cuong_bieu_nhiet": { hc: "Biểu nhiệt chứng", phanloai: ["Bát cương", "Biểu", "Nhiệt", "Thực"], tc: ["Phát sốt sợ gió họng đau", "Ho nhẹ", "Mạch phù sác"], pdt: "Tân lương giải biểu", bt: "Ngân kiều tán", tpbt: ["Kim ngân hoa", "Liên kiều", "Bạc hà", "Cát cánh", "Cúc hoa"]
  },
  "bat_cuong_ly_han": { hc: "Lý hàn chứng", phanloai: ["Bát cương", "Lý", "Hàn", "Hư"], tc: ["Bụng lạnh đau thích ấm", "Sợ lạnh tay chân lạnh", "Đại tiện lỏng", "Mạch trầm trì"], pdt: "Ôn trung tán hàn", bt: "Lý trung hoàn", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Cam thảo"]
  },
  "bat_cuong_ly_nhiet": { hc: "Lý nhiệt chứng", phanloai: ["Bát cương", "Lý", "Nhiệt", "Thực"], tc: ["Sốt cao phiền khát", "Mặt đỏ tiểu vàng", "Rêu vàng", "Mạch sác lực"], pdt: "Thanh nhiệt tả hỏa", bt: "Bạch hổ thang", tpbt: ["Thạch cao", "Tri mẫu", "Ngạnh mễ", "Cam thảo"]
  },
  "bat_cuong_ly_hu": { hc: "Lý hư chứng", phanloai: ["Bát cương", "Lý", "Bình", "Hư"], tc: ["Mệt mỏi đoản khí", "Sắc mặt nhợt", "Ăn kém", "Mạch tế nhược"], pdt: "Bổ ích khí huyết", bt: "Tứ quân tử thang hợp Tứ vật", tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Thục địa", "Đương quy"]
  },
  "bat_cuong_ly_thuc": { hc: "Lý thực chứng", phanloai: ["Bát cương", "Lý", "Bình", "Thực"], tc: ["Bụng trướng đau cự án", "Đại tiện bí kết", "Mạch thực lực"], pdt: "Công hạ tích trệ", bt: "Đại thừa khí thang", tpbt: ["Đại hoàng", "Hậu phác", "Mang tiêu", "Chỉ thực"]
  },
  "bat_cuong_am_hu": { hc: "Âm hư chứng", phanloai: ["Bát cương", "Lý", "Nhiệt", "Hư"], tc: ["Triều nhiệt đạo hãn", "Lòng bàn tay chân nóng", "Miệng khô họng ráo", "Mạch tế sác"], pdt: "Tư âm giáng hỏa", bt: "Lục vị địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh"]
  },
  "bat_cuong_duong_hu": { hc: "Dương hư chứng", phanloai: ["Bát cương", "Lý", "Hàn", "Hư"], tc: ["Sợ lạnh rõ rệt tay chân lạnh ngắt", "Sắc mặt trắng nhợt", "Mạch trầm vi", "Tiểu trong dài"], pdt: "Ôn dương bổ khí", bt: "Hữu quy hoàn hợp Tứ nghịch thang", tpbt: ["Phụ tử", "Nhục quế", "Thục địa", "Sơn thù", "Đảng sâm"]
  }, 
  "khi_hu_chung": { hc: "Khí hư chứng", phanloai: ["Khí Huyết Tân Dịch", "Bình", "Hư", "Khí hư"], tc: ["Mệt mỏi đoản khí", "Tiếng nói nhỏ lười nói", "Sắc mặt nhợt", "Mạch tế nhược"], pdt: "Bổ khí kiện tỳ", bt: "Tứ quân tử thang", tpbt: ["Đảng sâm", "Bạch truật", "Phục linh", "Cam thảo"]
  },
  "khi_ham_chung": { hc: "Khí hãm chứng", phanloai: ["Khí Huyết Tân Dịch", "Bình", "Hư", "Khí hãm"], tc: ["Nội tạng sa giáng", "Bụng dưới nặng tức", "Mệt mỏi chóng mặt", "Mạch nhược"], pdt: "Bổ khí thăng dương", bt: "Bổ trung ích khí thang", tpbt: ["Hoàng kỳ", "Đảng sâm", "Bạch truật", "Cam thảo", "Sài hồ", "Thăng ma"]
  },
  "khi_tre_chung": { hc: "Khí trệ chứng", phanloai: ["Khí Huyết Tân Dịch", "Bình", "Thực", "Khí trệ"], tc: ["Ngực sườn bụng trướng đau không cố định", "Hay thở dài", "Mạch huyền"], pdt: "Hành khí khai uất", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Chỉ xác", "Bạch thược", "Xuyên khung", "Hương phụ"]
  },
  "khi_nghich_chung": { hc: "Khí nghịch chứng", phanloai: ["Khí Huyết Tân Dịch", "Bình", "Thực", "Khí nghịch"], tc: ["Ho hen nấc cụt buồn nôn", "Đầu choáng váng", "Mạch huyền hoạt"], pdt: "Giáng khí định nghịch", bt: "Toàn phúc đại giả thạch thang", tpbt: ["Toàn phúc hoa", "Đại giả thạch", "Bán hạ", "Trần bì"]
  },
  "khi_thoat_chung": { hc: "Khí thoát chứng", phanloai: ["Khí Huyết Tân Dịch", "Hàn", "Hư", "Khí thoát"], tc: ["Thở gấp mồ hôi vã đầm đìa", "Tay chân lạnh ngắt", "Mạch vi dục tuyệt"], pdt: "Ích khí cố thoát, cứu nghịch", bt: "Sâm phụ thang", tpbt: ["Nhân sâm", "Hắc phụ tử"]
  },
  "huyet_hu_chung": { hc: "Huyết hư chứng", phanloai: ["Khí Huyết Tân Dịch", "Bình", "Hư", "Huyết hư"], tc: ["Chóng mặt hoa mắt", "Sắc mặt nhợt móng tay nhợt", "Mạch tế nhược"], pdt: "Dưỡng huyết bổ tâm can", bt: "Tứ vật thang", tpbt: ["Thục địa", "Đương quy", "Bạch thược", "Xuyên khung"]
  },
  "huyet_u_chung": { hc: "Huyết ứ chứng", phanloai: ["Khí Huyết Tân Dịch", "Bình", "Thực", "Huyết ứ"], tc: ["Đau nhói cố định cự án", "Chất lưỡi tím tối", "Mạch sáp"], pdt: "Hoạt huyết hóa ứ", bt: "Huyết phủ trục ứ thang", tpbt: ["Đương quy", "Xích thược", "Đào nhân", "Hồng hoa", "Xuyên khung"]
  },
  "huyet_nhiet_chung": { hc: "Huyết nhiệt chứng", phanloai: ["Khí Huyết Tân Dịch", "Nhiệt", "Thực", "Huyết nhiệt"], tc: ["Xuất huyết các khiếu", "Sắc mặt đỏ bứt rứt", "Mạch sác lực"], pdt: "Lương huyết chỉ huyết", bt: "Tê giác địa hoàng thang", tpbt: ["Sinh địa", "Xích thược", "Mẫu đơn bì"]
  },
  "huyet_han_chung": { hc: "Huyết hàn chứng", phanloai: ["Khí Huyết Tân Dịch", "Hàn", "Thực", "Huyết hàn"], tc: ["Đau bụng kinh đau các chi gặp lạnh tăng", "Mạch trầm khẩn"], pdt: "Ôn kinh tán hàn, hoạt huyết", bt: "Ôn kinh thang", tpbt: ["Đương quy", "Xuyên khung", "Bạch thược", "Quế chi", "Ngô thù du"]
  },
  "dam_am_chung": { hc: "Đàm ẩm chứng", phanloai: ["Khí Huyết Tân Dịch", "Hàn", "Thực", "Đàm ẩm"], tc: ["Ho đờm loãng ngực tức", "Chóng mặt buồn nôn", "Mạch huyền hoạt"], pdt: "Ôn hóa đàm ẩm", bt: "Linh quế truật cam thang", tpbt: ["Phục linh", "Quế chi", "Bạch truật", "Cam thảo"]
  },
  "thuy_thung_chung": { hc: "Thủy thũng chứng", phanloai: ["Khí Huyết Tân Dịch", "Bình", "Thực", "Thủy thấp"], tc: ["Phù thũng toàn thân ấn lõm", "Mệt mỏi", "Mạch trầm trì"], pdt: "Hóa khí lợi thủy", bt: "Ngũ linh tán", tpbt: ["Phục linh", "Trư linh", "Trạch tả", "Bạch truật", "Quế chi"]
  },
  "tan_dich_khuy_ton": { hc: "Tân dịch khuy tổn chứng", phanloai: ["Khí Huyết Tân Dịch", "Nhiệt", "Hư", "Tân dịch hư"], tc: ["Miệng khô họng khát da khô", "Đại tiện táo", "Mạch tế sác"], pdt: "Tư âm sinh tân", bt: "Tăng dịch thang", tpbt: ["Sinh địa", "Mạch môn", "Huyền sâm"]
  }, 
  "thai_duong_bieu_han": { hc: "Thái dương biểu hàn chứng", phanloai: ["Lục kinh", "Biểu", "Hàn", "Thực"], tc: ["Sợ lạnh phát sốt không có mồ hôi", "Đau đầu cứng gáy", "Mạch phù khẩn"], pdt: "Tân ôn giải biểu", bt: "Ma hoàng thang", tpbt: ["Ma hoàng", "Quế chi", "Hạnh nhân", "Cam thảo"]
  },
  "thai_duong_bieu_nhiet": { hc: "Thái dương biểu nhiệt chứng", phanloai: ["Lục kinh", "Biểu", "Nhiệt", "Thực"], tc: ["Sốt sợ gió ra mồ hôi", "Đau đầu họng rát", "Mạch phù hoãn"], pdt: "Tân lương giải biểu", bt: "Quế chi thang", tpbt: ["Quế chi", "Bạch thược", "Sinh khương", "Đại táo", "Cam thảo"]
  },
  "thai_duong_suc_thuy": { hc: "Thái dương súc thủy chứng", phanloai: ["Lục kinh", "Biểu lý", "Nhiệt", "Thực"], tc: ["Phát sốt khát nước uống vào nôn ra ngay", "Tiểu tiện khó khăn", "Mạch phù tế sác"], pdt: "Hóa khí lợi thủy", bt: "Ngũ linh tán", tpbt: ["Phục linh", "Trư linh", "Trạch tả", "Bạch truật", "Quế chi"]
  },
  "thai_duong_suc_huyet": { hc: "Thái dương súc huyết chứng", phanloai: ["Lục kinh", "Biểu lý", "Thực", "Huyết ứ"], tc: ["Bụng dưới trướng đầy phát cuồng hoặc tiểu tiện tự lợi", "Chất lưỡi tím", "Mạch trầm tế"], pdt: "Hoạt huyết hóa ứ, thông lạc", bt: "Đào hạch khí nhận thang", tpbt: ["Đào nhân", "Đại hoàng", "Quế chi", "Mang tiêu", "Cam thảo"]
  },
  "duong_minh_kinh_chung": { hc: "Dương minh kinh chứng", phanloai: ["Lục kinh", "Lý", "Nhiệt", "Thực"], tc: ["Sốt cao mặt đỏ khát nước nhiều", "Mồ hôi ra đầm đìa", "Mạch hồng đại hữu lực"], pdt: "Thanh nhiệt sinh tân", bt: "Bạch hổ thang", tpbt: ["Thạch cao", "Tri mẫu", "Ngạnh mễ", "Cam thảo"]
  },
  "duong_minh_phu_chung": { hc: "Dương minh phủ chứng", phanloai: ["Lục kinh", "Lý", "Nhiệt", "Thực"], tc: ["Bụng trướng đau cự án táo bón", "Sốt cao chiều về nặng trán", "Mạch trầm thực"], pdt: "Công hạ tích nhiệt", bt: "Đại thừa khí thang", tpbt: ["Đại hoàng", "Hậu phác", "Mang tiêu", "Chỉ thực"]
  },
  "thieu_duong_chung": { hc: "Thiếu dương chứng", phanloai: ["Lục kinh", "Bán biểu bán lý", "Hòa", "Hư thực"], tc: ["Ngực sườn trướng đau miệng đắng họng khô", "Hàn nhiệt vãng lai", "Mạch huyền"], pdt: "Hòa giải thiếu dương", bt: "Tiểu sài hồ thang", tpbt: ["Sài hồ", "Hoàng cầm", "Bán hạ", "Đảng sâm", "Cam thảo", "Sinh khương", "Đại táo"]
  },
  "thai_am_benh_chung": { hc: "Thái âm bệnh chứng", phanloai: ["Lục kinh", "Lý", "Hàn", "Hư"], tc: ["Bụng đầy trướng tiêu chảy phân lỏng", "Không khát nước", "Mạch trầm hoãn hoặc tế"], pdt: "Ôn trung kiện tỳ", bt: "Lý trung hoàn", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Cam thảo"]
  },
  "thieu_am_han_hoa": { hc: "Thiếu âm hàn hóa chứng", phanloai: ["Lục kinh", "Lý", "Hàn", "Hư"], tc: ["Sợ lạnh tay chân lạnh co ro", "Ngủ gà ngủ gật tiêu chảy phân lỏng", "Mạch trầm vi tế"], pdt: "Hồi dương cứu nghịch", bt: "Tứ nghịch thang", tpbt: ["Hắc phụ tử", "Can khương", "Cam thảo"]
  },
  "thieu_am_nhiet_hoa": { hc: "Thiếu âm nhiệt hóa chứng", phanloai: ["Lục kinh", "Lý", "Nhiệt", "Hư"], tc: ["Tâm phiền mất ngủ loét miệng lưỡi", "Lòng bàn tay chân nóng", "Mạch tế sác"], pdt: "Tư âm giáng hỏa, giao tâm thận", bt: "Hoàng liên A giao thang", tpbt: ["Hoàng liên", "A giao", "Hoàng cầm", "Bạch thược", "Kê tử hoàng"]
  },
  "quyet_am_benh_chung": { hc: "Quyết âm bệnh chứng", phanloai: ["Lục kinh", "Hàn nhiệt thác tạp", "Hư thực", "Quyết âm"], tc: ["Tay chân lạnh ngắt kèm tâm phiền nhiệt", "Đau bụng nôn giun", "Mạch huyền hoặc tế"], pdt: "Ôn tạng khử hàn, thanh thượng ôn hạ", bt: "Ôn tạng thang", tpbt: ["Đương quy", "Quế chi", "Thục địa", "Tế tân", "Mộc thông", "Xuyên tiêu"]
  },
  "ve_phan_chung": { hc: "Vệ phận chứng", phanloai: ["Vệ Khí Dinh Huyết", "Biểu", "Nhiệt", "Thực"], tc: ["Phát sốt sợ gió nhẹ đau đầu", "Họng rát rêu lưỡi mỏng", "Mạch phù sác"], pdt: "Tân lương giải biểu, thanh nhiệt", bt: "Ngân kiều tán", tpbt: ["Kim ngân hoa", "Liên kiều", "Bạc hà", "Cát cánh", "Ngưu bàng tử"]
  },
  "khi_phan_chung": { hc: "Khí phận chứng", phanloai: ["Vệ Khí Dinh Huyết", "Lý", "Nhiệt", "Thực"], tc: ["Sốt cao khát nước phiền táo ra mồ hôi", "Rêu vàng", "Mạch hồng sác"], pdt: "Thanh nhiệt tả hỏa, sinh tân", bt: "Bạch hổ thang", tpbt: ["Thạch cao", "Tri mẫu", "Ngạnh mễ", "Cam thảo"]
  },
  "dinh_phan_chung": { hc: "Dinh phận chứng", phanloai: ["Vệ Khí Dinh Huyết", "Lý", "Nhiệt", "Hư thực"], tc: ["Sốt cao về đêm tâm phiền trằn trọc", "Mê sảng nói nhảm phát ban nhẹ", "Lưỡi đỏ sẫm", "Mạch tế sác"], pdt: "Thanh dinh thấu nhiệt, lương huyết", bt: "Thanh dinh thang", tpbt: ["Tê giác", "Sinh địa", "Mạch môn", "Hoàng liên", "Ngân kiều", "Đan sâm"]
  },
  "huyet_phan_chung": { hc: "Huyết phận chứng", phanloai: ["Vệ Khí Dinh Huyết", "Lý", "Nhiệt", "Thực"], tc: ["Sốt cao xuất huyết các khiếu ban chẩn sẫm màu", "Hôn mê nói sảng", "Lưỡi tím sẫm", "Mạch tế sác"], pdt: "Thanh nhiệt lương huyết, hoạt huyết hóa ứ", bt: "Tê giác địa hoàng thang", tpbt: ["Sinh địa", "Xích thược", "Mẫu đơn bì", "Tê giác"]
  },
  "ve_khi_dong_su": { hc: "Vệ khí đồng bệnh chứng", phanloai: ["Vệ Khí Dinh Huyết", "Biểu lý", "Nhiệt", "Thực"], tc: ["Vừa sốt sợ gió vừa sốt cao phiền khát", "Mạch phù sác hữu lực"], pdt: "Giải biểu thanh lý", bt: "Ngân kiều tán hợp Bạch hổ thang", tpbt: ["Kim ngân hoa", "Liên kiều", "Thạch cao", "Tri mẫu", "Bạc hà"]
  },
  "khi_dinh_luong_gian": { hc: "Khí dinh lưỡng bàn chứng", phanloai: ["Vệ Khí Dinh Huyết", "Lý", "Nhiệt", "Thực"], tc: ["Sốt cao phiền táo mê sảng nhẹ", "Miệng khát rêu vàng", "Mạch sác"], pdt: "Thanh khí lương huyết", bt: "Thanh dinh thang hợp Bạch hổ", tpbt: ["Sinh địa", "Mạch môn", "Thạch cao", "Hoàng liên", "Đan sâm"]
  },
  "dinh_huyet_luong_kien": { hc: "Dinh huyết lưỡng kiêm chứng", phanloai: ["Vệ Khí Dinh Huyết", "Lý", "Nhiệt", "Thực"], tc: ["Sốt cao về đêm xuất huyết ban chẩn đậm", "Hôn mê nói sảng", "Mạch tế sác"], pdt: "Thanh dinh lương huyết, giải độc", bt: "Tê giác địa hoàng thang hợp Thanh dinh thang", tpbt: ["Sinh địa", "Xích thược", "Mẫu đơn bì", "Hoàng liên", "Mạch môn"]
  },
  "duong_minh_nhiet_thinh": { hc: "Dương minh nhiệt thịnh chứng", phanloai: ["Vệ Khí Dinh Huyết", "Lý", "Nhiệt", "Thực"], tc: ["Sốt cao mặt đỏ mồ hôi ra như tắm", "Khát nước thèm lạnh", "Mạch hồng đại"], pdt: "Thanh nhiệt sinh tân", bt: "Bạch hổ gia nhân sâm thang", tpbt: ["Thạch cao", "Tri mẫu", "Đảng sâm", "Ngạnh mễ", "Cam thảo"]
  },
  "thieu_am_hu_kiệt": { hc: "Thiếu âm hư kiệt chứng", phanloai: ["Lục kinh", "Lý", "Hàn", "Hư thoát"], tc: ["Mạch vi dục tuyệt mồ hôi vã lạnh", "Tay chân lạnh ngắt thần khí uể oải", "Hôn mê"], pdt: "Hồi dương cứu nghịch, ích khí cố thoát", bt: "Sâm phụ thang", tpbt: ["Nhân sâm", "Hắc phụ tử"]
  }, 
  "thu_thai_am_phe_kinh": { hc: "Thủ thái âm Phế kinh chứng", phanloai: ["Kinh lạc", "Biểu", "Hư thực", "Phế kinh"], tc: ["Khuyết bồn đau tức", "Cánh tay trong đau mỏi dọc đường đi của kinh", "Sốt ngột ngạt", "Mạch phù"], pdt: "Khu phong tán hàn, sơ thông kinh lạc", bt: "Thông kinh hoạt lạc thang", tpbt: ["Khương hoạt", "Độc hoạt", "Quế chi", "Uy linh tiên", "Cam thảo"]
  },
  "thu_duong_minh_dai_trang_kinh": { hc: "Thủ dương minh Đại tràng kinh chứng", phanloai: ["Kinh lạc", "Biểu", "Nhiệt", "Đại tràng kinh"], tc: ["Răng lợi sưng đau", "Cổ họng sưng nề", "Mặt trước ngón trỏ và cánh tay đau nhức", "Mạch phù sác"], pdt: "Thanh nhiệt lương huyết, thông kinh lạc", bt: "Thanh vị tán hợp Hoàng liên giải độc thang", tpbt: ["Hoàng liên", "Thăng ma", "Sinh địa", "Mẫu đơn bì", "Chi tử", "Hoàng cầm"]
  },
  "tuc_duong_minh_vi_kinh": { hc: "Túc dương minh Vị kinh chứng", phanloai: ["Kinh lạc", "Biểu", "Nhiệt", "Vị kinh"], tc: ["Đau đầu vùng trán", "Mặt sưng đau", "Đau dọc mặt trước chân đùi", "Sốt trán nóng"], pdt: "Thanh nhiệt lợi thấp, sơ thông kinh lạc", bt: "Bạch hổ thang gia vị", tpbt: ["Thạch cao", "Tri mẫu", "Ngạnh mễ", "Cam thảo", "Ngưu tất"]
  },
  "tuc_thai_am_ty_kinh": { hc: "Túc thái âm Tỳ kinh chứng", phanloai: ["Kinh lạc", "Lý", "Hư", "Tỳ kinh"], tc: ["Gốc lưỡi cứng đau", "Vùng vị quản trướng đau", "Mặt trong đùi và chân lạnh đau", "Mạch tế nhược"], pdt: "Ôn kinh tán hàn, kiện tỳ thông lạc", bt: "Lý trung hoàn hợp Đương quy tứ nghịch thang", tpbt: ["Đảng sâm", "Can khương", "Bạch truật", "Đương quy", "Quế chi", "Xích thược"]
  },
  "thu_shieu_am_tam_kinh": { hc: "Thủ thiếu âm Tâm kinh chứng", phanloai: ["Kinh lạc", "Lý", "Hư", "Tâm kinh"], tc: ["Lòng bàn tay nóng", "Vùng tim ngực đau tức", "Mặt trong cánh tay đau nhức", "Mạch tế"], pdt: "Dưỡng tâm an thần, thông kinh hoạt lạc", bt: "Thiên vương bổ tâm đan", tpbt: ["Sinh địa", "Đảng sâm", "Đan sâm", "Bách hợp", "Toan táo nhân", "Viễn chí"]
  },
  "thu_thai_duong_tieu_truong_kinh": { hc: "Thủ thái dương Tiểu trường kinh chứng", phanloai: ["Kinh lạc", "Biểu", "Thực", "Tiểu trường kinh"], tc: ["Đau vùng vai gáy và mặt sau ngoài tay", "Cổ gáy cứng đơ", "Ù tai đau họng"], pdt: "Khu phong trừ thấp, thông kinh hoạt lạc", bt: "Cát căn thang", tpbt: ["Cát căn", "Ma hoàng", "Quế chi", "Bạch thược", "Cam thảo", "Sinh khương"]
  },
  "tuc_thai_duong_bang_quang_kinh": { hc: "Túc thái dương Bàng quang kinh chứng", phanloai: ["Kinh lạc", "Biểu", "Thực", "Bàng quang kinh"], tc: ["Đau đầu cứng gáy dọc sống lưng", "Đau thắt lưng lan xuống mặt sau chân", "Mạch phù khẩn"], pdt: "Khu phong tán hàn, thông lạc chỉ thống", bt: "Độc hoạt tang ký sinh thang", tpbt: ["Độc hoạt", "Tang ký sinh", "Phòng phong", "Tần giao", "Quế chi", "Đương quy"]
  },
  "tuc_shieu_am_than_kinh": { hc: "Túc thiếu âm Thận kinh chứng", phanloai: ["Kinh lạc", "Lý", "Hư", "Thận kinh"], tc: ["Lưng gối mỏi yếu đau", "Lòng bàn tay chân nóng", "Cổ họng khô đau", "Mạch trầm tế"], pdt: "Tư bổ thận âm, thông kinh lạc", bt: "Lục vị địa hoàng hoàn", tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh"]
  },
  "thu_quyet_am_tam_bao_kinh": { hc: "Thủ quyết âm Tâm bào kinh chứng", phanloai: ["Kinh lạc", "Lý", "Thực", "Tâm bào kinh"], tc: ["Ngực tức tim đập mạnh", "Nách sưng đau", "Lòng bàn tay nóng co quắp", "Mạch huyền sác"], pdt: "Thanh tâm lương huyết, thông kinh lạc", bt: "Đan sâm ẩm", tpbt: ["Đan sâm", "Đàn hương", "Sa nhân"]
  },
  "thu_shieu_duong_tam_tieu_kinh": { hc: "Thủ thiếu dương Tam tiêu kinh chứng", phanloai: ["Kinh lạc", "Biểu", "Thực", "Tam tiêu kinh"], tc: ["Tai ù điếc đau vùng tai", "Vai gáy và mặt ngoài tay đau mỏi", "Sốt sợ gió"], pdt: "Sơ phong thanh nhiệt, thông lạc", bt: "Tiểu sài hồ thang", tpbt: ["Sài hồ", "Hoàng cầm", "Bán hạ", "Đảng sâm", "Cam thảo"]
  },
  "tuc_shieu_duong_dom_kinh": { hc: "Túc thiếu dương Đởm kinh chứng", phanloai: ["Kinh lạc", "Biểu", "Thực", "Đởm kinh"], tc: ["Đau đầu vùng thái dương hai bên", "Đau tức sườn ngực", "Mặt ngoài chân đau nhức", "Mạch huyền"], pdt: "Sơ can lý khí, thông kinh hoạt lạc", bt: "Sài hồ sơ can tán", tpbt: ["Sài hồ", "Bạch thược", "Chỉ xác", "Xuyên khung", "Trần bì"]
  },
  "tuc_quyet_am_can_kinh": { hc: "Túc quyết âm Can kinh chứng", phanloai: ["Kinh lạc", "Lý", "Thực", "Can kinh"], tc: ["Đau tức vùng hạ vị", "Đau lan tinh hoàn hoặc âm hộ", "Mặt sạm nhợt", "Mạch huyền"], pdt: "Ôn kinh tán hàn, sơ can lý khí", bt: "Noãn can tiễn", tpbt: ["Tiểu hồi hương", "Nhục quế", "Đương quy", "Câu kỷ tử", "Ô dược"]
  },
  "doc_mach_chung": { hc: "Đốc mạch bệnh chứng", phanloai: ["Khy kinh", "Lý", "Thực", "Đốc mạch"], tc: ["Cột sống cứng đơ đau nhức", "Đầu choáng tai ù", "Co giật uốn ván lưng", "Mạch huyền khẩn"], pdt: "Khu phong tán hàn, ôn dương thông lạc", bt: "Cát căn thang hợp Quế chi gia phụ tử thang", tpbt: ["Cát căn", "Quế chi", "Phụ tử", "Bạch thược", "Cam thảo"]
  },
  "nham_mach_chung": { hc: "Nhâm mạch bệnh chứng", phanloai: ["Khy kinh", "Lý", "Hư", "Nhâm mạch"], tc: ["Bụng dưới kết hòn cục ở nữ (chứng ica)", "Kinh nguyệt không đều", "Nam giới thất tinh", "Mạch trầm tế"], pdt: "Bổ thận dưỡng huyết, điều xung nhâm", bt: "Ôn kinh thang", tpbt: ["Đương quy", "Xuyên khung", "Bạch thược", "Quế chi", "Ngô thù du", "A giao"]
  },
  "xung_mach_chung": { hc: "Xung mạch bệnh chứng", phanloai: ["Khy kinh", "Lý", "Thực", "Xung mạch"], tc: ["Khí nghịch lên ngực gây hồi hộp bứt rứt", "Bụng dưới quặn đau", "Mạch huyền"], pdt: "Giáng nghịch hóa trọc, điều xung", bt: "Toàn phúc đại giả thạch thang", tpbt: ["Toàn phúc hoa", "Đại giả thạch", "Bán hạ", "Trần bì"]
  },
  "doi_mach_chung": { hc: "Đới mạch bệnh chứng", phanloai: ["Khy kinh", "Lý", "Hư", "Đới mạch"], tc: ["Vùng thắt lưng như ngồi trong nước lạnh", "Đới hạ ra nhiều", "Chân tay mỏi yếu", "Mạch trầm tế"], pdt: "Ôn bổ tỳ thận, cố đới", bt: "Uyển đới thang", tpbt: ["Bạch truật", "Sơn dược", "Nhân sâm", "Bạch thược", "Xa tiền tử"]
  },
  "am_kieu_mach_chung": { hc: "Âm kiều mạch bệnh chứng", phanloai: ["Khy kinh", "Lý", "Hư", "Âm kiều mạch"], tc: ["Mắt nhắm không muốn mở hay buồn ngủ", "Cơ bắp mặt trong chân co rút", "Mạch trầm tế"], pdt: "Dưỡng huyết thư cân, an thần", bt: "Tứ vật thang hợp An thần định chí hoàn", tpbt: ["Thục địa", "Đương quy", "Bạch thược", "Xuyên khung", "Phục thần"]
  },
  "duong_kieu_mach_chung": { hc: "Dương kiều mạch bệnh chứng", phanloai: ["Khy kinh", "Lý", "Thực", "Dương kiều mạch"], tc: ["Mắt mở to khó nhắm", "Cơ bắp mặt ngoài chân co cứng", "Chứng cuồng", "Mạch huyền sác"], pdt: "Khu phong thanh nhiệt, thư cân", bt: "Tần giao tang ký sinh thang", tpbt: ["Tần giao", "Tang ký sinh", "Phòng phong", "Xích thược"]
  },
  "am_duy_mach_chung": { hc: "Âm duy mạch bệnh chứng", phanloai: ["Khy kinh", "Lý", "Hư", "Âm duy mạch"], tc: ["Chứng tâm thống (đau tim ngực)", "Buồn bực bứt rứt", "Mạch tế nhược"], pdt: "Bổ khí dưỡng huyết, an tâm", bt: "Đan sâm ẩm hợp Cam mạch đại táo thang", tpbt: ["Đan sâm", "Đàn hương", "Cam thảo", "Tiểu mạch", "Đại táo"]
  },
  "duong_duy_mach_chung": { hc: "Dương duy mạch bệnh chứng", phanloai: ["Khy kinh", "Lý", "Thực", "Dương duy mạch"], tc: ["Phát sốt sợ lạnh ngoài da", "Đau nhức các khớp xương", "Mạch phù"], pdt: "Giải biểu thấu tà, thông lạc", bt: "Tiểu sài hồ thang hợp Quế chi thang", tpbt: ["Sài hồ", "Hoàng cầm", "Quế chi", "Bạch thược", "Sinh khương"]
  },
  "than_am_hu": {
    hc: "Thận âm hư",
    phanloai: ["Tạng Thận", "Nhiệt", "Hư", "Âm hư"],
  ...
  "than_tinh_bat_tuc": {
    ...
    tpbt: ["Hà xa", "Thục địa", "Quy bản", "Kỷ tử", "Đỗ trọng"]
  },
  "than_khi_hu": {
    hc: "Thận khí hư",
    phanloai: ["Tạng Thận", "Bình", "Hư", "Khí hư"],
    ...
    tpbt: ["Thục địa", "Sơn thù", "Hoài sơn", "Trạch tả", "Đan bì", "Phục linh", "Nhục quế", "Phụ tử"]
  },
  "than_am_duong_luong_hu": {
    hc: "Thận âm dương lưỡng hư",
    ...
    tpbt: ["Tiên mao", "Tiên linh tỳ", "Đương quy", "Ba kích thiên", "Thục địa", "Sơn thù", "Hoài sơn"]
  },
  "than_hu_thuy_lam": {
    hc: "Thận hư thủy lạm",
    ...
    bt: "Chân vũ thang",
    tpbt: ["Hắc phụ tử", "Bạch truật", "Phục linh", "Bạch thược", "Sinh khương"]
  },
  "than_lac_huyet_u": {
    hc: "Thận lạc huyết ứ",
    ...
    tpbt: ["Đương quy", "Xuyên khung", "Đào nhân", "Hồng hoa", "Ngưu tất", "Địa long"]
  },
  "than_hoa_vuong": {
    hc: "Thận hỏa vượng",
    ...
    bt: "Tri bách địa hoàng hoàn gia giảm",
